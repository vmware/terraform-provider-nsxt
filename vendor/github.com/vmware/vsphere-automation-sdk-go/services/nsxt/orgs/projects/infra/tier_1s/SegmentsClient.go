...
type SegmentsClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Delete0(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Deletedhcpleases(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string, dhcpDeleteLeasesParam nsx_policyModel.DhcpDeleteLeases, enforcementPointPathParam *string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string) (nsx_policyModel.Segment, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, tier1IdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, segmentTypeParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SegmentListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string, segmentParam nsx_policyModel.Segment) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string, segmentParam nsx_policyModel.Segment) (nsx_policyModel.Segment, error)
}
...
func NewSegmentsClient(connector vapiProtocolClient_.Connector) *segmentsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments")
...
func (sIface *segmentsClient) Delete(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments", "delete", inputDataValue, executionContext)
...
func (sIface *segmentsClient) Delete0(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments", "delete_0", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *segmentsClient) Deletedhcpleases(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string, dhcpDeleteLeasesParam nsx_policyModel.DhcpDeleteLeases, enforcementPointPathParam *string) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments", "deletedhcpleases", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *segmentsClient) Get(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string) (nsx_policyModel.Segment, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Segment
	if methodResult.IsSuccess() {
...
func (sIface *segmentsClient) List(orgIdParam string, projectIdParam string, tier1IdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, segmentTypeParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SegmentListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentListResult
	if methodResult.IsSuccess() {
...
func (sIface *segmentsClient) Patch(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string, segmentParam nsx_policyModel.Segment) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *segmentsClient) Update(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string, segmentParam nsx_policyModel.Segment) (nsx_policyModel.Segment, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Segment
	if methodResult.IsSuccess() {
