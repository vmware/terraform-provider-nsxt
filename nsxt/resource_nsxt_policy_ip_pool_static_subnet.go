...
var cliIpSubnetsClient = ippools.NewIpSubnetsClient
...
func resourceNsxtPolicyIPPoolStaticSubnetCreate(d *schema.ResourceData, m interface{}) error {
	...
	d.SetId(id)
	d.Set("nsx_id", id)
	MarkPostWriteAndInvalidateCacheForResourceType(resourceTypeIpAddressPoolStaticSubnet, CacheKeyForResourceID(resourceTypeIpAddressPoolStaticSubnet, d))
