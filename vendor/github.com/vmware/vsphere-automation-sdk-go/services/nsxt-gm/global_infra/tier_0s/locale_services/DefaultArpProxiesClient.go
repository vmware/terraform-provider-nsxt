...
func NewDefaultArpProxiesClient(connector client.Connector) *DefaultArpProxiesClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_0s.locale_services.arp_proxies"
...
func (aIface *DefaultArpProxiesClient) List(tier0IdParam string, localeServiceIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.PolicyArpProxyTableListResult, error) {
