...
type NatRulesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, tier1IdParam string, natIdParam string, natRuleIdParam string) (nsx_policyModel.PolicyNatRule, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, tier1IdParam string, natIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyNatRuleListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, tier1IdParam string, natIdParam string, natRuleIdParam string, policyNatRuleParam nsx_policyModel.PolicyNatRule) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, tier1IdParam string, natIdParam string, natRuleIdParam string, policyNatRuleParam nsx_policyModel.PolicyNatRule) (nsx_policyModel.PolicyNatRule, error)
}
...
func NewNatRulesClient(connector vapiProtocolClient_.Connector) *natRulesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.nat.nat_rules")
...
func (nIface *natRulesClient) Delete(orgIdParam string, projectIdParam string, tier1IdParam string, natIdParam string, natRuleIdParam string) error {
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.nat.nat_rules", "delete", inputDataValue, executionContext)
...
func (nIface *natRulesClient) Get(orgIdParam string, projectIdParam string, tier1IdParam string, natIdParam string, natRuleIdParam string) (nsx_policyModel.PolicyNatRule, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.nat.nat_rules", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyNatRule
	if methodResult.IsSuccess() {
...
func (nIface *natRulesClient) List(orgIdParam string, projectIdParam string, tier1IdParam string, natIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyNatRuleListResult, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.nat.nat_rules", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyNatRuleListResult
	if methodResult.IsSuccess() {
...
func (nIface *natRulesClient) Patch(orgIdParam string, projectIdParam string, tier1IdParam string, natIdParam string, natRuleIdParam string, policyNatRuleParam nsx_policyModel.PolicyNatRule) error {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.nat.nat_rules", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), nIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (nIface *natRulesClient) Update(orgIdParam string, projectIdParam string, tier1IdParam string, natIdParam string, natRuleIdParam string, policyNatRuleParam nsx_policyModel.PolicyNatRule) (nsx_policyModel.PolicyNatRule, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.nat.nat_rules", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyNatRule
	if methodResult.IsSuccess() {
