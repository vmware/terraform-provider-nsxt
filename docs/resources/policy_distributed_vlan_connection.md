...
* `subnet_exclusive_config` - (Optional) Subnet exclusive config
  * `ip_block_path` - Policy path of external IP block. This IP block must be marked as reserved for VLAN extension.
