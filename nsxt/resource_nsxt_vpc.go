...
var vpcSchema = map[string]*metadata.ExtendedSchema{
	...
	"subnet_profiles": {
		...
		Metadata: metadata.Metadata{
			SchemaType:   "struct",
			SdkFieldName: "SubnetProfiles",
			ReflectType:  reflect.TypeOf(model.SubnetProfiles{}),
		},
	},
	"private_ipv4_blocks": {
		Schema: schema.Schema{
