...
type TagsClient interface {
	...
	// @return com.vmware.nsx_global_policy.model.TagInfoListResult
	//
	...
	List(cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, scopeParam *string, sortAscendingParam *bool, sortByParam *string, sourceParam *string, tagParam *string) (nsx_global_policyModel.TagInfoListResult, error)
}
...
func NewTagsClient(connector vapiProtocolClient_.Connector) *tagsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tags")
...
func (tIface *tagsClient) List(cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, scopeParam *string, sortAscendingParam *bool, sortByParam *string, sourceParam *string, tagParam *string) (nsx_global_policyModel.TagInfoListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.TagInfoListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tags", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TagInfoListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.TagInfoListResult), nil
	} else {
