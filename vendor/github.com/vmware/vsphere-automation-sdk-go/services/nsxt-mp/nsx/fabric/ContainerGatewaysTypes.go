...
// Data type definitions file for service: ContainerGateways.
...
func containerGatewaysListInputType() vapiBindings_.StructType {
...
func ContainerGatewaysListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ContainerGatewayListResultBindingType)
}

func containerGatewaysListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/fabric/container-gateways",
		"",
		resultHeaders,
		200,
		"",
