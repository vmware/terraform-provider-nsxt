...
type ConfigClient interface {
	...
	// @return com.vmware.nsx_global_policy.model.PolicyMonitoringConfig
	//
	...
	Get() (nsx_global_policyModel.PolicyMonitoringConfig, error)
}
...
func NewConfigClient(connector vapiProtocolClient_.Connector) *configClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.config")
...
func (cIface *configClient) Get() (nsx_global_policyModel.PolicyMonitoringConfig, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyMonitoringConfig
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.config", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyMonitoringConfig
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyMonitoringConfig), nil
	} else {
