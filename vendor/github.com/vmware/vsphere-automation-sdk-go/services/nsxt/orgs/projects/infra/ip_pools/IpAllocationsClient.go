...
type IpAllocationsClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipAllocationIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipAllocationIdParam string) (nsx_policyModel.IpAddressAllocation, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipAllocationIdParam string, ipAddressAllocationParam nsx_policyModel.IpAddressAllocation) (nsx_policyModel.IpAddressAllocation, error)
}
...
func NewIpAllocationsClient(connector vapiProtocolClient_.Connector) *ipAllocationsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_allocations")
...
func (iIface *ipAllocationsClient) Delete(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipAllocationIdParam string) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_allocations", "delete", inputDataValue, executionContext)
...
func (iIface *ipAllocationsClient) Get(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipAllocationIdParam string) (nsx_policyModel.IpAddressAllocation, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_allocations", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IpAddressAllocation
	if methodResult.IsSuccess() {
...
func (iIface *ipAllocationsClient) List(orgIdParam string, projectIdParam string, ipPoolIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IpAddressAllocationListResult, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_allocations", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IpAddressAllocationListResult
	if methodResult.IsSuccess() {
...
func (iIface *ipAllocationsClient) Patch(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipAllocationIdParam string, ipAddressAllocationParam nsx_policyModel.IpAddressAllocation) error {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_allocations", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (iIface *ipAllocationsClient) Update(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipAllocationIdParam string, ipAddressAllocationParam nsx_policyModel.IpAddressAllocation) (nsx_policyModel.IpAddressAllocation, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_allocations", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IpAddressAllocation
	if methodResult.IsSuccess() {
