...
type VirtualMachineGroupAssociationsClient interface {
	...
	List(vmExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyResourceReferenceForEPListResult, error)
}
...
func NewVirtualMachineGroupAssociationsClient(connector vapiProtocolClient_.Connector) *virtualMachineGroupAssociationsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.virtual_machine_group_associations")
...
func (vIface *virtualMachineGroupAssociationsClient) List(vmExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyResourceReferenceForEPListResult, error) {
	...
	methodResult := vIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.virtual_machine_group_associations", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyResourceReferenceForEPListResult
