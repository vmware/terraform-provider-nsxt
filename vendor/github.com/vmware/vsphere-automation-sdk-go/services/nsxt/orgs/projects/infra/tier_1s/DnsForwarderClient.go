...
type DnsForwarderClient interface {
	...
	Create(orgIdParam string, projectIdParam string, tier1IdParam string, actionParam string, enforcementPointPathParam *string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, tier1IdParam string) (nsx_policyModel.PolicyDnsForwarder, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, tier1IdParam string, policyDnsForwarderParam nsx_policyModel.PolicyDnsForwarder) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, tier1IdParam string, policyDnsForwarderParam nsx_policyModel.PolicyDnsForwarder) (nsx_policyModel.PolicyDnsForwarder, error)
}
...
func NewDnsForwarderClient(connector vapiProtocolClient_.Connector) *dnsForwarderClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.dns_forwarder")
...
func (dIface *dnsForwarderClient) Create(orgIdParam string, projectIdParam string, tier1IdParam string, actionParam string, enforcementPointPathParam *string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.dns_forwarder", "create", inputDataValue, executionContext)
...
func (dIface *dnsForwarderClient) Delete(orgIdParam string, projectIdParam string, tier1IdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.dns_forwarder", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dnsForwarderClient) Get(orgIdParam string, projectIdParam string, tier1IdParam string) (nsx_policyModel.PolicyDnsForwarder, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.dns_forwarder", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyDnsForwarder
	if methodResult.IsSuccess() {
...
func (dIface *dnsForwarderClient) Patch(orgIdParam string, projectIdParam string, tier1IdParam string, policyDnsForwarderParam nsx_policyModel.PolicyDnsForwarder) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.dns_forwarder", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dnsForwarderClient) Update(orgIdParam string, projectIdParam string, tier1IdParam string, policyDnsForwarderParam nsx_policyModel.PolicyDnsForwarder) (nsx_policyModel.PolicyDnsForwarder, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.dns_forwarder", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyDnsForwarder
	if methodResult.IsSuccess() {
