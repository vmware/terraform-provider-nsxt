...
* `resource/nsxt_policy_tier0_gateway_interface`: Read edge_cluster_member_index from the state ([#1880](https://github.com/vmware/terraform-provider-nsxt/pull/1880))
* `resource/nsxt_policy_lb_virtual_server`: Add a check to identify import operation in read function ([#1881](https://github.com/vmware/terraform-provider-nsxt/pull/1881))
