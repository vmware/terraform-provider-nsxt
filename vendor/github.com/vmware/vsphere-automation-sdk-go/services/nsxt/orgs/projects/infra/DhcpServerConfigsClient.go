...
type DhcpServerConfigsClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, dhcpServerConfigIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, dhcpServerConfigIdParam string) (nsx_policyModel.DhcpServerConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DhcpServerConfigListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, dhcpServerConfigIdParam string, dhcpServerConfigParam nsx_policyModel.DhcpServerConfig) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, dhcpServerConfigIdParam string, dhcpServerConfigParam nsx_policyModel.DhcpServerConfig) (nsx_policyModel.DhcpServerConfig, error)
}
...
func NewDhcpServerConfigsClient(connector vapiProtocolClient_.Connector) *dhcpServerConfigsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.dhcp_server_configs")
...
func (dIface *dhcpServerConfigsClient) Delete(orgIdParam string, projectIdParam string, dhcpServerConfigIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.dhcp_server_configs", "delete", inputDataValue, executionContext)
...
func (dIface *dhcpServerConfigsClient) Get(orgIdParam string, projectIdParam string, dhcpServerConfigIdParam string) (nsx_policyModel.DhcpServerConfig, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.dhcp_server_configs", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DhcpServerConfig
	if methodResult.IsSuccess() {
...
func (dIface *dhcpServerConfigsClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DhcpServerConfigListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.dhcp_server_configs", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DhcpServerConfigListResult
	if methodResult.IsSuccess() {
...
func (dIface *dhcpServerConfigsClient) Patch(orgIdParam string, projectIdParam string, dhcpServerConfigIdParam string, dhcpServerConfigParam nsx_policyModel.DhcpServerConfig) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.dhcp_server_configs", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dhcpServerConfigsClient) Update(orgIdParam string, projectIdParam string, dhcpServerConfigIdParam string, dhcpServerConfigParam nsx_policyModel.DhcpServerConfig) (nsx_policyModel.DhcpServerConfig, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.dhcp_server_configs", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DhcpServerConfig
	if methodResult.IsSuccess() {
