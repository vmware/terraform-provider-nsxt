...
type AlbAutoScaleLaunchConfigsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albAutoscalelaunchconfigIdParam string) (nsx_global_policyModel.ALBAutoScaleLaunchConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBAutoScaleLaunchConfigApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albAutoscalelaunchconfigIdParam string, aLBAutoScaleLaunchConfigParam nsx_global_policyModel.ALBAutoScaleLaunchConfig) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albAutoscalelaunchconfigIdParam string, aLBAutoScaleLaunchConfigParam nsx_global_policyModel.ALBAutoScaleLaunchConfig) (nsx_global_policyModel.ALBAutoScaleLaunchConfig, error)
}
...
func NewAlbAutoScaleLaunchConfigsClient(connector vapiProtocolClient_.Connector) *albAutoScaleLaunchConfigsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_auto_scale_launch_configs")
...
func (aIface *albAutoScaleLaunchConfigsClient) Delete(albAutoscalelaunchconfigIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_auto_scale_launch_configs", "delete", inputDataValue, executionContext)
...
func (aIface *albAutoScaleLaunchConfigsClient) Get(albAutoscalelaunchconfigIdParam string) (nsx_global_policyModel.ALBAutoScaleLaunchConfig, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBAutoScaleLaunchConfig
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_auto_scale_launch_configs", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBAutoScaleLaunchConfig
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBAutoScaleLaunchConfig), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albAutoScaleLaunchConfigsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBAutoScaleLaunchConfigApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBAutoScaleLaunchConfigApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_auto_scale_launch_configs", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBAutoScaleLaunchConfigApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBAutoScaleLaunchConfigApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albAutoScaleLaunchConfigsClient) Patch(albAutoscalelaunchconfigIdParam string, aLBAutoScaleLaunchConfigParam nsx_global_policyModel.ALBAutoScaleLaunchConfig) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_auto_scale_launch_configs", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albAutoScaleLaunchConfigsClient) Update(albAutoscalelaunchconfigIdParam string, aLBAutoScaleLaunchConfigParam nsx_global_policyModel.ALBAutoScaleLaunchConfig) (nsx_global_policyModel.ALBAutoScaleLaunchConfig, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_auto_scale_launch_configs", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBAutoScaleLaunchConfig
	if methodResult.IsSuccess() {
