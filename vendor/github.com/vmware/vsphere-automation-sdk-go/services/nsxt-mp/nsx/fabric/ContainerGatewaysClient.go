...
type ContainerGatewaysClient interface {
	...
	List(containerClusterIdParam *string, containerProjectIdParam *string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, scopeIdParam *string, sortAscendingParam *bool, sortByParam *string) (nsxModel.ContainerGatewayListResult, error)
}
...
func NewContainerGatewaysClient(connector vapiProtocolClient_.Connector) *containerGatewaysClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.fabric.container_gateways")
...
func (cIface *containerGatewaysClient) GetErrorBindingType(errorName string) vapiBindings_.BindingType {
...
func (cIface *containerGatewaysClient) List(containerClusterIdParam *string, containerProjectIdParam *string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, scopeIdParam *string, sortAscendingParam *bool, sortByParam *string) (nsxModel.ContainerGatewayListResult, error) {
	...
	sv := vapiBindings_.NewStructValueBuilder(containerGatewaysListInputType(), typeConverter)
	...
	if inputError != nil {
		var emptyOutput nsxModel.ContainerGatewayListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.ContainerGatewayListResult), nil
	} else {
