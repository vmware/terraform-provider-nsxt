...
func transportZoneProfilesDeleteInputType() bindings.StructType {
	...
	fields["tz_profile_id"] = bindings.NewStringType()
...
func transportZoneProfilesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	fields["tz_profile_id"] = bindings.NewStringType()
	fieldNameMap["tz_profile_id"] = "TzProfileId"
	paramsTypeMap["tz_profile_id"] = bindings.NewStringType()
	paramsTypeMap["tzProfileId"] = bindings.NewStringType()
...
func transportZoneProfilesGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyTransportZoneProfileBindingType)
}
...
func transportZoneProfilesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyTransportZoneProfileListResultBindingType)
}
...
func transportZoneProfilesPatchInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["tz_profile_id"] = bindings.NewStringType()
	fields["policy_transport_zone_profile"] = bindings.NewReferenceType(model.PolicyTransportZoneProfileBindingType)
	fieldNameMap["tz_profile_id"] = "TzProfileId"
...
func transportZoneProfilesPatchOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyTransportZoneProfileBindingType)
}

func transportZoneProfilesPatchRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
	...
	fieldNameMap["tz_profile_id"] = "TzProfileId"
	fieldNameMap["policy_transport_zone_profile"] = "PolicyTransportZoneProfile"
	paramsTypeMap["policy_transport_zone_profile"] = bindings.NewReferenceType(model.PolicyTransportZoneProfileBindingType)
	paramsTypeMap["tz_profile_id"] = bindings.NewStringType()
	paramsTypeMap["tzProfileId"] = bindings.NewStringType()
	pathParams["tz_profile_id"] = "tzProfileId"
	resultHeaders := map[string]string{}
