...
// Data type definitions file for service: ArpProxies.
...
func ArpProxiesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.PolicyArpProxyTableListResultBindingType)
}

func arpProxiesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tier-0s/{tier0Id}/locale-services/{localeServiceId}/arp-proxies",
		"",
		resultHeaders,
		200,
		"",
