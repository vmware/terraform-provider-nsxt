...
type AlbProtocolParsersClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albProtocolparserIdParam string) (nsx_policyModel.ALBProtocolParser, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ALBProtocolParserApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albProtocolparserIdParam string, aLBProtocolParserParam nsx_policyModel.ALBProtocolParser) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albProtocolparserIdParam string, aLBProtocolParserParam nsx_policyModel.ALBProtocolParser) (nsx_policyModel.ALBProtocolParser, error)
}
...
func NewAlbProtocolParsersClient(connector vapiProtocolClient_.Connector) *albProtocolParsersClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.alb_protocol_parsers")
...
func (aIface *albProtocolParsersClient) Get(albProtocolparserIdParam string) (nsx_policyModel.ALBProtocolParser, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.ALBProtocolParser
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ALBProtocolParser), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albProtocolParsersClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ALBProtocolParserApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.ALBProtocolParserApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ALBProtocolParserApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albProtocolParsersClient) Patch(albProtocolparserIdParam string, aLBProtocolParserParam nsx_policyModel.ALBProtocolParser) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
...
func (aIface *albProtocolParsersClient) Update(albProtocolparserIdParam string, aLBProtocolParserParam nsx_policyModel.ALBProtocolParser) (nsx_policyModel.ALBProtocolParser, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
