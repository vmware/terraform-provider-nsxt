...
type SharedWithMeClient interface {
	...
	List(orgIdParam string, projectIdParam string, resourceTypeParam *string) (nsx_policyModel.SharedResourceListResult, error)
}
...
func NewSharedWithMeClient(connector vapiProtocolClient_.Connector) *sharedWithMeClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.shared_with_me")
...
func (sIface *sharedWithMeClient) List(orgIdParam string, projectIdParam string, resourceTypeParam *string) (nsx_policyModel.SharedResourceListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.shared_with_me", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SharedResourceListResult
