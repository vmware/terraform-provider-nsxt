...
func segmentQosProfileBindingMapsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/global-manager/api/v1/global-infra/segments/{segmentId}/segment-qos-profile-binding-maps/{segmentQosProfileBindingMapId}",
		"",
		resultHeaders,
		204,
		"",
...
func segmentQosProfileBindingMapsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/segments/{segmentId}/segment-qos-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
