...
func gatewayInterfaceArpTableListInputType() bindings.StructType {
...
func gatewayInterfaceArpTableListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.InterfaceArpTableBindingType)
}

func gatewayInterfaceArpTableListRestMetadata() protocol.OperationRestMetadata {
