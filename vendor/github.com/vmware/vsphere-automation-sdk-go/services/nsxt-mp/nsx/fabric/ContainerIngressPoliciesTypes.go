...
// Data type definitions file for service: ContainerIngressPolicies.
...
func containerIngressPoliciesGetInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["ingress_policy_id"] = vapiBindings_.NewStringType()
	fieldNameMap["ingress_policy_id"] = "IngressPolicyId"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}

func ContainerIngressPoliciesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ContainerIngressPolicyBindingType)
}

func containerIngressPoliciesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["ingress_policy_id"] = vapiBindings_.NewStringType()
	fieldNameMap["ingress_policy_id"] = "IngressPolicyId"
	paramsTypeMap["ingress_policy_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["ingressPolicyId"] = vapiBindings_.NewStringType()
...
func containerIngressPoliciesListInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
...
func ContainerIngressPoliciesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ContainerIngressPolicyListResultBindingType)
}

func containerIngressPoliciesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
