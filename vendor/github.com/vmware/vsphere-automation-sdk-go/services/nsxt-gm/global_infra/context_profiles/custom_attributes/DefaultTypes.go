...
func defaultCreateInputType() vapiBindings_.StructType {
	...
	fields["policy_custom_attributes"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.PolicyCustomAttributesBindingType)
...
func defaultCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["policy_custom_attributes"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.PolicyCustomAttributesBindingType)
