...
type AlbAuthTokenClient interface {
	...
	// @return com.vmware.nsx_global_policy.model.ALBAuthToken
	//
	...
	Update(aLBAuthTokenParam nsx_global_policyModel.ALBAuthToken) (nsx_global_policyModel.ALBAuthToken, error)
}
...
func NewAlbAuthTokenClient(connector vapiProtocolClient_.Connector) *albAuthTokenClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_auth_token")
...
func (aIface *albAuthTokenClient) Update(aLBAuthTokenParam nsx_global_policyModel.ALBAuthToken) (nsx_global_policyModel.ALBAuthToken, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBAuthToken
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_auth_token", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBAuthToken
