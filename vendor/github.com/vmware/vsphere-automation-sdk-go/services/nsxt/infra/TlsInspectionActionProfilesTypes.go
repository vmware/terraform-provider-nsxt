...
func TlsInspectionActionProfilesDeleteOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func tlsInspectionActionProfilesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
...
func TlsInspectionActionProfilesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TlsProfileListResultBindingType)
}

func tlsInspectionActionProfilesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
