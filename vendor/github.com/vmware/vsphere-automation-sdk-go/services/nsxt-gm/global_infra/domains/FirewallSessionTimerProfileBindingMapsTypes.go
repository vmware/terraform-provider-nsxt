...
func FirewallSessionTimerProfileBindingMapsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMapListResultBindingType)
}
...
func firewallSessionTimerProfileBindingMapsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/domains/firewall-session-timer-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
