...
func lbServiceUsageSummaryGetInputType() vapiBindings_.StructType {
...
func LbServiceUsageSummaryGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.LBServiceUsageSummaryBindingType)
}

func lbServiceUsageSummaryGetRestMetadata() vapiProtocol_.OperationRestMetadata {
