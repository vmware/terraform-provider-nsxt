...
// Source: /Users/aruntony/Desktop/playground/vcf/vsphere-automation-sdk-go/services/nsxt/infra/settings/scrx/cluster_configs/StatusClient.go
...
func (m *MockStatusClient) Get(clusterIdParam string) (model.ScrxResizeStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", clusterIdParam)
	ret0, _ := ret[0].(model.ScrxResizeStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Get indicates an expected call of Get.
func (mr *MockStatusClientMockRecorder) Get(clusterIdParam interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockStatusClient)(nil).Get), clusterIdParam)
}
