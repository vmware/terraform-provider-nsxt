...
func AffectedIpsCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyIdsIpListBindingType)
}

func affectedIpsCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
