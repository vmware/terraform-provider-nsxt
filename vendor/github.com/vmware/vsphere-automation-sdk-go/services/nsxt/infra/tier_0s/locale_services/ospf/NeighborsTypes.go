...
func neighborsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.OspfNeighborsStatusListResultBindingType)
}
...
func neighborsListRestMetadata() protocol.OperationRestMetadata {
	...
	paramsTypeMap["neighbor_address"] = bindings.NewOptionalType(bindings.NewStringType())
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/tier-0s/{tier0Id}/locale-services/{localeServiceId}/ospf/neighbors",
		"",
		resultHeaders,
		200,
		"",
