...
func NewServicesClient(connector vapiProtocolClient_.Connector) *servicesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.services")
...
func (sIface *servicesClient) Delete(orgIdParam string, projectIdParam string, serviceIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.services", "delete", inputDataValue, executionContext)
...
func (sIface *servicesClient) Get(orgIdParam string, projectIdParam string, serviceIdParam string) (nsx_policyModel.Service, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.services", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Service
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.Service), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (sIface *servicesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, defaultServiceParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ServiceListResult, error) {
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.ServiceListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.services", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.ServiceListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ServiceListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (sIface *servicesClient) Patch(orgIdParam string, projectIdParam string, serviceIdParam string, serviceParam nsx_policyModel.Service) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.services", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *servicesClient) Update(orgIdParam string, projectIdParam string, serviceIdParam string, serviceParam nsx_policyModel.Service) (nsx_policyModel.Service, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.services", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Service
	if methodResult.IsSuccess() {
