...
func NewSummaryClient(connector vapiProtocolClient_.Connector) *summaryClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_1s.locale_services.ipsec_vpn_services.summary")
...
func (sIface *summaryClient) Get(tier1IdParam string, localeServiceIdParam string, serviceIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.PolicyIpsecVpnIkeServiceSummary, error) {
