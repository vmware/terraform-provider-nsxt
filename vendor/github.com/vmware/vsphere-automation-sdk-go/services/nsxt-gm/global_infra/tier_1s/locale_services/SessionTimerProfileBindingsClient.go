...
type SessionTimerProfileBindingsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(tier1IdParam string, localeServicesIdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam model.SessionTimerProfileBindingMap) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(tier1IdParam string, localeServicesIdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam model.SessionTimerProfileBindingMap) (model.SessionTimerProfileBindingMap, error)
}
...
func NewSessionTimerProfileBindingsClient(connector client.Connector) *sessionTimerProfileBindingsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_1s.locale_services.session_timer_profile_bindings")
...
func (sIface *sessionTimerProfileBindingsClient) Patch(tier1IdParam string, localeServicesIdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam model.SessionTimerProfileBindingMap) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
...
func (sIface *sessionTimerProfileBindingsClient) Update(tier1IdParam string, localeServicesIdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam model.SessionTimerProfileBindingMap) (model.SessionTimerProfileBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
