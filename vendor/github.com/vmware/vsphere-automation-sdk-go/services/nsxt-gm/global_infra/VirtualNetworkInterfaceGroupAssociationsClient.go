...
type VirtualNetworkInterfaceGroupAssociationsClient interface {
	...
	List(vifExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyResourceReferenceForEPListResult, error)
}
...
func NewVirtualNetworkInterfaceGroupAssociationsClient(connector vapiProtocolClient_.Connector) *virtualNetworkInterfaceGroupAssociationsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.virtual_network_interface_group_associations")
