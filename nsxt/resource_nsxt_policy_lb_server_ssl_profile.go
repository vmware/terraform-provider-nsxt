...
var lbServerSslProfileCiphersValues = []string{
	model.LBServerSslProfile_CIPHERS_ECDHE_RSA_WITH_AES_128_GCM_SHA256,
	model.LBServerSslProfile_CIPHERS_ECDHE_RSA_WITH_AES_256_GCM_SHA384,
	model.LBServerSslProfile_CIPHERS_ECDHE_RSA_WITH_AES_256_CBC_SHA,
	model.LBServerSslProfile_CIPHERS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA,
	model.LBServerSslProfile_CIPHERS_ECDH_ECDSA_WITH_AES_256_CBC_SHA,
	model.LBServerSslProfile_CIPHERS_ECDH_RSA_WITH_AES_256_CBC_SHA,
	model.LBServerSslProfile_CIPHERS_RSA_WITH_AES_256_CBC_SHA,
	model.LBServerSslProfile_CIPHERS_RSA_WITH_AES_128_CBC_SHA,
	model.LBServerSslProfile_CIPHERS_RSA_WITH_3DES_EDE_CBC_SHA,
	model.LBServerSslProfile_CIPHERS_ECDHE_RSA_WITH_AES_128_CBC_SHA,
	model.LBServerSslProfile_CIPHERS_ECDHE_RSA_WITH_AES_128_CBC_SHA256,
	model.LBServerSslProfile_CIPHERS_ECDHE_RSA_WITH_AES_256_CBC_SHA384,
	model.LBServerSslProfile_CIPHERS_RSA_WITH_AES_128_CBC_SHA256,
	model.LBServerSslProfile_CIPHERS_RSA_WITH_AES_128_GCM_SHA256,
	model.LBServerSslProfile_CIPHERS_RSA_WITH_AES_256_CBC_SHA256,
	model.LBServerSslProfile_CIPHERS_RSA_WITH_AES_256_GCM_SHA384,
	model.LBServerSslProfile_CIPHERS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA,
	model.LBServerSslProfile_CIPHERS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256,
	model.LBServerSslProfile_CIPHERS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,
	model.LBServerSslProfile_CIPHERS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384,
	model.LBServerSslProfile_CIPHERS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,
	model.LBServerSslProfile_CIPHERS_ECDH_ECDSA_WITH_AES_128_CBC_SHA,
	model.LBServerSslProfile_CIPHERS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256,
	model.LBServerSslProfile_CIPHERS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256,
	model.LBServerSslProfile_CIPHERS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384,
	model.LBServerSslProfile_CIPHERS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384,
	model.LBServerSslProfile_CIPHERS_ECDH_RSA_WITH_AES_128_CBC_SHA,
	model.LBServerSslProfile_CIPHERS_ECDH_RSA_WITH_AES_128_CBC_SHA256,
	model.LBServerSslProfile_CIPHERS_ECDH_RSA_WITH_AES_128_GCM_SHA256,
	model.LBServerSslProfile_CIPHERS_ECDH_RSA_WITH_AES_256_CBC_SHA384,
	model.LBServerSslProfile_CIPHERS_ECDH_RSA_WITH_AES_256_GCM_SHA384,
}
	...
	"ciphers": {
		Schema: schema.Schema{
			...
			Elem: &metadata.ExtendedSchema{
				Schema: schema.Schema{
					Type:         schema.TypeString,
					ValidateFunc: validation.StringInSlice(lbServerSslProfileCiphersValues, false),
				},
				Metadata: metadata.Metadata{
					SchemaType: "string",
				},
