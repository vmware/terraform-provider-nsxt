...
// Data type definitions file for service: Attributes.
...
func AttributesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyContextProfileListResultBindingType)
}

func attributesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/context-profiles/attributes",
		"",
		resultHeaders,
		200,
		"",
