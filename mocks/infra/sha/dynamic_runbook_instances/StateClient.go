...
// Source: /Users/aruntony/Desktop/playground/vcf/vsphere-automation-sdk-go/services/nsxt/infra/sha/dynamic_runbook_instances/StateClient.go
...
func (m *MockStateClient) Get(instanceIdParam string) (model.OdsDynamicRunbookInstanceState, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", instanceIdParam)
	ret0, _ := ret[0].(model.OdsDynamicRunbookInstanceState)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Get indicates an expected call of Get.
func (mr *MockStateClientMockRecorder) Get(instanceIdParam interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockStateClient)(nil).Get), instanceIdParam)
}
