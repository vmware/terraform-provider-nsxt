...
var vpcServiceProfileModeValues = []string{
	model.VpcProfileDhcpConfig_MODE_NONE,
	model.VpcProfileDhcpConfig_MODE_DHCP_SERVER,
	model.VpcProfileDhcpConfig_MODE_DHCP_RELAY,
	model.VpcProfileDhcpConfig_MODE_DHCP_DISTRIBUTED,
}
				...
				Schema: map[string]*metadata.ExtendedSchema{
					...
					"mode": {
						Schema: schema.Schema{
							...
							Optional:     true,
							Default:      model.VpcProfileDhcpConfig_MODE_NONE,
						},
						Metadata: metadata.Metadata{
							SchemaType:   "string",
							SdkFieldName: "Mode",
