...
type GatewayInterfaceDadStateClient interface {
	...
	Get(orgIdParam string, projectIdParam string, segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.InterfaceDADState, error)
}
...
func NewGatewayInterfaceDadStateClient(connector vapiProtocolClient_.Connector) *gatewayInterfaceDadStateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segments.gateway_interface_dad_state")
...
func (gIface *gatewayInterfaceDadStateClient) Get(orgIdParam string, projectIdParam string, segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.InterfaceDADState, error) {
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.gateway_interface_dad_state", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.InterfaceDADState
