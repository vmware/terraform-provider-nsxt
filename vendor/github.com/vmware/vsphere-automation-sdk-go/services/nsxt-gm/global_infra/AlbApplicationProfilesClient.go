...
type AlbApplicationProfilesClient interface {
	...
	//
	// @param albApplicationprofileIdParam ALBApplicationProfile ID (required)
	// @return com.vmware.nsx_global_policy.model.ALBApplicationProfile
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albApplicationprofileIdParam string) (nsx_global_policyModel.ALBApplicationProfile, error)
	...
	// @return com.vmware.nsx_global_policy.model.ALBApplicationProfileApiResponse
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBApplicationProfileApiResponse, error)
...
func NewAlbApplicationProfilesClient(connector vapiProtocolClient_.Connector) *albApplicationProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_application_profiles")
...
func (aIface *albApplicationProfilesClient) Delete(albApplicationprofileIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_application_profiles", "delete", inputDataValue, executionContext)
...
func (aIface *albApplicationProfilesClient) Get(albApplicationprofileIdParam string) (nsx_global_policyModel.ALBApplicationProfile, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBApplicationProfile
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_application_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBApplicationProfile
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBApplicationProfile), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albApplicationProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBApplicationProfileApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBApplicationProfileApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_application_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBApplicationProfileApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBApplicationProfileApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albApplicationProfilesClient) Patch(albApplicationprofileIdParam string, aLBApplicationProfileParam nsx_global_policyModel.ALBApplicationProfile) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_application_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albApplicationProfilesClient) Update(albApplicationprofileIdParam string, aLBApplicationProfileParam nsx_global_policyModel.ALBApplicationProfile) (nsx_global_policyModel.ALBApplicationProfile, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_application_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBApplicationProfile
	if methodResult.IsSuccess() {
