...
type CrlsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(crlIdParam string, detailsParam *bool) (nsx_global_policyModel.TlsCrl, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Importcrl(crlIdParam string, tlsCrlParam nsx_global_policyModel.TlsCrl) (nsx_global_policyModel.TlsCrlListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, detailsParam *bool, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_global_policyModel.TlsCrlListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(crlIdParam string, tlsCrlParam nsx_global_policyModel.TlsCrl) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(crlIdParam string, tlsCrlParam nsx_global_policyModel.TlsCrl) (nsx_global_policyModel.TlsCrl, error)
}
...
func NewCrlsClient(connector vapiProtocolClient_.Connector) *crlsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.crls")
...
func (cIface *crlsClient) Delete(crlIdParam string) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.crls", "delete", inputDataValue, executionContext)
...
func (cIface *crlsClient) Get(crlIdParam string, detailsParam *bool) (nsx_global_policyModel.TlsCrl, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.TlsCrl
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.crls", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCrl
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.TlsCrl), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (cIface *crlsClient) Importcrl(crlIdParam string, tlsCrlParam nsx_global_policyModel.TlsCrl) (nsx_global_policyModel.TlsCrlListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.TlsCrlListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.crls", "importcrl", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCrlListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.TlsCrlListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (cIface *crlsClient) List(cursorParam *string, detailsParam *bool, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_global_policyModel.TlsCrlListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.crls", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCrlListResult
	if methodResult.IsSuccess() {
...
func (cIface *crlsClient) Patch(crlIdParam string, tlsCrlParam nsx_global_policyModel.TlsCrl) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.crls", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *crlsClient) Update(crlIdParam string, tlsCrlParam nsx_global_policyModel.TlsCrl) (nsx_global_policyModel.TlsCrl, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.crls", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCrl
	if methodResult.IsSuccess() {
