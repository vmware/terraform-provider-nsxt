...
func groupAssociationsListInputType() bindings.StructType {
...
func groupAssociationsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyResourceReferenceForEPListResultBindingType)
}

func groupAssociationsListRestMetadata() protocol.OperationRestMetadata {
