...
type SessionTimerProfileBindingsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(tier1IdParam string, sessionTimerProfileBindingIdParam string) (nsx_global_policyModel.SessionTimerProfileBindingMap, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(tier1IdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_global_policyModel.SessionTimerProfileBindingMap) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(tier1IdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_global_policyModel.SessionTimerProfileBindingMap) (nsx_global_policyModel.SessionTimerProfileBindingMap, error)
}
...
func NewSessionTimerProfileBindingsClient(connector vapiProtocolClient_.Connector) *sessionTimerProfileBindingsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_1s.session_timer_profile_bindings")
...
func (sIface *sessionTimerProfileBindingsClient) Delete(tier1IdParam string, sessionTimerProfileBindingIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_1s.session_timer_profile_bindings", "delete", inputDataValue, executionContext)
...
func (sIface *sessionTimerProfileBindingsClient) Get(tier1IdParam string, sessionTimerProfileBindingIdParam string) (nsx_global_policyModel.SessionTimerProfileBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_1s.session_timer_profile_bindings", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.SessionTimerProfileBindingMap
	if methodResult.IsSuccess() {
...
func (sIface *sessionTimerProfileBindingsClient) Patch(tier1IdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_global_policyModel.SessionTimerProfileBindingMap) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_1s.session_timer_profile_bindings", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *sessionTimerProfileBindingsClient) Update(tier1IdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_global_policyModel.SessionTimerProfileBindingMap) (nsx_global_policyModel.SessionTimerProfileBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_1s.session_timer_profile_bindings", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.SessionTimerProfileBindingMap
	if methodResult.IsSuccess() {
