...
func gatewayQosProfilesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/gateway-qos-profiles/{qosProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func gatewayQosProfilesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/gateway-qos-profiles",
		"",
		resultHeaders,
		200,
		"",
