...
type DhcpRelayConfigsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, dhcpRelayConfigIdParam string) (nsx_policyModel.DhcpRelayConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DhcpRelayConfigListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, dhcpRelayConfigIdParam string, dhcpRelayConfigParam nsx_policyModel.DhcpRelayConfig) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, dhcpRelayConfigIdParam string, dhcpRelayConfigParam nsx_policyModel.DhcpRelayConfig) (nsx_policyModel.DhcpRelayConfig, error)
}
...
func NewDhcpRelayConfigsClient(connector vapiProtocolClient_.Connector) *dhcpRelayConfigsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.dhcp_relay_configs")
...
func (dIface *dhcpRelayConfigsClient) Delete(orgIdParam string, projectIdParam string, dhcpRelayConfigIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.dhcp_relay_configs", "delete", inputDataValue, executionContext)
...
func (dIface *dhcpRelayConfigsClient) Get(orgIdParam string, projectIdParam string, dhcpRelayConfigIdParam string) (nsx_policyModel.DhcpRelayConfig, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.dhcp_relay_configs", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DhcpRelayConfig
	if methodResult.IsSuccess() {
...
func (dIface *dhcpRelayConfigsClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DhcpRelayConfigListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.dhcp_relay_configs", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DhcpRelayConfigListResult
	if methodResult.IsSuccess() {
...
func (dIface *dhcpRelayConfigsClient) Patch(orgIdParam string, projectIdParam string, dhcpRelayConfigIdParam string, dhcpRelayConfigParam nsx_policyModel.DhcpRelayConfig) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.dhcp_relay_configs", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dhcpRelayConfigsClient) Update(orgIdParam string, projectIdParam string, dhcpRelayConfigIdParam string, dhcpRelayConfigParam nsx_policyModel.DhcpRelayConfig) (nsx_policyModel.DhcpRelayConfig, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.dhcp_relay_configs", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DhcpRelayConfig
	if methodResult.IsSuccess() {
