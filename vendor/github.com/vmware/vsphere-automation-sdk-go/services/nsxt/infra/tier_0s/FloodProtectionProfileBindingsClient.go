...
type FloodProtectionProfileBindingsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(tier0IdParam string, floodProtectionProfileBindingIdParam string) (nsx_policyModel.FloodProtectionProfileBindingMap, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(tier0IdParam string, floodProtectionProfileBindingIdParam string, floodProtectionProfileBindingMapParam nsx_policyModel.FloodProtectionProfileBindingMap) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(tier0IdParam string, floodProtectionProfileBindingIdParam string, floodProtectionProfileBindingMapParam nsx_policyModel.FloodProtectionProfileBindingMap) (nsx_policyModel.FloodProtectionProfileBindingMap, error)
}
...
func NewFloodProtectionProfileBindingsClient(connector vapiProtocolClient_.Connector) *floodProtectionProfileBindingsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.flood_protection_profile_bindings")
...
func (fIface *floodProtectionProfileBindingsClient) Delete(tier0IdParam string, floodProtectionProfileBindingIdParam string) error {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.flood_protection_profile_bindings", "delete", inputDataValue, executionContext)
...
func (fIface *floodProtectionProfileBindingsClient) Get(tier0IdParam string, floodProtectionProfileBindingIdParam string) (nsx_policyModel.FloodProtectionProfileBindingMap, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.flood_protection_profile_bindings", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.FloodProtectionProfileBindingMap
	if methodResult.IsSuccess() {
...
func (fIface *floodProtectionProfileBindingsClient) Patch(tier0IdParam string, floodProtectionProfileBindingIdParam string, floodProtectionProfileBindingMapParam nsx_policyModel.FloodProtectionProfileBindingMap) error {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.flood_protection_profile_bindings", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), fIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (fIface *floodProtectionProfileBindingsClient) Update(tier0IdParam string, floodProtectionProfileBindingIdParam string, floodProtectionProfileBindingMapParam nsx_policyModel.FloodProtectionProfileBindingMap) (nsx_policyModel.FloodProtectionProfileBindingMap, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.flood_protection_profile_bindings", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.FloodProtectionProfileBindingMap
	if methodResult.IsSuccess() {
