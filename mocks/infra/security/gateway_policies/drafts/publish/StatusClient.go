...
// Source: /Users/aruntony/Desktop/playground/vcf/vsphere-automation-sdk-go/services/nsxt/infra/security/gateway_policies/drafts/publish/StatusClient.go
...
func (m *MockStatusClient) Get(draftIdParam string) (model.PublishTask, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStatusClientMockRecorder) Get(draftIdParam interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockStatusClient)(nil).Get), draftIdParam)
}
