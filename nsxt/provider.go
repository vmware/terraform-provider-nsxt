...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"nsxt_policy_tier0_gateway_interface": dataSourceNsxtPolicyTier0GatewayInterface(),
			"nsxt_policy_tier1_gateway":           dataSourceNsxtPolicyTier1Gateway(),
			// "nsxt_policy_tier1_gateway_interface":                    dataSourceNsxtPolicyTier1GatewayInterface(),
