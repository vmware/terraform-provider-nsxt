...
type InterfaceGroupsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(tier0IdParam string, localeServiceIdParam string, labelIdParam string) (nsx_policyModel.Tier0InterfaceGroup, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(tier0IdParam string, localeServiceIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.Tier0InterfaceGroupListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(tier0IdParam string, localeServiceIdParam string, labelIdParam string, tier0InterfaceGroupParam nsx_policyModel.Tier0InterfaceGroup) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(tier0IdParam string, localeServiceIdParam string, labelIdParam string, tier0InterfaceGroupParam nsx_policyModel.Tier0InterfaceGroup) (nsx_policyModel.Tier0InterfaceGroup, error)
}
...
func NewInterfaceGroupsClient(connector vapiProtocolClient_.Connector) *interfaceGroupsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.locale_services.interface_groups")
...
func (iIface *interfaceGroupsClient) Get(tier0IdParam string, localeServiceIdParam string, labelIdParam string) (nsx_policyModel.Tier0InterfaceGroup, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.Tier0InterfaceGroup
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.Tier0InterfaceGroup), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (iIface *interfaceGroupsClient) List(tier0IdParam string, localeServiceIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.Tier0InterfaceGroupListResult, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.Tier0InterfaceGroupListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.Tier0InterfaceGroupListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (iIface *interfaceGroupsClient) Patch(tier0IdParam string, localeServiceIdParam string, labelIdParam string, tier0InterfaceGroupParam nsx_policyModel.Tier0InterfaceGroup) error {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
...
func (iIface *interfaceGroupsClient) Update(tier0IdParam string, localeServiceIdParam string, labelIdParam string, tier0InterfaceGroupParam nsx_policyModel.Tier0InterfaceGroup) (nsx_policyModel.Tier0InterfaceGroup, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
