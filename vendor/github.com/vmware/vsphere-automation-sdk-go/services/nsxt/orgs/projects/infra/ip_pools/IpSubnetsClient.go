...
type IpSubnetsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string) (*vapiData_.StructValue, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string, ipAddressPoolSubnetParam *vapiData_.StructValue) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string, ipAddressPoolSubnetParam *vapiData_.StructValue) (*vapiData_.StructValue, error)
}
...
func NewIpSubnetsClient(connector vapiProtocolClient_.Connector) *ipSubnetsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_subnets")
...
func (iIface *ipSubnetsClient) Delete(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_subnets", "delete", inputDataValue, executionContext)
...
func (iIface *ipSubnetsClient) Get(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string) (*vapiData_.StructValue, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_subnets", "get", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
...
func (iIface *ipSubnetsClient) List(orgIdParam string, projectIdParam string, ipPoolIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IpAddressPoolSubnetListResult, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_subnets", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IpAddressPoolSubnetListResult
	if methodResult.IsSuccess() {
...
func (iIface *ipSubnetsClient) Patch(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string, ipAddressPoolSubnetParam *vapiData_.StructValue) error {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_subnets", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (iIface *ipSubnetsClient) Update(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string, ipAddressPoolSubnetParam *vapiData_.StructValue) (*vapiData_.StructValue, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_subnets", "update", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
