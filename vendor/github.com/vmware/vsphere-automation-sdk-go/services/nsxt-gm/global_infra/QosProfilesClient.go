...
type QosProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(qosProfileIdParam string) (nsx_global_policyModel.QosProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.QosProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(qosProfileIdParam string, qosProfileParam nsx_global_policyModel.QosProfile, overrideParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(qosProfileIdParam string, qosProfileParam nsx_global_policyModel.QosProfile, overrideParam *bool) (nsx_global_policyModel.QosProfile, error)
}
...
func NewQosProfilesClient(connector vapiProtocolClient_.Connector) *qosProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.qos_profiles")
...
func (qIface *qosProfilesClient) Delete(qosProfileIdParam string, overrideParam *bool) error {
	...
	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.qos_profiles", "delete", inputDataValue, executionContext)
...
func (qIface *qosProfilesClient) Get(qosProfileIdParam string) (nsx_global_policyModel.QosProfile, error) {
	typeConverter := qIface.connector.TypeConverter()
	executionContext := qIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.QosProfile
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.qos_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.QosProfile
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.QosProfile), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), qIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (qIface *qosProfilesClient) List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.QosProfileListResult, error) {
	typeConverter := qIface.connector.TypeConverter()
	executionContext := qIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.QosProfileListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.qos_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.QosProfileListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.QosProfileListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), qIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (qIface *qosProfilesClient) Patch(qosProfileIdParam string, qosProfileParam nsx_global_policyModel.QosProfile, overrideParam *bool) error {
	typeConverter := qIface.connector.TypeConverter()
	executionContext := qIface.connector.NewExecutionContext()
	...
	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.qos_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), qIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (qIface *qosProfilesClient) Update(qosProfileIdParam string, qosProfileParam nsx_global_policyModel.QosProfile, overrideParam *bool) (nsx_global_policyModel.QosProfile, error) {
	typeConverter := qIface.connector.TypeConverter()
	executionContext := qIface.connector.NewExecutionContext()
	...
	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.qos_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.QosProfile
	if methodResult.IsSuccess() {
