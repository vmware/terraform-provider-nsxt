...
type LocaleServicesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, tier1IdParam string, localeServicesIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, tier1IdParam string, localeServicesIdParam string) (nsx_policyModel.LocaleServices, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, tier1IdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LocaleServicesListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, tier1IdParam string, localeServicesIdParam string, localeServicesParam nsx_policyModel.LocaleServices) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, tier1IdParam string, localeServicesIdParam string, localeServicesParam nsx_policyModel.LocaleServices) (nsx_policyModel.LocaleServices, error)
}
...
func (lIface *localeServicesClient) Delete(orgIdParam string, projectIdParam string, tier1IdParam string, localeServicesIdParam string) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services", "delete", inputDataValue, executionContext)
...
func (lIface *localeServicesClient) Get(orgIdParam string, projectIdParam string, tier1IdParam string, localeServicesIdParam string) (nsx_policyModel.LocaleServices, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LocaleServices
	if methodResult.IsSuccess() {
...
func (lIface *localeServicesClient) List(orgIdParam string, projectIdParam string, tier1IdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LocaleServicesListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LocaleServicesListResult
	if methodResult.IsSuccess() {
...
func (lIface *localeServicesClient) Patch(orgIdParam string, projectIdParam string, tier1IdParam string, localeServicesIdParam string, localeServicesParam nsx_policyModel.LocaleServices) error {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *localeServicesClient) Update(orgIdParam string, projectIdParam string, tier1IdParam string, localeServicesIdParam string, localeServicesParam nsx_policyModel.LocaleServices) (nsx_policyModel.LocaleServices, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LocaleServices
	if methodResult.IsSuccess() {
