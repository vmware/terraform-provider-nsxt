...
func ServicesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.ServiceBindingType)
}
...
func ServicesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.ServiceListResultBindingType)
}
...
func servicesPatchInputType() vapiBindings_.StructType {
	...
	fieldNameMap := make(map[string]string)
	fields["service_id"] = vapiBindings_.NewStringType()
	fields["service"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ServiceBindingType)
	fieldNameMap["service_id"] = "ServiceId"
...
func ServicesPatchOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func servicesPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
	...
	fieldNameMap["service_id"] = "ServiceId"
	fieldNameMap["service"] = "Service"
	paramsTypeMap["service"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ServiceBindingType)
	paramsTypeMap["service_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["serviceId"] = vapiBindings_.NewStringType()
	pathParams["service_id"] = "serviceId"
	resultHeaders := map[string]string{}
