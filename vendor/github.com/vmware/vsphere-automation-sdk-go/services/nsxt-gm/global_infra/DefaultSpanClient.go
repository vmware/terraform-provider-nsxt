...
func NewDefaultSpanClient(connector client.Connector) *DefaultSpanClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.span"
...
func (sIface *DefaultSpanClient) Get(intentPathParam string, sitePathParam *string) (model.Span, error) {
