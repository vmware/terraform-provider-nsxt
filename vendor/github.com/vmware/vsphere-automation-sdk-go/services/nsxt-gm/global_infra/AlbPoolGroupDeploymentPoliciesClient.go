...
type AlbPoolGroupDeploymentPoliciesClient interface {
	...
	//
	// @param albPoolgroupdeploymentpolicyIdParam ALBPoolGroupDeploymentPolicy ID (required)
	// @return com.vmware.nsx_global_policy.model.ALBPoolGroupDeploymentPolicy
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albPoolgroupdeploymentpolicyIdParam string) (nsx_global_policyModel.ALBPoolGroupDeploymentPolicy, error)
	...
	// @return com.vmware.nsx_global_policy.model.ALBPoolGroupDeploymentPolicyApiResponse
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBPoolGroupDeploymentPolicyApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albPoolgroupdeploymentpolicyIdParam string, aLBPoolGroupDeploymentPolicyParam nsx_global_policyModel.ALBPoolGroupDeploymentPolicy) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albPoolgroupdeploymentpolicyIdParam string, aLBPoolGroupDeploymentPolicyParam nsx_global_policyModel.ALBPoolGroupDeploymentPolicy) (nsx_global_policyModel.ALBPoolGroupDeploymentPolicy, error)
}
...
func NewAlbPoolGroupDeploymentPoliciesClient(connector vapiProtocolClient_.Connector) *albPoolGroupDeploymentPoliciesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_pool_group_deployment_policies")
...
func (aIface *albPoolGroupDeploymentPoliciesClient) Delete(albPoolgroupdeploymentpolicyIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_pool_group_deployment_policies", "delete", inputDataValue, executionContext)
...
func (aIface *albPoolGroupDeploymentPoliciesClient) Get(albPoolgroupdeploymentpolicyIdParam string) (nsx_global_policyModel.ALBPoolGroupDeploymentPolicy, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBPoolGroupDeploymentPolicy
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_pool_group_deployment_policies", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBPoolGroupDeploymentPolicy
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBPoolGroupDeploymentPolicy), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albPoolGroupDeploymentPoliciesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBPoolGroupDeploymentPolicyApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBPoolGroupDeploymentPolicyApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_pool_group_deployment_policies", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBPoolGroupDeploymentPolicyApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBPoolGroupDeploymentPolicyApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albPoolGroupDeploymentPoliciesClient) Patch(albPoolgroupdeploymentpolicyIdParam string, aLBPoolGroupDeploymentPolicyParam nsx_global_policyModel.ALBPoolGroupDeploymentPolicy) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_pool_group_deployment_policies", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albPoolGroupDeploymentPoliciesClient) Update(albPoolgroupdeploymentpolicyIdParam string, aLBPoolGroupDeploymentPolicyParam nsx_global_policyModel.ALBPoolGroupDeploymentPolicy) (nsx_global_policyModel.ALBPoolGroupDeploymentPolicy, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_pool_group_deployment_policies", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBPoolGroupDeploymentPolicy
	if methodResult.IsSuccess() {
