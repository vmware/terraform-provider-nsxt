...
type AlbNetworkSecurityPoliciesClient interface {
	...
	//
	// @param albNetworksecuritypolicyIdParam ALBNetworkSecurityPolicy ID (required)
	// @return com.vmware.nsx_global_policy.model.ALBNetworkSecurityPolicy
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albNetworksecuritypolicyIdParam string) (nsx_global_policyModel.ALBNetworkSecurityPolicy, error)
	...
	// @return com.vmware.nsx_global_policy.model.ALBNetworkSecurityPolicyApiResponse
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBNetworkSecurityPolicyApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albNetworksecuritypolicyIdParam string, aLBNetworkSecurityPolicyParam nsx_global_policyModel.ALBNetworkSecurityPolicy) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albNetworksecuritypolicyIdParam string, aLBNetworkSecurityPolicyParam nsx_global_policyModel.ALBNetworkSecurityPolicy) (nsx_global_policyModel.ALBNetworkSecurityPolicy, error)
}
...
func NewAlbNetworkSecurityPoliciesClient(connector vapiProtocolClient_.Connector) *albNetworkSecurityPoliciesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_network_security_policies")
...
func (aIface *albNetworkSecurityPoliciesClient) Delete(albNetworksecuritypolicyIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_network_security_policies", "delete", inputDataValue, executionContext)
...
func (aIface *albNetworkSecurityPoliciesClient) Get(albNetworksecuritypolicyIdParam string) (nsx_global_policyModel.ALBNetworkSecurityPolicy, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBNetworkSecurityPolicy
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_network_security_policies", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBNetworkSecurityPolicy
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBNetworkSecurityPolicy), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albNetworkSecurityPoliciesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBNetworkSecurityPolicyApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBNetworkSecurityPolicyApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_network_security_policies", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBNetworkSecurityPolicyApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBNetworkSecurityPolicyApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albNetworkSecurityPoliciesClient) Patch(albNetworksecuritypolicyIdParam string, aLBNetworkSecurityPolicyParam nsx_global_policyModel.ALBNetworkSecurityPolicy) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_network_security_policies", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albNetworkSecurityPoliciesClient) Update(albNetworksecuritypolicyIdParam string, aLBNetworkSecurityPolicyParam nsx_global_policyModel.ALBNetworkSecurityPolicy) (nsx_global_policyModel.ALBNetworkSecurityPolicy, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_network_security_policies", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBNetworkSecurityPolicy
	if methodResult.IsSuccess() {
