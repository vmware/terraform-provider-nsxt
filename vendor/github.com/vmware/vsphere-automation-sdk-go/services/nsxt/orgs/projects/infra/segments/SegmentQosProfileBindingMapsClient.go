...
type SegmentQosProfileBindingMapsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, segmentIdParam string, segmentQosProfileBindingMapIdParam string) (nsx_policyModel.SegmentQosProfileBindingMap, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, segmentIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SegmentQosProfileBindingMapListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, segmentIdParam string, segmentQosProfileBindingMapIdParam string, segmentQosProfileBindingMapParam nsx_policyModel.SegmentQosProfileBindingMap) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, segmentIdParam string, segmentQosProfileBindingMapIdParam string, segmentQosProfileBindingMapParam nsx_policyModel.SegmentQosProfileBindingMap) (nsx_policyModel.SegmentQosProfileBindingMap, error)
}
...
func (sIface *segmentQosProfileBindingMapsClient) Delete(orgIdParam string, projectIdParam string, segmentIdParam string, segmentQosProfileBindingMapIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.segment_qos_profile_binding_maps", "delete", inputDataValue, executionContext)
...
func (sIface *segmentQosProfileBindingMapsClient) Get(orgIdParam string, projectIdParam string, segmentIdParam string, segmentQosProfileBindingMapIdParam string) (nsx_policyModel.SegmentQosProfileBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.segment_qos_profile_binding_maps", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentQosProfileBindingMap
	if methodResult.IsSuccess() {
...
func (sIface *segmentQosProfileBindingMapsClient) List(orgIdParam string, projectIdParam string, segmentIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SegmentQosProfileBindingMapListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.segment_qos_profile_binding_maps", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentQosProfileBindingMapListResult
	if methodResult.IsSuccess() {
...
func (sIface *segmentQosProfileBindingMapsClient) Patch(orgIdParam string, projectIdParam string, segmentIdParam string, segmentQosProfileBindingMapIdParam string, segmentQosProfileBindingMapParam nsx_policyModel.SegmentQosProfileBindingMap) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.segment_qos_profile_binding_maps", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *segmentQosProfileBindingMapsClient) Update(orgIdParam string, projectIdParam string, segmentIdParam string, segmentQosProfileBindingMapIdParam string, segmentQosProfileBindingMapParam nsx_policyModel.SegmentQosProfileBindingMap) (nsx_policyModel.SegmentQosProfileBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.segment_qos_profile_binding_maps", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentQosProfileBindingMap
	if methodResult.IsSuccess() {
