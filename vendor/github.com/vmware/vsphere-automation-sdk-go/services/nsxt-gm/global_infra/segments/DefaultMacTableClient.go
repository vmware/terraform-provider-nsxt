...
func NewDefaultMacTableClient(connector client.Connector) *DefaultMacTableClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.segments.mac_table"
...
func (mIface *DefaultMacTableClient) List(segmentIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (model.SegmentMacAddressListResult, error) {
