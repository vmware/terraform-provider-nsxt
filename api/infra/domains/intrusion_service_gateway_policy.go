...
func (c IntrusionServiceGatewayPolicyClientContext) List(domainIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includeRuleCountParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model0.IdsGatewayPolicyListResult, error) {
	...
	case utl.Local:
		client := c.Client.(interface {
			List(string, *string, *bool, *bool, *bool, *string, *int64, *bool, *string) (model0.IdsGatewayPolicyListResult, error)
		})
		obj, err = client.List(domainIdParam, cursorParam, nil, includeMarkForDeleteObjectsParam, includeRuleCountParam, includedFieldsParam, pageSizeParam, sortAscendingParam, sortByParam)
