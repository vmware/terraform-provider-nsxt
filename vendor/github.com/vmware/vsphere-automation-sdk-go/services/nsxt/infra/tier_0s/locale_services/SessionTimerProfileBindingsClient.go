...
type SessionTimerProfileBindingsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(tier0IdParam string, localeServicesIdParam string, sessionTimerProfileBindingIdParam string) (nsx_policyModel.SessionTimerProfileBindingMap, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(tier0IdParam string, localeServicesIdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_policyModel.SessionTimerProfileBindingMap) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(tier0IdParam string, localeServicesIdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_policyModel.SessionTimerProfileBindingMap) (nsx_policyModel.SessionTimerProfileBindingMap, error)
}
...
func NewSessionTimerProfileBindingsClient(connector vapiProtocolClient_.Connector) *sessionTimerProfileBindingsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.locale_services.session_timer_profile_bindings")
...
func (sIface *sessionTimerProfileBindingsClient) Delete(tier0IdParam string, localeServicesIdParam string, sessionTimerProfileBindingIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.locale_services.session_timer_profile_bindings", "delete", inputDataValue, executionContext)
...
func (sIface *sessionTimerProfileBindingsClient) Get(tier0IdParam string, localeServicesIdParam string, sessionTimerProfileBindingIdParam string) (nsx_policyModel.SessionTimerProfileBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.locale_services.session_timer_profile_bindings", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SessionTimerProfileBindingMap
	if methodResult.IsSuccess() {
...
func (sIface *sessionTimerProfileBindingsClient) Patch(tier0IdParam string, localeServicesIdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_policyModel.SessionTimerProfileBindingMap) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.locale_services.session_timer_profile_bindings", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *sessionTimerProfileBindingsClient) Update(tier0IdParam string, localeServicesIdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_policyModel.SessionTimerProfileBindingMap) (nsx_policyModel.SessionTimerProfileBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.locale_services.session_timer_profile_bindings", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SessionTimerProfileBindingMap
	if methodResult.IsSuccess() {
