		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, "is_default", accTestPolicyVpcServiceProfileCreateAttributes["is_default"]),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, "is_default", accTestPolicyVpcServiceProfileUpdateAttributes["is_default"]),
...
}`, testAccNsxtPolicyMultitenancyContext(), attrMap["display_name"], attrMap["description"], attrMap["is_default"], attrMap["ntp_servers"], attrMap["lease_time"], attrMap["mode"], attrMap["dns_server_ips"], attrMap["cache_size"], attrMap["log_level"])
}
...
resource "nsxt_vpc_service_profile" "test" {
  %s
  display_name = "%s"
}`, testAccNsxtPolicyMultitenancyContext(), accTestPolicyVpcServiceProfileUpdateAttributes["display_name"])
}
