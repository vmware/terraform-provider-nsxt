...
type CertificatesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(certificateIdParam string, detailsParam *bool) (nsx_global_policyModel.TlsCertificate, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, detailsParam *bool, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_global_policyModel.TlsCertificateList, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(certificateIdParam string, tlsTrustDataParam nsx_global_policyModel.TlsTrustData) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(certificateIdParam string, tlsTrustDataParam nsx_global_policyModel.TlsTrustData) (nsx_global_policyModel.TlsCertificate, error)
}
...
func NewCertificatesClient(connector vapiProtocolClient_.Connector) *certificatesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.certificates")
...
func (cIface *certificatesClient) Delete(certificateIdParam string) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.certificates", "delete", inputDataValue, executionContext)
...
func (cIface *certificatesClient) Get(certificateIdParam string, detailsParam *bool) (nsx_global_policyModel.TlsCertificate, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.certificates", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCertificate
	if methodResult.IsSuccess() {
...
func (cIface *certificatesClient) List(cursorParam *string, detailsParam *bool, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_global_policyModel.TlsCertificateList, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.TlsCertificateList
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.certificates", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCertificateList
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.TlsCertificateList), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (cIface *certificatesClient) Patch(certificateIdParam string, tlsTrustDataParam nsx_global_policyModel.TlsTrustData) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.certificates", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *certificatesClient) Update(certificateIdParam string, tlsTrustDataParam nsx_global_policyModel.TlsTrustData) (nsx_global_policyModel.TlsCertificate, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.certificates", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCertificate
	if methodResult.IsSuccess() {
