...
FEATURES:
Fabric support and user management support are offered with this release. For detailed list of supported objects, please see below.
...
Additional Beta features include separate security policy rule resource, LB profiles and GRE tunnel.
