...
type AlbIpAddrGroupsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albIpaddrgroupIdParam string) (nsx_global_policyModel.ALBIpAddrGroup, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBIpAddrGroupApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albIpaddrgroupIdParam string, aLBIpAddrGroupParam nsx_global_policyModel.ALBIpAddrGroup) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albIpaddrgroupIdParam string, aLBIpAddrGroupParam nsx_global_policyModel.ALBIpAddrGroup) (nsx_global_policyModel.ALBIpAddrGroup, error)
}
...
func NewAlbIpAddrGroupsClient(connector vapiProtocolClient_.Connector) *albIpAddrGroupsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_ip_addr_groups")
...
func (aIface *albIpAddrGroupsClient) Delete(albIpaddrgroupIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_ip_addr_groups", "delete", inputDataValue, executionContext)
...
func (aIface *albIpAddrGroupsClient) Get(albIpaddrgroupIdParam string) (nsx_global_policyModel.ALBIpAddrGroup, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBIpAddrGroup
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_ip_addr_groups", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBIpAddrGroup
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBIpAddrGroup), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albIpAddrGroupsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBIpAddrGroupApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_ip_addr_groups", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBIpAddrGroupApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBIpAddrGroupApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albIpAddrGroupsClient) Patch(albIpaddrgroupIdParam string, aLBIpAddrGroupParam nsx_global_policyModel.ALBIpAddrGroup) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_ip_addr_groups", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albIpAddrGroupsClient) Update(albIpaddrgroupIdParam string, aLBIpAddrGroupParam nsx_global_policyModel.ALBIpAddrGroup) (nsx_global_policyModel.ALBIpAddrGroup, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_ip_addr_groups", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBIpAddrGroup
	if methodResult.IsSuccess() {
