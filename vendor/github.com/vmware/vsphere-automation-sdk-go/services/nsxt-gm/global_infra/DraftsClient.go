...
type DraftsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(draftIdParam string) (nsx_global_policyModel.PolicyDraft, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(autoDraftsParam *bool, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyDraftListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(draftIdParam string, policyDraftParam nsx_global_policyModel.PolicyDraft) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Publish(draftIdParam string, infraParam nsx_global_policyModel.Infra) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(draftIdParam string, policyDraftParam nsx_global_policyModel.PolicyDraft) (nsx_global_policyModel.PolicyDraft, error)
}
...
func NewDraftsClient(connector vapiProtocolClient_.Connector) *draftsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.drafts")
...
func (dIface *draftsClient) Delete(draftIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.drafts", "delete", inputDataValue, executionContext)
...
func (dIface *draftsClient) Get(draftIdParam string) (nsx_global_policyModel.PolicyDraft, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyDraft
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.drafts", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyDraft
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyDraft), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (dIface *draftsClient) List(autoDraftsParam *bool, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyDraftListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyDraftListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.drafts", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyDraftListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyDraftListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (dIface *draftsClient) Patch(draftIdParam string, policyDraftParam nsx_global_policyModel.PolicyDraft) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.drafts", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *draftsClient) Publish(draftIdParam string, infraParam nsx_global_policyModel.Infra) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.drafts", "publish", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *draftsClient) Update(draftIdParam string, policyDraftParam nsx_global_policyModel.PolicyDraft) (nsx_global_policyModel.PolicyDraft, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.drafts", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyDraft
	if methodResult.IsSuccess() {
