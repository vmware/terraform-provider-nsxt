...
// Data type definitions file for service: ContainerIpPools.
...
func containerIpPoolsListInputType() vapiBindings_.StructType {
...
func ContainerIpPoolsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ContainerIpPoolListResultBindingType)
}

func containerIpPoolsListRestMetadata() vapiProtocol_.OperationRestMetadata {
