...
func dhcpStaticBindingConfigsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/segments/{segmentId}/dhcp-static-binding-configs/{bindingId}",
		"",
		resultHeaders,
		204,
		"",
...
func dhcpStaticBindingConfigsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/segments/{segmentId}/dhcp-static-binding-configs",
		"",
		resultHeaders,
		200,
		"",
