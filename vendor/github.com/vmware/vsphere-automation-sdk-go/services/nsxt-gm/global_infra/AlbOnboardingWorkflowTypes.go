...
func albOnboardingWorkflowDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/global-manager/api/v1/global-infra/alb-onboarding-workflow/{managedBy}",
		"",
		resultHeaders,
		204,
		"",
...
func albOnboardingWorkflowUpdateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["a_LB_controller_configuration"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ALBControllerConfigurationBindingType)
...
func albOnboardingWorkflowUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["a_LB_controller_configuration"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ALBControllerConfigurationBindingType)
	fieldNameMap["a_LB_controller_configuration"] = "ALBControllerConfiguration"
	paramsTypeMap["a_LB_controller_configuration"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ALBControllerConfigurationBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
		...
		"PUT",
		"/global-manager/api/v1/global-infra/alb-onboarding-workflow",
		"",
		resultHeaders,
		200,
		"",
