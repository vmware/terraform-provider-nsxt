		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(testResourceName, "locale_service.2097025006.edge_cluster_path"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.2097025006.preferred_edge_paths.#", "1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(testResourceName, "locale_service.2097025006.edge_cluster_path"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.2097025006.preferred_edge_paths.#", "1"),
					resource.TestCheckResourceAttrSet(testResourceName, "locale_service.4230003402.edge_cluster_path"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.4230003402.preferred_edge_paths.#", "0"),
					resource.TestCheckResourceAttr(testResourceName, "intersite_config.#", "1"),
					resource.TestCheckResourceAttr(testResourceName, "intersite_config.0.transit_subnet", testAccGmGatewayIntersiteSubnet),
					resource.TestCheckResourceAttrSet(testResourceName, "intersite_config.0.primary_site_path"),
					resource.TestCheckResourceAttrSet(testResourceName, "path"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, "ha_mode", "ACTIVE_ACTIVE"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.#", "1"),
					resource.TestCheckResourceAttrSet(testResourceName, "locale_service.190475003.edge_cluster_path"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.190475003.redistribution_config.#", "1"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.190475003.redistribution_config.0.enabled", "false"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.190475003.redistribution_config.0.rule.0.name", "test-rule-1"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.190475003.redistribution_config.0.rule.0.types.#", "3"),
					resource.TestCheckResourceAttrSet(testResourceName, "path"),
					resource.TestCheckResourceAttrSet(testResourceName, "revision"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, "ha_mode", "ACTIVE_ACTIVE"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.#", "2"),
					resource.TestCheckResourceAttrSet(testResourceName, "locale_service.256752120.edge_cluster_path"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.256752120.redistribution_config.#", "0"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.1377309837.redistribution_config.#", "1"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.1377309837.redistribution_config.0.enabled", "true"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.1377309837.redistribution_config.0.rule.0.name", "test-rule-2"),
					resource.TestCheckResourceAttr(testResourceName, "locale_service.1377309837.redistribution_config.0.rule.0.types.#", "3"),
					resource.TestCheckResourceAttrSet(testResourceName, "path"),
					resource.TestCheckResourceAttrSet(testResourceName, "revision"),
				),
			},
