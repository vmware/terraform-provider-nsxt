...
type ConstraintsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, constraintIdParam string) (nsx_policyModel.Constraint, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, constraintIdParam string, constraintParam nsx_policyModel.Constraint) (nsx_policyModel.Constraint, error)
}
...
func NewConstraintsClient(connector vapiProtocolClient_.Connector) *constraintsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.constraints")
...
func (cIface *constraintsClient) Delete(orgIdParam string, projectIdParam string, constraintIdParam string) error {
	...
	sv := vapiBindings_.NewStructValueBuilder(constraintsDeleteInputType(), typeConverter)
...
func (cIface *constraintsClient) Get(orgIdParam string, projectIdParam string, constraintIdParam string) (nsx_policyModel.Constraint, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.Constraint
...
func (cIface *constraintsClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ConstraintListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	sv := vapiBindings_.NewStructValueBuilder(constraintsListInputType(), typeConverter)
	sv.AddStructField("OrgId", orgIdParam)
	sv.AddStructField("ProjectId", projectIdParam)
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.ConstraintListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ConstraintListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (cIface *constraintsClient) Patch(orgIdParam string, projectIdParam string, constraintIdParam string, constraintParam nsx_policyModel.Constraint) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	sv := vapiBindings_.NewStructValueBuilder(constraintsPatchInputType(), typeConverter)
	sv.AddStructField("OrgId", orgIdParam)
	sv.AddStructField("ProjectId", projectIdParam)
	sv.AddStructField("ConstraintId", constraintIdParam)
...
func (cIface *constraintsClient) Update(orgIdParam string, projectIdParam string, constraintIdParam string, constraintParam nsx_policyModel.Constraint) (nsx_policyModel.Constraint, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	sv := vapiBindings_.NewStructValueBuilder(constraintsUpdateInputType(), typeConverter)
	sv.AddStructField("OrgId", orgIdParam)
	sv.AddStructField("ProjectId", projectIdParam)
	sv.AddStructField("ConstraintId", constraintIdParam)
	sv.AddStructField("Constraint", constraintParam)
