...
type TepTableClient interface {
	...
	List(segmentIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_global_policyModel.PolicyTepListResult, error)
}
...
func NewTepTableClient(connector vapiProtocolClient_.Connector) *tepTableClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.segments.tep_table")
...
func (tIface *tepTableClient) List(segmentIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_global_policyModel.PolicyTepListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyTepListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyTepListResult), nil
	} else {
