...
type VirtualMachineGroupAssociationsClient interface {
	...
	List(orgIdParam string, projectIdParam string, vmExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyResourceReferenceForEPListResult, error)
}
...
func NewVirtualMachineGroupAssociationsClient(connector vapiProtocolClient_.Connector) *virtualMachineGroupAssociationsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.virtual_machine_group_associations")
...
func (vIface *virtualMachineGroupAssociationsClient) List(orgIdParam string, projectIdParam string, vmExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyResourceReferenceForEPListResult, error) {
	...
	methodResult := vIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.virtual_machine_group_associations", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyResourceReferenceForEPListResult
