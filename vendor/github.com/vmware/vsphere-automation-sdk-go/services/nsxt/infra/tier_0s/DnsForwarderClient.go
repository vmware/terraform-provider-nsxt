...
func NewDnsForwarderClient(connector client.Connector) *dnsForwarderClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.dns_forwarder")
...
func (dIface *dnsForwarderClient) Create(tier0IdParam string, actionParam string, enforcementPointPathParam *string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.dns_forwarder", "create", inputDataValue, executionContext)
...
func (dIface *dnsForwarderClient) Delete(tier0IdParam string) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.dns_forwarder", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dnsForwarderClient) Get(tier0IdParam string) (model.PolicyDnsForwarder, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.dns_forwarder", "get", inputDataValue, executionContext)
	var emptyOutput model.PolicyDnsForwarder
	if methodResult.IsSuccess() {
...
func (dIface *dnsForwarderClient) Patch(tier0IdParam string, policyDnsForwarderParam model.PolicyDnsForwarder) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.dns_forwarder", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dnsForwarderClient) Update(tier0IdParam string, policyDnsForwarderParam model.PolicyDnsForwarder) (model.PolicyDnsForwarder, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.dns_forwarder", "update", inputDataValue, executionContext)
	var emptyOutput model.PolicyDnsForwarder
	if methodResult.IsSuccess() {
