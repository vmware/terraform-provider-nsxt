...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_0s.nat.nat_rules.statistics"
...
func (sIface *DefaultStatisticsClient) List(tier0IdParam string, natIdParam string, natRuleIdParam string, enforcementPointPathParam *string) (model.PolicyNatRuleStatisticsListResult, error) {
