...
// Source: /Users/aruntony/Desktop/playground/vcf/vsphere-automation-sdk-go/services/nsxt/infra/segments/dhcp_static_bindings/StateClient.go
...
func (m *MockStateClient) Get(segmentIdParam, bindingIdParam string) (model.DhcpStaticBindingState, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStateClientMockRecorder) Get(segmentIdParam, bindingIdParam interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockStateClient)(nil).Get), segmentIdParam, bindingIdParam)
}
