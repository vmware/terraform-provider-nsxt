...
func (c IdsSecurityPolicyClientContext) Get(domainIdParam string, policyIdParam string) (model0.IdsSecurityPolicy, error) {
	...
	case utl.Local:
		client := c.Client.(interface {
			Get(string, string) (model0.IdsSecurityPolicy, error)
		})
	...
	case utl.Multitenancy:
		client := c.Client.(interface {
			Get(string, string, string, string) (model0.IdsSecurityPolicy, error)
		})
...
func (c IdsSecurityPolicyClientContext) List(domainIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includeRuleCountParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model0.IdsSecurityPolicyListResult, error) {
	...
	case utl.Local:
		client := c.Client.(interface {
			List(string, *string, *bool, *bool, *bool, *string, *int64, *bool, *string) (model0.IdsSecurityPolicyListResult, error)
		})
	...
	case utl.Multitenancy:
		client := c.Client.(interface {
			List(string, string, string, *string, *bool, *bool, *bool, *string, *int64, *bool, *string) (model0.IdsSecurityPolicyListResult, error)
		})
		obj, err = client.List(utl.DefaultOrgID, c.ProjectID, domainIdParam, cursorParam, nil, includeMarkForDeleteObjectsParam, includeRuleCountParam, includedFieldsParam, pageSizeParam, sortAscendingParam, sortByParam)
...
func (c IdsSecurityPolicyClientContext) Patch(domainIdParam string, policyIdParam string, idsSecurityPolicyParam model0.IdsSecurityPolicy) error {
	...
	case utl.Local:
		client := c.Client.(interface {
			Patch(string, string, model0.IdsSecurityPolicy) error
		})
		err = client.Patch(domainIdParam, policyIdParam, idsSecurityPolicyParam)

	case utl.Multitenancy:
		client := c.Client.(interface {
			Patch(string, string, string, string, model0.IdsSecurityPolicy) error
		})
...
func (c IdsSecurityPolicyClientContext) Update(domainIdParam string, policyIdParam string, idsSecurityPolicyParam model0.IdsSecurityPolicy) (model0.IdsSecurityPolicy, error) {
	...
	case utl.Local:
		client := c.Client.(interface {
			Update(string, string, model0.IdsSecurityPolicy) (model0.IdsSecurityPolicy, error)
		})
		obj, err = client.Update(domainIdParam, policyIdParam, idsSecurityPolicyParam)

	case utl.Multitenancy:
		client := c.Client.(interface {
			Update(string, string, string, string, model0.IdsSecurityPolicy) (model0.IdsSecurityPolicy, error)
		})
