...
func enforcementPointsGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.RealizedEnforcementPointBindingType)
}
...
func enforcementPointsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.RealizedEnforcementPointListResultBindingType)
}
