...
type MacTableClient interface {
	...
	List(tier1IdParam string, segmentIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_global_policyModel.SegmentMacAddressListResult, error)
}
...
func NewMacTableClient(connector vapiProtocolClient_.Connector) *macTableClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_1s.segments.mac_table")
...
func (mIface *macTableClient) List(tier1IdParam string, segmentIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_global_policyModel.SegmentMacAddressListResult, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_1s.segments.mac_table", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.SegmentMacAddressListResult
