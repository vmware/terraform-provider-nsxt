...
func NewGatewayFirewallClient(connector client.Connector) *gatewayFirewallClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_1s.locale_services.gateway_firewall")
...
func (gIface *gatewayFirewallClient) List(tier1IdParam string, localeServicesIdParam string) (model.GatewayPolicyListResult, error) {
