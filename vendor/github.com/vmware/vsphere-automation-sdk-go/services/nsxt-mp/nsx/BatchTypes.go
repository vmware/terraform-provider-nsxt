...
func batchCreateInputType() vapiBindings_.StructType {
	...
	fields["batch_request"] = vapiBindings_.NewReferenceType(nsxModel.BatchRequestBindingType)
...
func BatchCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.BatchResponseBindingType)
}
...
func batchCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["batch_request"] = "BatchRequest"
	fieldNameMap["atomic"] = "Atomic"
	paramsTypeMap["batch_request"] = vapiBindings_.NewReferenceType(nsxModel.BatchRequestBindingType)
