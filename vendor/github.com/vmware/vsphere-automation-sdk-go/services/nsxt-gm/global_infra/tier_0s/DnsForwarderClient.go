...
type DnsForwarderClient interface {
	...
	//
	// @param tier0IdParam Tier-0 ID (required)
	// @return com.vmware.nsx_global_policy.model.PolicyDnsForwarder
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(tier0IdParam string) (nsx_global_policyModel.PolicyDnsForwarder, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(tier0IdParam string, policyDnsForwarderParam nsx_global_policyModel.PolicyDnsForwarder) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(tier0IdParam string, policyDnsForwarderParam nsx_global_policyModel.PolicyDnsForwarder) (nsx_global_policyModel.PolicyDnsForwarder, error)
}
...
func NewDnsForwarderClient(connector vapiProtocolClient_.Connector) *dnsForwarderClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_0s.dns_forwarder")
...
func (dIface *dnsForwarderClient) Create(tier0IdParam string, actionParam string, enforcementPointPathParam *string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_0s.dns_forwarder", "create", inputDataValue, executionContext)
...
func (dIface *dnsForwarderClient) Delete(tier0IdParam string) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_0s.dns_forwarder", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dnsForwarderClient) Get(tier0IdParam string) (nsx_global_policyModel.PolicyDnsForwarder, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyDnsForwarder
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_0s.dns_forwarder", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyDnsForwarder
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyDnsForwarder), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (dIface *dnsForwarderClient) Patch(tier0IdParam string, policyDnsForwarderParam nsx_global_policyModel.PolicyDnsForwarder) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_0s.dns_forwarder", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dnsForwarderClient) Update(tier0IdParam string, policyDnsForwarderParam nsx_global_policyModel.PolicyDnsForwarder) (nsx_global_policyModel.PolicyDnsForwarder, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_0s.dns_forwarder", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyDnsForwarder
	if methodResult.IsSuccess() {
