...
type DhcpServerConfigsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(dhcpServerConfigIdParam string) (nsx_global_policyModel.DhcpServerConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.DhcpServerConfigListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(dhcpServerConfigIdParam string, dhcpServerConfigParam nsx_global_policyModel.DhcpServerConfig) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(dhcpServerConfigIdParam string, dhcpServerConfigParam nsx_global_policyModel.DhcpServerConfig) (nsx_global_policyModel.DhcpServerConfig, error)
}
...
func NewDhcpServerConfigsClient(connector vapiProtocolClient_.Connector) *dhcpServerConfigsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.dhcp_server_configs")
...
func (dIface *dhcpServerConfigsClient) Delete(dhcpServerConfigIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.dhcp_server_configs", "delete", inputDataValue, executionContext)
...
func (dIface *dhcpServerConfigsClient) Get(dhcpServerConfigIdParam string) (nsx_global_policyModel.DhcpServerConfig, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.DhcpServerConfig
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.dhcp_server_configs", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.DhcpServerConfig
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.DhcpServerConfig), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (dIface *dhcpServerConfigsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.DhcpServerConfigListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.DhcpServerConfigListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.dhcp_server_configs", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.DhcpServerConfigListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.DhcpServerConfigListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (dIface *dhcpServerConfigsClient) Patch(dhcpServerConfigIdParam string, dhcpServerConfigParam nsx_global_policyModel.DhcpServerConfig) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.dhcp_server_configs", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dhcpServerConfigsClient) Update(dhcpServerConfigIdParam string, dhcpServerConfigParam nsx_global_policyModel.DhcpServerConfig) (nsx_global_policyModel.DhcpServerConfig, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.dhcp_server_configs", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.DhcpServerConfig
	if methodResult.IsSuccess() {
