...
// Data type definitions file for service: AffectedIps.
...
func affectedIpsCreateInputType() bindings.StructType {
...
func affectedIpsCreateOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyIdsIpListBindingType)
}

func affectedIpsCreateRestMetadata() protocol.OperationRestMetadata {
