...
// Data type definitions file for service: ContainerEgresses.
...
func containerEgressesListInputType() vapiBindings_.StructType {
...
func ContainerEgressesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ContainerEgressListResultBindingType)
}

func containerEgressesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/fabric/container-egresses",
		"",
		resultHeaders,
		200,
		"",
