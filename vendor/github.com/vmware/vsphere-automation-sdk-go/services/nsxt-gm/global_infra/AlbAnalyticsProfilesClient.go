...
type AlbAnalyticsProfilesClient interface {
	...
	//
	// @param albAnalyticsprofileIdParam ALBAnalyticsProfile ID (required)
	// @return com.vmware.nsx_global_policy.model.ALBAnalyticsProfile
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albAnalyticsprofileIdParam string) (nsx_global_policyModel.ALBAnalyticsProfile, error)
	...
	// @return com.vmware.nsx_global_policy.model.ALBAnalyticsProfileApiResponse
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBAnalyticsProfileApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albAnalyticsprofileIdParam string, aLBAnalyticsProfileParam nsx_global_policyModel.ALBAnalyticsProfile) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albAnalyticsprofileIdParam string, aLBAnalyticsProfileParam nsx_global_policyModel.ALBAnalyticsProfile) (nsx_global_policyModel.ALBAnalyticsProfile, error)
}
...
func NewAlbAnalyticsProfilesClient(connector vapiProtocolClient_.Connector) *albAnalyticsProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_analytics_profiles")
...
func (aIface *albAnalyticsProfilesClient) Delete(albAnalyticsprofileIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_analytics_profiles", "delete", inputDataValue, executionContext)
...
func (aIface *albAnalyticsProfilesClient) Get(albAnalyticsprofileIdParam string) (nsx_global_policyModel.ALBAnalyticsProfile, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBAnalyticsProfile
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_analytics_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBAnalyticsProfile
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBAnalyticsProfile), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albAnalyticsProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBAnalyticsProfileApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBAnalyticsProfileApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_analytics_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBAnalyticsProfileApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBAnalyticsProfileApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albAnalyticsProfilesClient) Patch(albAnalyticsprofileIdParam string, aLBAnalyticsProfileParam nsx_global_policyModel.ALBAnalyticsProfile) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_analytics_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albAnalyticsProfilesClient) Update(albAnalyticsprofileIdParam string, aLBAnalyticsProfileParam nsx_global_policyModel.ALBAnalyticsProfile) (nsx_global_policyModel.ALBAnalyticsProfile, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_analytics_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBAnalyticsProfile
	if methodResult.IsSuccess() {
