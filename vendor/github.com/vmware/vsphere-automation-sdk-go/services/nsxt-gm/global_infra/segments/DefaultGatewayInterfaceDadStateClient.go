...
func NewDefaultGatewayInterfaceDadStateClient(connector client.Connector) *DefaultGatewayInterfaceDadStateClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.segments.gateway_interface_dad_state"
...
func (gIface *DefaultGatewayInterfaceDadStateClient) Get(segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.InterfaceDADState, error) {
