...
func StatisticsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.PolicyNatRuleStatisticsPerLogicalRouterListResultBindingType)
}
...
func statisticsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tier-0s/{tier0Id}/nat/statistics",
		"",
		resultHeaders,
		200,
		"",
