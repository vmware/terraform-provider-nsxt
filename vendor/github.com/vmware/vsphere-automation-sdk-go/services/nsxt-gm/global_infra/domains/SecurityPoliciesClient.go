...
type SecurityPoliciesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(domainIdParam string, securityPolicyIdParam string) (nsx_global_policyModel.SecurityPolicy, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(domainIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includeRuleCountParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.SecurityPolicyListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(domainIdParam string, securityPolicyIdParam string, securityPolicyParam nsx_global_policyModel.SecurityPolicy) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Revise(domainIdParam string, securityPolicyIdParam string, securityPolicyParam nsx_global_policyModel.SecurityPolicy, anchorPathParam *string, operationParam *string) (nsx_global_policyModel.SecurityPolicy, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(domainIdParam string, securityPolicyIdParam string, securityPolicyParam nsx_global_policyModel.SecurityPolicy) (nsx_global_policyModel.SecurityPolicy, error)
}
...
func NewSecurityPoliciesClient(connector vapiProtocolClient_.Connector) *securityPoliciesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.security_policies")
...
func (sIface *securityPoliciesClient) Get(domainIdParam string, securityPolicyIdParam string) (nsx_global_policyModel.SecurityPolicy, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.SecurityPolicy
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.SecurityPolicy), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (sIface *securityPoliciesClient) List(domainIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includeRuleCountParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.SecurityPolicyListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.SecurityPolicyListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.SecurityPolicyListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (sIface *securityPoliciesClient) Patch(domainIdParam string, securityPolicyIdParam string, securityPolicyParam nsx_global_policyModel.SecurityPolicy) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
...
func (sIface *securityPoliciesClient) Revise(domainIdParam string, securityPolicyIdParam string, securityPolicyParam nsx_global_policyModel.SecurityPolicy, anchorPathParam *string, operationParam *string) (nsx_global_policyModel.SecurityPolicy, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
...
func (sIface *securityPoliciesClient) Update(domainIdParam string, securityPolicyIdParam string, securityPolicyParam nsx_global_policyModel.SecurityPolicy) (nsx_global_policyModel.SecurityPolicy, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
