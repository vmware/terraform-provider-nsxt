...
type AlbErrorPageProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albErrorpageprofileIdParam string) (nsx_policyModel.ALBErrorPageProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ALBErrorPageProfileApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albErrorpageprofileIdParam string, aLBErrorPageProfileParam nsx_policyModel.ALBErrorPageProfile) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albErrorpageprofileIdParam string, aLBErrorPageProfileParam nsx_policyModel.ALBErrorPageProfile) (nsx_policyModel.ALBErrorPageProfile, error)
}
...
func NewAlbErrorPageProfilesClient(connector vapiProtocolClient_.Connector) *albErrorPageProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.alb_error_page_profiles")
...
func (aIface *albErrorPageProfilesClient) Get(albErrorpageprofileIdParam string) (nsx_policyModel.ALBErrorPageProfile, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.ALBErrorPageProfile
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ALBErrorPageProfile), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albErrorPageProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ALBErrorPageProfileApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.ALBErrorPageProfileApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ALBErrorPageProfileApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albErrorPageProfilesClient) Patch(albErrorpageprofileIdParam string, aLBErrorPageProfileParam nsx_policyModel.ALBErrorPageProfile) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
...
func (aIface *albErrorPageProfilesClient) Update(albErrorpageprofileIdParam string, aLBErrorPageProfileParam nsx_policyModel.ALBErrorPageProfile) (nsx_policyModel.ALBErrorPageProfile, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
