...
func NewStaticRoutesClient(connector client.Connector) *staticRoutesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.static_routes")
...
func (sIface *staticRoutesClient) Delete(tier0IdParam string, routeIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.static_routes", "delete", inputDataValue, executionContext)
...
func (sIface *staticRoutesClient) Get(tier0IdParam string, routeIdParam string) (model.StaticRoutes, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.static_routes", "get", inputDataValue, executionContext)
	var emptyOutput model.StaticRoutes
	if methodResult.IsSuccess() {
...
func (sIface *staticRoutesClient) List(tier0IdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.StaticRoutesListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.static_routes", "list", inputDataValue, executionContext)
	var emptyOutput model.StaticRoutesListResult
	if methodResult.IsSuccess() {
...
func (sIface *staticRoutesClient) Patch(tier0IdParam string, routeIdParam string, staticRoutesParam model.StaticRoutes) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.static_routes", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *staticRoutesClient) Update(tier0IdParam string, routeIdParam string, staticRoutesParam model.StaticRoutes) (model.StaticRoutes, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.static_routes", "update", inputDataValue, executionContext)
	var emptyOutput model.StaticRoutes
	if methodResult.IsSuccess() {
