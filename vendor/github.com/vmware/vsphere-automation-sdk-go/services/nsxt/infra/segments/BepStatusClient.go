...
type BepStatusClient interface {
	...
	Get(segmentIdParam string, bridgeProfilePathParam string, enforcementPointPathParam *string) (model.BridgeEndpointStatus, error)
}
...
func NewBepStatusClient(connector client.Connector) *bepStatusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.segments.bep_status")
...
func (bIface *bepStatusClient) Get(segmentIdParam string, bridgeProfilePathParam string, enforcementPointPathParam *string) (model.BridgeEndpointStatus, error) {
