...
func idsSummaryCreateOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyIdsSummaryListResultBindingType)
}

func idsSummaryCreateRestMetadata() protocol.OperationRestMetadata {
