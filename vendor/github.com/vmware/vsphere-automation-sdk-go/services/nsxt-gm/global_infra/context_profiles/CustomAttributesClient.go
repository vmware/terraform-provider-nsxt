...
type CustomAttributesClient interface {
	...
	Create(policyAttributesParam nsx_global_policyModel.PolicyAttributes, actionParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(policyAttributesParam nsx_global_policyModel.PolicyAttributes) error
}
...
func NewCustomAttributesClient(connector vapiProtocolClient_.Connector) *customAttributesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.context_profiles.custom_attributes")
...
func (cIface *customAttributesClient) Create(policyAttributesParam nsx_global_policyModel.PolicyAttributes, actionParam string) error {
...
func (cIface *customAttributesClient) Patch(policyAttributesParam nsx_global_policyModel.PolicyAttributes) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
