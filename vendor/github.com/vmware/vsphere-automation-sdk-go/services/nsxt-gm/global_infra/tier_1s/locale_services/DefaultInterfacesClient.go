...
func NewDefaultInterfacesClient(connector client.Connector) *DefaultInterfacesClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_1s.locale_services.interfaces"
...
func (iIface *DefaultInterfacesClient) Get(tier1IdParam string, localeServicesIdParam string, interfaceIdParam string) (model.Tier1Interface, error) {
	typeConverter := iIface.connector.TypeConverter()
...
func (iIface *DefaultInterfacesClient) List(tier1IdParam string, localeServicesIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.Tier1InterfaceListResult, error) {
	typeConverter := iIface.connector.TypeConverter()
