...
func NewDefaultNeighborsClient(connector client.Connector) *DefaultNeighborsClient {
	interfaceName := "com.vmware.nsx_policy.infra.tier_0s.locale_services.ospf.neighbors"
...
func (nIface *DefaultNeighborsClient) List(tier0IdParam string, localeServiceIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, neighborAddressParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.OspfNeighborsStatusListResult, error) {
