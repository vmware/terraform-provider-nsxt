...
type AlbL4PolicySetsClient interface {
	...
	//
	// @param albL4policysetIdParam ALBL4PolicySet ID (required)
	// @return com.vmware.nsx_global_policy.model.ALBL4PolicySet
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albL4policysetIdParam string) (nsx_global_policyModel.ALBL4PolicySet, error)
	...
	// @return com.vmware.nsx_global_policy.model.ALBL4PolicySetApiResponse
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBL4PolicySetApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albL4policysetIdParam string, aLBL4PolicySetParam nsx_global_policyModel.ALBL4PolicySet) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albL4policysetIdParam string, aLBL4PolicySetParam nsx_global_policyModel.ALBL4PolicySet) (nsx_global_policyModel.ALBL4PolicySet, error)
}
...
func NewAlbL4PolicySetsClient(connector vapiProtocolClient_.Connector) *albL4PolicySetsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_l4_policy_sets")
...
func (aIface *albL4PolicySetsClient) Delete(albL4policysetIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_l4_policy_sets", "delete", inputDataValue, executionContext)
...
func (aIface *albL4PolicySetsClient) Get(albL4policysetIdParam string) (nsx_global_policyModel.ALBL4PolicySet, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBL4PolicySet
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_l4_policy_sets", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBL4PolicySet
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBL4PolicySet), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albL4PolicySetsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBL4PolicySetApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBL4PolicySetApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_l4_policy_sets", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBL4PolicySetApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBL4PolicySetApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albL4PolicySetsClient) Patch(albL4policysetIdParam string, aLBL4PolicySetParam nsx_global_policyModel.ALBL4PolicySet) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_l4_policy_sets", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albL4PolicySetsClient) Update(albL4policysetIdParam string, aLBL4PolicySetParam nsx_global_policyModel.ALBL4PolicySet) (nsx_global_policyModel.ALBL4PolicySet, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_l4_policy_sets", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBL4PolicySet
	if methodResult.IsSuccess() {
