...
func NewFirewallSessionTimerProfilesClient(connector vapiProtocolClient_.Connector) *firewallSessionTimerProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.firewall_session_timer_profiles")
...
func (fIface *firewallSessionTimerProfilesClient) Delete(orgIdParam string, projectIdParam string, firewallSessionTimerProfileIdParam string, overrideParam *bool) error {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.firewall_session_timer_profiles", "delete", inputDataValue, executionContext)
...
func (fIface *firewallSessionTimerProfilesClient) Get(orgIdParam string, projectIdParam string, firewallSessionTimerProfileIdParam string) (nsx_policyModel.PolicyFirewallSessionTimerProfile, error) {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.firewall_session_timer_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyFirewallSessionTimerProfile
	if methodResult.IsSuccess() {
...
func (fIface *firewallSessionTimerProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyFirewallSessionTimerProfileListResult, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.firewall_session_timer_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyFirewallSessionTimerProfileListResult
	if methodResult.IsSuccess() {
...
func (fIface *firewallSessionTimerProfilesClient) Patch(orgIdParam string, projectIdParam string, firewallSessionTimerProfileIdParam string, policyFirewallSessionTimerProfileParam nsx_policyModel.PolicyFirewallSessionTimerProfile, overrideParam *bool) error {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.firewall_session_timer_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), fIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (fIface *firewallSessionTimerProfilesClient) Update(orgIdParam string, projectIdParam string, firewallSessionTimerProfileIdParam string, policyFirewallSessionTimerProfileParam nsx_policyModel.PolicyFirewallSessionTimerProfile, overrideParam *bool) (nsx_policyModel.PolicyFirewallSessionTimerProfile, error) {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.firewall_session_timer_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyFirewallSessionTimerProfile
	if methodResult.IsSuccess() {
