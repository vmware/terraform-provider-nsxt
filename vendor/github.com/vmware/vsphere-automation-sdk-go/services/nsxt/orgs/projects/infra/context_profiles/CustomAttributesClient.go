...
func (cIface *customAttributesClient) Create(orgIdParam string, projectIdParam string, policyAttributesParam nsx_policyModel.PolicyAttributes, actionParam string) error {
...
func (cIface *customAttributesClient) Patch(orgIdParam string, projectIdParam string, policyAttributesParam nsx_policyModel.PolicyAttributes) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
