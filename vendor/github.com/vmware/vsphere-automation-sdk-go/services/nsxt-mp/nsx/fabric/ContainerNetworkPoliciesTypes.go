...
// Data type definitions file for service: ContainerNetworkPolicies.
...
func containerNetworkPoliciesGetInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["network_policy_id"] = vapiBindings_.NewStringType()
	fieldNameMap["network_policy_id"] = "NetworkPolicyId"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}

func ContainerNetworkPoliciesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ContainerNetworkPolicyBindingType)
}

func containerNetworkPoliciesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["network_policy_id"] = vapiBindings_.NewStringType()
	fieldNameMap["network_policy_id"] = "NetworkPolicyId"
	paramsTypeMap["network_policy_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["networkPolicyId"] = vapiBindings_.NewStringType()
...
func containerNetworkPoliciesListInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
...
func ContainerNetworkPoliciesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ContainerNetworkPolicyListResultBindingType)
}

func containerNetworkPoliciesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
