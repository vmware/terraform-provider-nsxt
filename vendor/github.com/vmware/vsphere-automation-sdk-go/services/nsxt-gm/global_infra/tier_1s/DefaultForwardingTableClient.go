...
func NewDefaultForwardingTableClient(connector client.Connector) *DefaultForwardingTableClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_1s.forwarding_table"
...
func (fIface *DefaultForwardingTableClient) List(tier1IdParam string, cursorParam *string, edgeIdParam *string, edgePathParam *string, enforcementPointPathParam *string, includedFieldsParam *string, networkPrefixParam *string, pageSizeParam *int64, routeSourceParam *string, sortAscendingParam *bool, sortByParam *string) (model.RoutingTableListResult, error) {
