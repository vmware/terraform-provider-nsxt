...
type DomainsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DomainListResult, error)
}
...
func NewDomainsClient(connector vapiProtocolClient_.Connector) *domainsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains")
...
func (dIface *domainsClient) Get(orgIdParam string, projectIdParam string, domainIdParam string) (nsx_policyModel.Domain, error) {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Domain
...
func (dIface *domainsClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DomainListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DomainListResult
	if methodResult.IsSuccess() {
