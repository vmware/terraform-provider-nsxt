...
type AlbErrorPageBodiesClient interface {
	...
	//
	// @param albErrorpagebodyIdParam ALBErrorPageBody ID (required)
	// @return com.vmware.nsx_global_policy.model.ALBErrorPageBody
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albErrorpagebodyIdParam string) (nsx_global_policyModel.ALBErrorPageBody, error)
	...
	// @return com.vmware.nsx_global_policy.model.ALBErrorPageBodyApiResponse
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBErrorPageBodyApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albErrorpagebodyIdParam string, aLBErrorPageBodyParam nsx_global_policyModel.ALBErrorPageBody) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albErrorpagebodyIdParam string, aLBErrorPageBodyParam nsx_global_policyModel.ALBErrorPageBody) (nsx_global_policyModel.ALBErrorPageBody, error)
}
...
func (aIface *albErrorPageBodiesClient) Delete(albErrorpagebodyIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_error_page_bodies", "delete", inputDataValue, executionContext)
...
func (aIface *albErrorPageBodiesClient) Get(albErrorpagebodyIdParam string) (nsx_global_policyModel.ALBErrorPageBody, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBErrorPageBody
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_error_page_bodies", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBErrorPageBody
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBErrorPageBody), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albErrorPageBodiesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBErrorPageBodyApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBErrorPageBodyApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_error_page_bodies", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBErrorPageBodyApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBErrorPageBodyApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albErrorPageBodiesClient) Patch(albErrorpagebodyIdParam string, aLBErrorPageBodyParam nsx_global_policyModel.ALBErrorPageBody) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_error_page_bodies", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albErrorPageBodiesClient) Update(albErrorpagebodyIdParam string, aLBErrorPageBodyParam nsx_global_policyModel.ALBErrorPageBody) (nsx_global_policyModel.ALBErrorPageBody, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_error_page_bodies", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBErrorPageBody
	if methodResult.IsSuccess() {
