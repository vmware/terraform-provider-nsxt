...
func macTableListInputType() bindings.StructType {
...
func macTableListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.SegmentMacAddressListResultBindingType)
}

func macTableListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/tier-1s/{tier1Id}/segments/{segmentId}/mac-table",
		"",
		resultHeaders,
		200,
		"",
