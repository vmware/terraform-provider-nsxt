...
func testAccNsxtPolicyDnsZoneTemplate(createFlow bool) string {
	...
	return testAccNsxtDnsTransitGatewayTemplate(attrMap["display_name"]) + fmt.Sprintf(`
...
func testAccNsxtPolicyDnsZoneWithSoaTemplate() string {
	return testAccNsxtDnsTransitGatewayTemplate(accTestPolicyDnsZoneCreateAttributes["display_name"]) + fmt.Sprintf(`
resource "nsxt_policy_dns_service" "parent" {
  %s
  display_name           = "%s-svc"
  allocated_listener_ips = ["%s"]
...
func testAccNsxtPolicyDnsZoneWithPartialSoaTemplate(displayName string) string {
	return testAccNsxtDnsTransitGatewayTemplate(displayName) + fmt.Sprintf(`
resource "nsxt_policy_dns_service" "parent" {
  %s
  display_name           = "%s-svc"
  allocated_listener_ips = ["%s"]
