...
type MacDiscoveryProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.MacDiscoveryProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, macDiscoveryProfileIdParam string, macDiscoveryProfileParam nsx_policyModel.MacDiscoveryProfile, overrideParam *bool) error
...
func NewMacDiscoveryProfilesClient(connector vapiProtocolClient_.Connector) *macDiscoveryProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.mac_discovery_profiles")
...
func (mIface *macDiscoveryProfilesClient) Delete(orgIdParam string, projectIdParam string, macDiscoveryProfileIdParam string, overrideParam *bool) error {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.mac_discovery_profiles", "delete", inputDataValue, executionContext)
...
func (mIface *macDiscoveryProfilesClient) Get(orgIdParam string, projectIdParam string, macDiscoveryProfileIdParam string) (nsx_policyModel.MacDiscoveryProfile, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.mac_discovery_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.MacDiscoveryProfile
	if methodResult.IsSuccess() {
...
func (mIface *macDiscoveryProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.MacDiscoveryProfileListResult, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.mac_discovery_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.MacDiscoveryProfileListResult
	if methodResult.IsSuccess() {
...
func (mIface *macDiscoveryProfilesClient) Patch(orgIdParam string, projectIdParam string, macDiscoveryProfileIdParam string, macDiscoveryProfileParam nsx_policyModel.MacDiscoveryProfile, overrideParam *bool) error {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.mac_discovery_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), mIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (mIface *macDiscoveryProfilesClient) Update(orgIdParam string, projectIdParam string, macDiscoveryProfileIdParam string, macDiscoveryProfileParam nsx_policyModel.MacDiscoveryProfile, overrideParam *bool) (nsx_policyModel.MacDiscoveryProfile, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.mac_discovery_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.MacDiscoveryProfile
	if methodResult.IsSuccess() {
