...
/*
 * Client stubs for service: Status
 * Functions that implement the generated StatusClient interface
 */
...
func NewDefaultStatusClient(connector client.Connector) *DefaultStatusClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.realized_state.status"
...
func (sIface *DefaultStatusClient) Get(intentPathParam string, includeEnforcedStatusParam *bool, sitePathParam *string) (model.ConsolidatedRealizedStatus, error) {
	...
	if inputError != nil {
		var emptyOutput model.ConsolidatedRealizedStatus
	...
	if methodResult.IsSuccess() {
		...
		return output.(model.ConsolidatedRealizedStatus), nil
	} else {
...
func (sIface *DefaultStatusClient) getMethodDefinition() *core.MethodDefinition {
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatusClient.get method's errors.InvalidRequest error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatusClient.get method's errors.Unauthorized error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatusClient.get method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatusClient.get method's errors.InternalServerError error - %s",
	...
	if errError5 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatusClient.get method's errors.NotFound error - %s",
