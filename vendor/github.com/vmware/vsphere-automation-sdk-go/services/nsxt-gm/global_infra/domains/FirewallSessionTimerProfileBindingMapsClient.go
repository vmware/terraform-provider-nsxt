...
type FirewallSessionTimerProfileBindingMapsClient interface {
	...
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMapListResult, error)
}
...
func NewFirewallSessionTimerProfileBindingMapsClient(connector vapiProtocolClient_.Connector) *firewallSessionTimerProfileBindingMapsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.firewall_session_timer_profile_binding_maps")
...
func (fIface *firewallSessionTimerProfileBindingMapsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMapListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMapListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyFirewallSessionTimerProfileBindingMapListResult), nil
	} else {
