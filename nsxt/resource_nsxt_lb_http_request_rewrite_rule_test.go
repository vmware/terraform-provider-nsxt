		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testLbRuleConditionAttr(fullName, "uri", "125183042", "uri", "/hello"),
					testLbRuleConditionAttr(fullName, "uri", "125183042", "match_type", matchType),
					testLbRuleConditionAttr(fullName, "uri", "125183042", "inverse", "false"),
					testLbRuleConditionCount(fullName, "uri_arguments", 1),
					testLbRuleConditionAttr(fullName, "uri_arguments", "4065886679", "uri_arguments", "hello"),
					testLbRuleConditionAttr(fullName, "uri_arguments", "4065886679", "match_type", matchType),
					testLbRuleConditionAttr(fullName, "uri_arguments", "4065886679", "inverse", "false"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testLbRuleConditionCount(fullName, "uri", 1),
					testLbRuleConditionAttr(fullName, "uri", "2630720601", "uri", "/hello"),
					testLbRuleConditionAttr(fullName, "uri", "2630720601", "match_type", updatedMatchType),
					testLbRuleConditionAttr(fullName, "uri", "2630720601", "inverse", "true"),
					testLbRuleConditionCount(fullName, "uri_arguments", 1),
					testLbRuleConditionAttr(fullName, "uri_arguments", "2349690291", "uri_arguments", "hello"),
					testLbRuleConditionAttr(fullName, "uri_arguments", "2349690291", "match_type", updatedMatchType),
					testLbRuleConditionAttr(fullName, "uri_arguments", "2349690291", "inverse", "true"),
					testLbRuleConditionCount(fullName, "ip", 1),
...
func TestAccResourceNsxtLbHttpRequestRewriteRule_importBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNSXLbHTTPRequestRewriteRuleCreateTemplateTrivial(name),
			},
			{
...
func testAccNSXLbHTTPRequestRewriteRuleCreateTemplateTrivial(name string) string {
	return `
resource "nsxt_lb_http_request_rewrite_rule" "test" {
  description    = "test description"
  match_strategy = "ALL"
