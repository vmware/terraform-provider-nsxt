...
type LocalizationParam struct {
	...
	Format *LocalizationParamDateTimeFormatEnum
...
const (
	...
	LocalizationParamDateTimeFormat_SHORT_DATE LocalizationParamDateTimeFormatEnum = "SHORT_DATE"
	// The date and time value will be formatted as medium date, for example *2019 Jan 28*
	LocalizationParamDateTimeFormat_MED_DATE LocalizationParamDateTimeFormatEnum = "MED_DATE"
	// The date and time value will be formatted as long date, for example *2019 Jan 28*
	LocalizationParamDateTimeFormat_LONG_DATE LocalizationParamDateTimeFormatEnum = "LONG_DATE"
	// The date and time value will be formatted as full date, for example *2019 Jan 28, Mon*
	LocalizationParamDateTimeFormat_FULL_DATE LocalizationParamDateTimeFormatEnum = "FULL_DATE"
	// The date and time value will be formatted as short time, for example *12:59*
	LocalizationParamDateTimeFormat_SHORT_TIME LocalizationParamDateTimeFormatEnum = "SHORT_TIME"
	// The date and time value will be formatted as medium time, for example *12:59:01*
	LocalizationParamDateTimeFormat_MED_TIME LocalizationParamDateTimeFormatEnum = "MED_TIME"
	// The date and time value will be formatted as long time, for example *12:59:01 Z*
	LocalizationParamDateTimeFormat_LONG_TIME LocalizationParamDateTimeFormatEnum = "LONG_TIME"
	// The date and time value will be formatted as full time, for example *12:59:01 Z*
	LocalizationParamDateTimeFormat_FULL_TIME LocalizationParamDateTimeFormatEnum = "FULL_TIME"
	// The date and time value will be formatted as short date and time, for example *2019-01-28 12:59*
	LocalizationParamDateTimeFormat_SHORT_DATE_TIME LocalizationParamDateTimeFormatEnum = "SHORT_DATE_TIME"
	// The date and time value will be formatted as medium date and time, for example *2019 Jan 28 12:59:01*
	LocalizationParamDateTimeFormat_MED_DATE_TIME LocalizationParamDateTimeFormatEnum = "MED_DATE_TIME"
	// The date and time value will be formatted as long date and time, for example *2019 Jan 28 12:59:01 Z*
	LocalizationParamDateTimeFormat_LONG_DATE_TIME LocalizationParamDateTimeFormatEnum = "LONG_DATE_TIME"
	// The date and time value will be formatted as full date and time, for example *2019 Jan 28, Mon 12:59:01 Z*
	LocalizationParamDateTimeFormat_FULL_DATE_TIME LocalizationParamDateTimeFormatEnum = "FULL_DATE_TIME"
)

func (d LocalizationParamDateTimeFormatEnum) LocalizationParamDateTimeFormatEnum() bool {
	switch d {
