...
type VersionClient interface {
	...
	Get() (nsxModel.NodeVersion, error)
}
...
func NewVersionClient(connector vapiProtocolClient_.Connector) *versionClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.node.version")
...
func (vIface *versionClient) Get() (nsxModel.NodeVersion, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.NodeVersion
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.NodeVersion), nil
	} else {
