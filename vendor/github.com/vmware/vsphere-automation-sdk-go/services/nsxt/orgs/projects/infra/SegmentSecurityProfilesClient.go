...
type SegmentSecurityProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, segmentSecurityProfileIdParam string) (nsx_policyModel.SegmentSecurityProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SegmentSecurityProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, segmentSecurityProfileIdParam string, segmentSecurityProfileParam nsx_policyModel.SegmentSecurityProfile, overrideParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, segmentSecurityProfileIdParam string, segmentSecurityProfileParam nsx_policyModel.SegmentSecurityProfile, overrideParam *bool) (nsx_policyModel.SegmentSecurityProfile, error)
}
...
func NewSegmentSecurityProfilesClient(connector vapiProtocolClient_.Connector) *segmentSecurityProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segment_security_profiles")
...
func (sIface *segmentSecurityProfilesClient) Delete(orgIdParam string, projectIdParam string, segmentSecurityProfileIdParam string, overrideParam *bool) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segment_security_profiles", "delete", inputDataValue, executionContext)
...
func (sIface *segmentSecurityProfilesClient) Get(orgIdParam string, projectIdParam string, segmentSecurityProfileIdParam string) (nsx_policyModel.SegmentSecurityProfile, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segment_security_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentSecurityProfile
	if methodResult.IsSuccess() {
...
func (sIface *segmentSecurityProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SegmentSecurityProfileListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segment_security_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentSecurityProfileListResult
	if methodResult.IsSuccess() {
...
func (sIface *segmentSecurityProfilesClient) Patch(orgIdParam string, projectIdParam string, segmentSecurityProfileIdParam string, segmentSecurityProfileParam nsx_policyModel.SegmentSecurityProfile, overrideParam *bool) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segment_security_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *segmentSecurityProfilesClient) Update(orgIdParam string, projectIdParam string, segmentSecurityProfileIdParam string, segmentSecurityProfileParam nsx_policyModel.SegmentSecurityProfile, overrideParam *bool) (nsx_policyModel.SegmentSecurityProfile, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segment_security_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentSecurityProfile
	if methodResult.IsSuccess() {
