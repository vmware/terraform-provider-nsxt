...
func NewDefaultTepTableClient(connector client.Connector) *DefaultTepTableClient {
	interfaceName := "com.vmware.nsx_policy.infra.tier_1s.segments.tep_table"
...
func (tIface *DefaultTepTableClient) List(tier1IdParam string, segmentIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (model.PolicyTepListResult, error) {
