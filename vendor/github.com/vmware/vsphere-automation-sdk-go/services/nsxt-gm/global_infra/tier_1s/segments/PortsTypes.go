...
func PortsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.SegmentPortBindingType)
}
...
func portsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tier-1s/{tier1Id}/segments/{segmentId}/ports/{portId}",
		"",
		resultHeaders,
		200,
		"",
...
func PortsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.SegmentPortListResultBindingType)
}
...
func portsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tier-1s/{tier1Id}/segments/{segmentId}/ports",
		"",
		resultHeaders,
		200,
		"",
