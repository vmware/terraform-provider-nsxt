...
type GatewayFirewallClient interface {
	...
	List(tier0IdParam string, localeServicesIdParam string) (nsx_global_policyModel.GatewayPolicyListResult, error)
}
...
func NewGatewayFirewallClient(connector vapiProtocolClient_.Connector) *gatewayFirewallClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_0s.locale_services.gateway_firewall")
...
func (gIface *gatewayFirewallClient) List(tier0IdParam string, localeServicesIdParam string) (nsx_global_policyModel.GatewayPolicyListResult, error) {
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_0s.locale_services.gateway_firewall", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.GatewayPolicyListResult
