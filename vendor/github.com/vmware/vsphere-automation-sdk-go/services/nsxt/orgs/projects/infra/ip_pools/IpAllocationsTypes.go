...
func ipAllocationsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ip-pools/{ipPoolId}/ip-allocations/{ipAllocationId}",
		"",
		resultHeaders,
		204,
		"",
...
func ipAllocationsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ip-pools/{ipPoolId}/ip-allocations",
		"",
		resultHeaders,
		200,
		"",
