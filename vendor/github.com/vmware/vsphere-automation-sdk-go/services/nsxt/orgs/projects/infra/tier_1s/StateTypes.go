...
func StateGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.Tier1GatewayStateBindingType)
}
...
func stateGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["interface_path"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	...
	queryParams["interface_path"] = "interface_path"
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/tier-1s/{tier1Id}/state",
		"",
		resultHeaders,
		200,
		"",
