...
func NewMacTableClient(connector vapiProtocolClient_.Connector) *macTableClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segments.mac_table")
...
func (mIface *macTableClient) List(orgIdParam string, projectIdParam string, segmentIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_policyModel.SegmentMacAddressListResult, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.mac_table", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentMacAddressListResult
