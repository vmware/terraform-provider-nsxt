...
type DnsForwarderClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(tier1IdParam string) (nsx_global_policyModel.PolicyDnsForwarder, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(tier1IdParam string, policyDnsForwarderParam nsx_global_policyModel.PolicyDnsForwarder) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(tier1IdParam string, policyDnsForwarderParam nsx_global_policyModel.PolicyDnsForwarder) (nsx_global_policyModel.PolicyDnsForwarder, error)
}
...
func NewDnsForwarderClient(connector vapiProtocolClient_.Connector) *dnsForwarderClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_1s.dns_forwarder")
...
func (dIface *dnsForwarderClient) Create(tier1IdParam string, actionParam string, enforcementPointPathParam *string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_1s.dns_forwarder", "create", inputDataValue, executionContext)
...
func (dIface *dnsForwarderClient) Delete(tier1IdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_1s.dns_forwarder", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dnsForwarderClient) Get(tier1IdParam string) (nsx_global_policyModel.PolicyDnsForwarder, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_1s.dns_forwarder", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyDnsForwarder
	if methodResult.IsSuccess() {
...
func (dIface *dnsForwarderClient) Patch(tier1IdParam string, policyDnsForwarderParam nsx_global_policyModel.PolicyDnsForwarder) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_1s.dns_forwarder", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dnsForwarderClient) Update(tier1IdParam string, policyDnsForwarderParam nsx_global_policyModel.PolicyDnsForwarder) (nsx_global_policyModel.PolicyDnsForwarder, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_1s.dns_forwarder", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyDnsForwarder
	if methodResult.IsSuccess() {
