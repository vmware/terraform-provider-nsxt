...
type AlbHealthMonitorsClient interface {
	...
	//
	// @param albHealthmonitorIdParam ALBHealthMonitor ID (required)
	// @return com.vmware.nsx_global_policy.model.ALBHealthMonitor
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albHealthmonitorIdParam string) (nsx_global_policyModel.ALBHealthMonitor, error)
	...
	// @return com.vmware.nsx_global_policy.model.ALBHealthMonitorApiResponse
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBHealthMonitorApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albHealthmonitorIdParam string, aLBHealthMonitorParam nsx_global_policyModel.ALBHealthMonitor) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albHealthmonitorIdParam string, aLBHealthMonitorParam nsx_global_policyModel.ALBHealthMonitor) (nsx_global_policyModel.ALBHealthMonitor, error)
}
...
func NewAlbHealthMonitorsClient(connector vapiProtocolClient_.Connector) *albHealthMonitorsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_health_monitors")
...
func (aIface *albHealthMonitorsClient) Delete(albHealthmonitorIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_health_monitors", "delete", inputDataValue, executionContext)
...
func (aIface *albHealthMonitorsClient) Get(albHealthmonitorIdParam string) (nsx_global_policyModel.ALBHealthMonitor, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBHealthMonitor
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_health_monitors", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBHealthMonitor
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBHealthMonitor), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albHealthMonitorsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBHealthMonitorApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBHealthMonitorApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_health_monitors", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBHealthMonitorApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBHealthMonitorApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albHealthMonitorsClient) Patch(albHealthmonitorIdParam string, aLBHealthMonitorParam nsx_global_policyModel.ALBHealthMonitor) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_health_monitors", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albHealthMonitorsClient) Update(albHealthmonitorIdParam string, aLBHealthMonitorParam nsx_global_policyModel.ALBHealthMonitor) (nsx_global_policyModel.ALBHealthMonitor, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_health_monitors", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBHealthMonitor
	if methodResult.IsSuccess() {
