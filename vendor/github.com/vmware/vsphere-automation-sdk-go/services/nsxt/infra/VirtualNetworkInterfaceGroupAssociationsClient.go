...
type VirtualNetworkInterfaceGroupAssociationsClient interface {
	...
	List(vifExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyResourceReferenceForEPListResult, error)
}
...
func NewVirtualNetworkInterfaceGroupAssociationsClient(connector vapiProtocolClient_.Connector) *virtualNetworkInterfaceGroupAssociationsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.virtual_network_interface_group_associations")
...
func (vIface *virtualNetworkInterfaceGroupAssociationsClient) List(vifExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyResourceReferenceForEPListResult, error) {
	...
	methodResult := vIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.virtual_network_interface_group_associations", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyResourceReferenceForEPListResult
