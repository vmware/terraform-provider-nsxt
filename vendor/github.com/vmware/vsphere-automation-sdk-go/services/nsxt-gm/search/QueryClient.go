...
type QueryClient interface {
	...
	// @return com.vmware.nsx_global_policy.model.SearchResponse
	//
	...
	List(queryParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.SearchResponse, error)
}
...
func NewQueryClient(connector vapiProtocolClient_.Connector) *queryClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.search.query")
...
func (qIface *queryClient) List(queryParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.SearchResponse, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.SearchResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.search.query", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.SearchResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.SearchResponse), nil
	} else {
