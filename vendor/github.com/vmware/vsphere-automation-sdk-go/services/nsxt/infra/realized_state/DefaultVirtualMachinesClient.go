...
func NewDefaultVirtualMachinesClient(connector client.Connector) *DefaultVirtualMachinesClient {
	interfaceName := "com.vmware.nsx_policy.infra.realized_state.virtual_machines"
...
func (vIface *DefaultVirtualMachinesClient) List(cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.VirtualMachineListResult, error) {
