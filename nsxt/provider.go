	...
	return &schema.Provider{
		...
		Schema: map[string]*schema.Schema{
			...
			"retry_max_delay": &schema.Schema{
				...
				DefaultFunc: schema.EnvDefaultFunc("NSX_RETRY_MAZ_DELAY", 5000),
			},
			"retry_on_statuses": &schema.Schema{
				...
				// 429: TooManyRequests
				DefaultFunc: schema.EnvDefaultFunc("NSX_RETRY_ON_STATUSES", []int{429}),
			},
		},
...
func providerConfigure(d *schema.ResourceData) (interface{}, error) {
	...
	statuses := d.Get("retry_on_statuses").([]interface{})
