...
/*
 * Data type definitions file for service: RedirectionPolicies.
...
func redirectionPoliciesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/infra/domains/{domainId}/redirection-policies/{redirectionPolicyId}",
		resultHeaders,
		204,
		errorHeaders,
...
func redirectionPoliciesList0RestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/domains/{domainId}/redirection-policies",
		resultHeaders,
		200,
		errorHeaders,
		map[string]int{"InvalidRequest": 400,"Unauthorized": 403,"ServiceUnavailable": 503,"InternalServerError": 500,"NotFound": 404})
