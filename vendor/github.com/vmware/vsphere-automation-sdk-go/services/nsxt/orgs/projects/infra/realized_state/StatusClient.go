...
type StatusClient interface {
	...
	Get(orgIdParam string, projectIdParam string, intentPathParam string, includeEnforcedStatusParam *bool, sitePathParam *string) (nsx_policyModel.ConsolidatedRealizedStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.realized_state.status")
...
func (sIface *statusClient) Get(orgIdParam string, projectIdParam string, intentPathParam string, includeEnforcedStatusParam *bool, sitePathParam *string) (nsx_policyModel.ConsolidatedRealizedStatus, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.realized_state.status", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.ConsolidatedRealizedStatus
