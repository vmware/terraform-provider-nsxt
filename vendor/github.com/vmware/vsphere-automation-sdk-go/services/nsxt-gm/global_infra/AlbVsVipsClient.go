...
type AlbVsVipsClient interface {
	...
	//
	// @param albVsvipIdParam ALBVsVip ID (required)
	// @return com.vmware.nsx_global_policy.model.ALBVsVip
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albVsvipIdParam string) (nsx_global_policyModel.ALBVsVip, error)
	...
	// @return com.vmware.nsx_global_policy.model.ALBVsVipApiResponse
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBVsVipApiResponse, error)
...
func NewAlbVsVipsClient(connector vapiProtocolClient_.Connector) *albVsVipsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_vs_vips")
...
func (aIface *albVsVipsClient) Delete(albVsvipIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_vs_vips", "delete", inputDataValue, executionContext)
...
func (aIface *albVsVipsClient) Get(albVsvipIdParam string) (nsx_global_policyModel.ALBVsVip, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBVsVip
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_vs_vips", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBVsVip
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBVsVip), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albVsVipsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBVsVipApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBVsVipApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_vs_vips", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBVsVipApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBVsVipApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albVsVipsClient) Patch(albVsvipIdParam string, aLBVsVipParam nsx_global_policyModel.ALBVsVip) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_vs_vips", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albVsVipsClient) Update(albVsvipIdParam string, aLBVsVipParam nsx_global_policyModel.ALBVsVip) (nsx_global_policyModel.ALBVsVip, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_vs_vips", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBVsVip
	if methodResult.IsSuccess() {
