...
type AlbServerAutoScalePoliciesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albServerautoscalepolicyIdParam string) (nsx_global_policyModel.ALBServerAutoScalePolicy, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBServerAutoScalePolicyApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albServerautoscalepolicyIdParam string, aLBServerAutoScalePolicyParam nsx_global_policyModel.ALBServerAutoScalePolicy) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albServerautoscalepolicyIdParam string, aLBServerAutoScalePolicyParam nsx_global_policyModel.ALBServerAutoScalePolicy) (nsx_global_policyModel.ALBServerAutoScalePolicy, error)
}
...
func NewAlbServerAutoScalePoliciesClient(connector vapiProtocolClient_.Connector) *albServerAutoScalePoliciesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_server_auto_scale_policies")
...
func (aIface *albServerAutoScalePoliciesClient) Delete(albServerautoscalepolicyIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_server_auto_scale_policies", "delete", inputDataValue, executionContext)
...
func (aIface *albServerAutoScalePoliciesClient) Get(albServerautoscalepolicyIdParam string) (nsx_global_policyModel.ALBServerAutoScalePolicy, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBServerAutoScalePolicy
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_server_auto_scale_policies", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBServerAutoScalePolicy
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBServerAutoScalePolicy), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albServerAutoScalePoliciesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBServerAutoScalePolicyApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBServerAutoScalePolicyApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_server_auto_scale_policies", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBServerAutoScalePolicyApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBServerAutoScalePolicyApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albServerAutoScalePoliciesClient) Patch(albServerautoscalepolicyIdParam string, aLBServerAutoScalePolicyParam nsx_global_policyModel.ALBServerAutoScalePolicy) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_server_auto_scale_policies", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albServerAutoScalePoliciesClient) Update(albServerautoscalepolicyIdParam string, aLBServerAutoScalePolicyParam nsx_global_policyModel.ALBServerAutoScalePolicy) (nsx_global_policyModel.ALBServerAutoScalePolicy, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_server_auto_scale_policies", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBServerAutoScalePolicy
	if methodResult.IsSuccess() {
