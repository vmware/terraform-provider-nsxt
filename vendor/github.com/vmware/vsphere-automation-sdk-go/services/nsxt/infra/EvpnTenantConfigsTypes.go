...
func evpnTenantConfigsDeleteInputType() bindings.StructType {
...
func evpnTenantConfigsDeleteOutputType() bindings.BindingType {
	return bindings.NewVoidType()
}

func evpnTenantConfigsDeleteRestMetadata() protocol.OperationRestMetadata {
...
func evpnTenantConfigsGetInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["config_id"] = bindings.NewStringType()
	fieldNameMap["config_id"] = "ConfigId"
...
func evpnTenantConfigsGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.EvpnTenantConfigBindingType)
}

func evpnTenantConfigsGetRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
...
func evpnTenantConfigsListInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
...
func evpnTenantConfigsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.EvpnTenantConfigListResultBindingType)
}

func evpnTenantConfigsListRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
