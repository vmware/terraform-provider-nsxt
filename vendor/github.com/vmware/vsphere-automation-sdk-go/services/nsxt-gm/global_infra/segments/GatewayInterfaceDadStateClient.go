...
type GatewayInterfaceDadStateClient interface {
	...
	Get(segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_global_policyModel.InterfaceDADState, error)
}
...
func NewGatewayInterfaceDadStateClient(connector vapiProtocolClient_.Connector) *gatewayInterfaceDadStateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.segments.gateway_interface_dad_state")
...
func (gIface *gatewayInterfaceDadStateClient) Get(segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_global_policyModel.InterfaceDADState, error) {
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.segments.gateway_interface_dad_state", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.InterfaceDADState
