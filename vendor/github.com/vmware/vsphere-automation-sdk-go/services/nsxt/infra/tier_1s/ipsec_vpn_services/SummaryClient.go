...
type SummaryClient interface {
	...
	Get(tier1IdParam string, serviceIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.PolicyIpsecVpnIkeServiceSummary, error)
}
...
func NewSummaryClient(connector client.Connector) *summaryClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_1s.ipsec_vpn_services.summary")
...
func (sIface *summaryClient) Get(tier1IdParam string, serviceIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.PolicyIpsecVpnIkeServiceSummary, error) {
