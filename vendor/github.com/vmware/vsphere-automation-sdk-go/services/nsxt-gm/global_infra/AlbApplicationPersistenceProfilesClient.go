...
type AlbApplicationPersistenceProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albApplicationpersistenceprofileIdParam string) (nsx_global_policyModel.ALBApplicationPersistenceProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBApplicationPersistenceProfileApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albApplicationpersistenceprofileIdParam string, aLBApplicationPersistenceProfileParam nsx_global_policyModel.ALBApplicationPersistenceProfile) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albApplicationpersistenceprofileIdParam string, aLBApplicationPersistenceProfileParam nsx_global_policyModel.ALBApplicationPersistenceProfile) (nsx_global_policyModel.ALBApplicationPersistenceProfile, error)
}
...
func NewAlbApplicationPersistenceProfilesClient(connector vapiProtocolClient_.Connector) *albApplicationPersistenceProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_application_persistence_profiles")
...
func (aIface *albApplicationPersistenceProfilesClient) Delete(albApplicationpersistenceprofileIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_application_persistence_profiles", "delete", inputDataValue, executionContext)
...
func (aIface *albApplicationPersistenceProfilesClient) Get(albApplicationpersistenceprofileIdParam string) (nsx_global_policyModel.ALBApplicationPersistenceProfile, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBApplicationPersistenceProfile
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_application_persistence_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBApplicationPersistenceProfile
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBApplicationPersistenceProfile), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albApplicationPersistenceProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBApplicationPersistenceProfileApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBApplicationPersistenceProfileApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_application_persistence_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBApplicationPersistenceProfileApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBApplicationPersistenceProfileApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albApplicationPersistenceProfilesClient) Patch(albApplicationpersistenceprofileIdParam string, aLBApplicationPersistenceProfileParam nsx_global_policyModel.ALBApplicationPersistenceProfile) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_application_persistence_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albApplicationPersistenceProfilesClient) Update(albApplicationpersistenceprofileIdParam string, aLBApplicationPersistenceProfileParam nsx_global_policyModel.ALBApplicationPersistenceProfile) (nsx_global_policyModel.ALBApplicationPersistenceProfile, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_application_persistence_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBApplicationPersistenceProfile
	if methodResult.IsSuccess() {
