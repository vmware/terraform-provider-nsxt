		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, "span.cluster_based_span.#", "1"),
					resource.TestCheckResourceAttrSet(testResourceName, "span.cluster_based_span.span_path"),
