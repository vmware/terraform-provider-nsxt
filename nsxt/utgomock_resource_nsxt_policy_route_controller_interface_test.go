...
func TestMockResourceNsxtPolicyRouteControllerInterfaceUpdate(t *testing.T) {
	...
	t.Run("Update success", func(t *testing.T) {
		resp := rcInterfaceAPIResponse()
		gomock.InOrder(
			mockIfaceSDK.EXPECT().Update(routeControllerID, rcInterfaceID, gomock.Any()).Return(resp, nil),
	...
	t.Run("Update fails when API returns error", func(t *testing.T) {
		mockIfaceSDK.EXPECT().Update(routeControllerID, rcInterfaceID, gomock.Any()).Return(model.RouteControllerInterface{}, errors.New("API error"))
