...
type QosProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, qosProfileIdParam string) (nsx_policyModel.QosProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.QosProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, qosProfileIdParam string, qosProfileParam nsx_policyModel.QosProfile, overrideParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, qosProfileIdParam string, qosProfileParam nsx_policyModel.QosProfile, overrideParam *bool) (nsx_policyModel.QosProfile, error)
}
...
func NewQosProfilesClient(connector vapiProtocolClient_.Connector) *qosProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.qos_profiles")
...
func (qIface *qosProfilesClient) Delete(orgIdParam string, projectIdParam string, qosProfileIdParam string, overrideParam *bool) error {
	...
	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.qos_profiles", "delete", inputDataValue, executionContext)
...
func (qIface *qosProfilesClient) Get(orgIdParam string, projectIdParam string, qosProfileIdParam string) (nsx_policyModel.QosProfile, error) {
	typeConverter := qIface.connector.TypeConverter()
	executionContext := qIface.connector.NewExecutionContext()
	...
	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.qos_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.QosProfile
	if methodResult.IsSuccess() {
...
func (qIface *qosProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.QosProfileListResult, error) {
	typeConverter := qIface.connector.TypeConverter()
	executionContext := qIface.connector.NewExecutionContext()
	...
	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.qos_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.QosProfileListResult
	if methodResult.IsSuccess() {
...
func (qIface *qosProfilesClient) Patch(orgIdParam string, projectIdParam string, qosProfileIdParam string, qosProfileParam nsx_policyModel.QosProfile, overrideParam *bool) error {
	typeConverter := qIface.connector.TypeConverter()
	executionContext := qIface.connector.NewExecutionContext()
	...
	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.qos_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), qIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (qIface *qosProfilesClient) Update(orgIdParam string, projectIdParam string, qosProfileIdParam string, qosProfileParam nsx_policyModel.QosProfile, overrideParam *bool) (nsx_policyModel.QosProfile, error) {
	typeConverter := qIface.connector.TypeConverter()
	executionContext := qIface.connector.NewExecutionContext()
	...
	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.qos_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.QosProfile
	if methodResult.IsSuccess() {
