...
func csrsCreateInputType() vapiBindings_.StructType {
	...
	fields["tls_csr"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.TlsCsrBindingType)
...
func CsrsCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.TlsCsrBindingType)
}
...
func csrsCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["tls_csr"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.TlsCsrBindingType)
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"tls_csr",
		"POST",
		"/global-manager/api/v1/global-infra/csrs/{csrId}",
		"",
		resultHeaders,
		201,
		"",
...
func csrsImportcsrInputType() vapiBindings_.StructType {
	...
	fieldNameMap := make(map[string]string)
	fields["csr_id"] = vapiBindings_.NewStringType()
	fields["tls_trust_data"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.TlsTrustDataBindingType)
	fieldNameMap["csr_id"] = "CsrId"
...
func CsrsImportcsrOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.TlsCertificateBindingType)
}
...
func csrsImportcsrRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["tls_trust_data"] = "TlsTrustData"
	paramsTypeMap["csr_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["tls_trust_data"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.TlsTrustDataBindingType)
	paramsTypeMap["csrId"] = vapiBindings_.NewStringType()
	pathParams["csr_id"] = "csrId"
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
...
func CsrsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.TlsCsrListResultBindingType)
}
...
func csrsSelfsign0InputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["tls_csr_with_days_valid"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.TlsCsrWithDaysValidBindingType)
...
func csrsSelfsign0RestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["tls_csr_with_days_valid"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.TlsCsrWithDaysValidBindingType)
	fieldNameMap["tls_csr_with_days_valid"] = "TlsCsrWithDaysValid"
	paramsTypeMap["tls_csr_with_days_valid"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.TlsCsrWithDaysValidBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
