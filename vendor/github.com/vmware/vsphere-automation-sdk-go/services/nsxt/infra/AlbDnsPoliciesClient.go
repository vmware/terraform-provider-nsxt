...
type AlbDnsPoliciesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albDnspolicyIdParam string) (nsx_policyModel.ALBDnsPolicy, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ALBDnsPolicyApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albDnspolicyIdParam string, aLBDnsPolicyParam nsx_policyModel.ALBDnsPolicy) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albDnspolicyIdParam string, aLBDnsPolicyParam nsx_policyModel.ALBDnsPolicy) (nsx_policyModel.ALBDnsPolicy, error)
}
...
func NewAlbDnsPoliciesClient(connector vapiProtocolClient_.Connector) *albDnsPoliciesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.alb_dns_policies")
...
func (aIface *albDnsPoliciesClient) Get(albDnspolicyIdParam string) (nsx_policyModel.ALBDnsPolicy, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.ALBDnsPolicy
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ALBDnsPolicy), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albDnsPoliciesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ALBDnsPolicyApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.ALBDnsPolicyApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ALBDnsPolicyApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albDnsPoliciesClient) Patch(albDnspolicyIdParam string, aLBDnsPolicyParam nsx_policyModel.ALBDnsPolicy) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
...
func (aIface *albDnsPoliciesClient) Update(albDnspolicyIdParam string, aLBDnsPolicyParam nsx_policyModel.ALBDnsPolicy) (nsx_policyModel.ALBDnsPolicy, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
