...
func interfacesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/global-manager/api/v1/global-infra/tier-0s/{tier0Id}/locale-services/{localeServiceId}/interfaces/{interfaceId}",
		"",
		resultHeaders,
		204,
		"",
...
func interfacesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tier-0s/{tier0Id}/locale-services/{localeServiceId}/interfaces",
		"",
		resultHeaders,
		200,
		"",
