...
const (
	...
	ErrorType_ERROR ErrorTypeEnum = "ERROR"
	// Discriminator for the AlreadyExists type.
	ErrorType_ALREADY_EXISTS ErrorTypeEnum = "ALREADY_EXISTS"
	// Discriminator for the AlreadyInDesiredState type.
	ErrorType_ALREADY_IN_DESIRED_STATE ErrorTypeEnum = "ALREADY_IN_DESIRED_STATE"
	// Discriminator for the Canceled type.
	ErrorType_CANCELED ErrorTypeEnum = "CANCELED"
	// Discriminator for the ConcurrentChange type.
	ErrorType_CONCURRENT_CHANGE ErrorTypeEnum = "CONCURRENT_CHANGE"
	// Discriminator for the FeatureInUse type.
	ErrorType_FEATURE_IN_USE ErrorTypeEnum = "FEATURE_IN_USE"
	// Discriminator for the InternalServerError type.
	ErrorType_INTERNAL_SERVER_ERROR ErrorTypeEnum = "INTERNAL_SERVER_ERROR"
	// Discriminator for the InvalidArgument type.
	ErrorType_INVALID_ARGUMENT ErrorTypeEnum = "INVALID_ARGUMENT"
	// Discriminator for the InvalidElementConfiguration type.
	ErrorType_INVALID_ELEMENT_CONFIGURATION ErrorTypeEnum = "INVALID_ELEMENT_CONFIGURATION"
	// Discriminator for the InvalidElementType type.
	ErrorType_INVALID_ELEMENT_TYPE ErrorTypeEnum = "INVALID_ELEMENT_TYPE"
	// Discriminator for the InvalidRequest type.
	ErrorType_INVALID_REQUEST ErrorTypeEnum = "INVALID_REQUEST"
	// Discriminator for the NotAllowedInCurrentState type.
	ErrorType_NOT_ALLOWED_IN_CURRENT_STATE ErrorTypeEnum = "NOT_ALLOWED_IN_CURRENT_STATE"
	// Discriminator for the NotFound type.
	ErrorType_NOT_FOUND ErrorTypeEnum = "NOT_FOUND"
	// Discriminator for the OperationNotFound type.
	ErrorType_OPERATION_NOT_FOUND ErrorTypeEnum = "OPERATION_NOT_FOUND"
	// Discriminator for the ResourceBusy type.
	ErrorType_RESOURCE_BUSY ErrorTypeEnum = "RESOURCE_BUSY"
	// Discriminator for the ResourceInUse type.
	ErrorType_RESOURCE_IN_USE ErrorTypeEnum = "RESOURCE_IN_USE"
	// Discriminator for the ResourceInaccessible type.
	ErrorType_RESOURCE_INACCESSIBLE ErrorTypeEnum = "RESOURCE_INACCESSIBLE"
	// Discriminator for the ServiceUnavailable type.
	ErrorType_SERVICE_UNAVAILABLE ErrorTypeEnum = "SERVICE_UNAVAILABLE"
	// Discriminator for the TimedOut type.
	ErrorType_TIMED_OUT ErrorTypeEnum = "TIMED_OUT"
	// Discriminator for the UnableToAllocateResource type.
	ErrorType_UNABLE_TO_ALLOCATE_RESOURCE ErrorTypeEnum = "UNABLE_TO_ALLOCATE_RESOURCE"
	// Discriminator for the Unauthenticated type.
	ErrorType_UNAUTHENTICATED ErrorTypeEnum = "UNAUTHENTICATED"
	// Discriminator for the Unauthorized type.
	ErrorType_UNAUTHORIZED ErrorTypeEnum = "UNAUTHORIZED"
	// Discriminator for the UnexpectedInput type.
	ErrorType_UNEXPECTED_INPUT ErrorTypeEnum = "UNEXPECTED_INPUT"
	// Discriminator for the Unsupported type.
	ErrorType_UNSUPPORTED ErrorTypeEnum = "UNSUPPORTED"
	// Discriminator for the UnverifiedPeer type.
	ErrorType_UNVERIFIED_PEER ErrorTypeEnum = "UNVERIFIED_PEER"
)

func (t ErrorTypeEnum) ErrorTypeEnum() bool {
	switch t {
