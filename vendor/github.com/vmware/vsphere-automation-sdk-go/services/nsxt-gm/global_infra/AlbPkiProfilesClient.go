...
type AlbPkiProfilesClient interface {
	...
	//
	// @param albPkiprofileIdParam ALBPKIProfile ID (required)
	// @return com.vmware.nsx_global_policy.model.ALBPKIProfile
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albPkiprofileIdParam string) (nsx_global_policyModel.ALBPKIProfile, error)
	...
	// @return com.vmware.nsx_global_policy.model.ALBPKIProfileApiResponse
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBPKIProfileApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albPkiprofileIdParam string, aLBPKIProfileParam nsx_global_policyModel.ALBPKIProfile) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albPkiprofileIdParam string, aLBPKIProfileParam nsx_global_policyModel.ALBPKIProfile) (nsx_global_policyModel.ALBPKIProfile, error)
}
...
func NewAlbPkiProfilesClient(connector vapiProtocolClient_.Connector) *albPkiProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_pki_profiles")
...
func (aIface *albPkiProfilesClient) Delete(albPkiprofileIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_pki_profiles", "delete", inputDataValue, executionContext)
...
func (aIface *albPkiProfilesClient) Get(albPkiprofileIdParam string) (nsx_global_policyModel.ALBPKIProfile, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBPKIProfile
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_pki_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBPKIProfile
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBPKIProfile), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albPkiProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBPKIProfileApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBPKIProfileApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_pki_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBPKIProfileApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBPKIProfileApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albPkiProfilesClient) Patch(albPkiprofileIdParam string, aLBPKIProfileParam nsx_global_policyModel.ALBPKIProfile) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_pki_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albPkiProfilesClient) Update(albPkiprofileIdParam string, aLBPKIProfileParam nsx_global_policyModel.ALBPKIProfile) (nsx_global_policyModel.ALBPKIProfile, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_pki_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBPKIProfile
	if methodResult.IsSuccess() {
