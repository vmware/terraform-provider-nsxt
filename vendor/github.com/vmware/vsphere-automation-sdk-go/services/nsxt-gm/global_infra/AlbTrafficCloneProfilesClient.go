...
type AlbTrafficCloneProfilesClient interface {
	...
	//
	// @param albTrafficcloneprofileIdParam ALBTrafficCloneProfile ID (required)
	// @return com.vmware.nsx_global_policy.model.ALBTrafficCloneProfile
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albTrafficcloneprofileIdParam string) (nsx_global_policyModel.ALBTrafficCloneProfile, error)
	...
	// @return com.vmware.nsx_global_policy.model.ALBTrafficCloneProfileApiResponse
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBTrafficCloneProfileApiResponse, error)
...
func NewAlbTrafficCloneProfilesClient(connector vapiProtocolClient_.Connector) *albTrafficCloneProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_traffic_clone_profiles")
...
func (aIface *albTrafficCloneProfilesClient) Delete(albTrafficcloneprofileIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_traffic_clone_profiles", "delete", inputDataValue, executionContext)
...
func (aIface *albTrafficCloneProfilesClient) Get(albTrafficcloneprofileIdParam string) (nsx_global_policyModel.ALBTrafficCloneProfile, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBTrafficCloneProfile
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_traffic_clone_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBTrafficCloneProfile
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBTrafficCloneProfile), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albTrafficCloneProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBTrafficCloneProfileApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBTrafficCloneProfileApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_traffic_clone_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBTrafficCloneProfileApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBTrafficCloneProfileApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albTrafficCloneProfilesClient) Patch(albTrafficcloneprofileIdParam string, aLBTrafficCloneProfileParam nsx_global_policyModel.ALBTrafficCloneProfile) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_traffic_clone_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albTrafficCloneProfilesClient) Update(albTrafficcloneprofileIdParam string, aLBTrafficCloneProfileParam nsx_global_policyModel.ALBTrafficCloneProfile) (nsx_global_policyModel.ALBTrafficCloneProfile, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_traffic_clone_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBTrafficCloneProfile
	if methodResult.IsSuccess() {
