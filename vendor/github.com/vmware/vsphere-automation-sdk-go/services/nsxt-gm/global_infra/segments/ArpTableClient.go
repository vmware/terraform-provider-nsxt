...
func NewArpTableClient(connector vapiProtocolClient_.Connector) *arpTableClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.segments.arp_table")
...
func (aIface *arpTableClient) List(segmentIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, hostTransportNodePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.InterfaceArpTable, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.segments.arp_table", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.InterfaceArpTable
