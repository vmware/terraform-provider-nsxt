...
type AlbWafPolicyPsmGroupsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albWafpolicypsmgroupIdParam string) (nsx_global_policyModel.ALBWafPolicyPSMGroup, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBWafPolicyPSMGroupApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albWafpolicypsmgroupIdParam string, aLBWafPolicyPSMGroupParam nsx_global_policyModel.ALBWafPolicyPSMGroup) error
...
func NewAlbWafPolicyPsmGroupsClient(connector vapiProtocolClient_.Connector) *albWafPolicyPsmGroupsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_waf_policy_psm_groups")
...
func (aIface *albWafPolicyPsmGroupsClient) Delete(albWafpolicypsmgroupIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_waf_policy_psm_groups", "delete", inputDataValue, executionContext)
...
func (aIface *albWafPolicyPsmGroupsClient) Get(albWafpolicypsmgroupIdParam string) (nsx_global_policyModel.ALBWafPolicyPSMGroup, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBWafPolicyPSMGroup
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_waf_policy_psm_groups", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBWafPolicyPSMGroup
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBWafPolicyPSMGroup), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albWafPolicyPsmGroupsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBWafPolicyPSMGroupApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBWafPolicyPSMGroupApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_waf_policy_psm_groups", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBWafPolicyPSMGroupApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBWafPolicyPSMGroupApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albWafPolicyPsmGroupsClient) Patch(albWafpolicypsmgroupIdParam string, aLBWafPolicyPSMGroupParam nsx_global_policyModel.ALBWafPolicyPSMGroup) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_waf_policy_psm_groups", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albWafPolicyPsmGroupsClient) Update(albWafpolicypsmgroupIdParam string, aLBWafPolicyPSMGroupParam nsx_global_policyModel.ALBWafPolicyPSMGroup) (nsx_global_policyModel.ALBWafPolicyPSMGroup, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_waf_policy_psm_groups", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBWafPolicyPSMGroup
	if methodResult.IsSuccess() {
