...
/*
 * Client stubs for service: UnassociatedVirtualMachines
 * Functions that implement the generated UnassociatedVirtualMachinesClient interface
 */
...
type DefaultUnassociatedVirtualMachinesClient struct {
...
func NewDefaultUnassociatedVirtualMachinesClient(connector client.Connector) *DefaultUnassociatedVirtualMachinesClient {
	interfaceName := "com.vmware.nsx_policy.infra.realized_state.unassociated_virtual_machines"
	...
	uIface := DefaultUnassociatedVirtualMachinesClient{interfaceName: interfaceName, methodIdentifiers: methodIdentifiers, interfaceDefinition: interfaceDefinition, errorBindingMap: errorBindingMap, interfaceIdentifier: interfaceIdentifier, connector: connector}
...
func (uIface *DefaultUnassociatedVirtualMachinesClient) List(cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.VirtualMachineListResult, error) {
...
func (uIface *DefaultUnassociatedVirtualMachinesClient) Invoke(ctx *core.ExecutionContext, methodId core.MethodIdentifier, inputDataValue data.DataValue) core.MethodResult {
	methodResult := uIface.connector.GetApiProvider().Invoke(uIface.interfaceName, methodId.Name(), inputDataValue, ctx)
	return methodResult
}


func (uIface *DefaultUnassociatedVirtualMachinesClient) listMethodDefinition() *core.MethodDefinition {
	interfaceIdentifier := core.NewInterfaceIdentifier(uIface.interfaceName)
	typeConverter := uIface.connector.TypeConverter()

	input, inputError := typeConverter.ConvertToDataDefinition(unassociatedVirtualMachinesListInputType())
	output, outputError := typeConverter.ConvertToDataDefinition(unassociatedVirtualMachinesListOutputType())
	if inputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultUnassociatedVirtualMachinesClient.list method's input - %s",
			bindings.VAPIerrorsToError(inputError).Error())
		return nil
	}
	if outputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultUnassociatedVirtualMachinesClient.list method's output - %s",
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultUnassociatedVirtualMachinesClient.list method's errors.InvalidRequest error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultUnassociatedVirtualMachinesClient.list method's errors.Unauthorized error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultUnassociatedVirtualMachinesClient.list method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultUnassociatedVirtualMachinesClient.list method's errors.InternalServerError error - %s",
	...
	if errError5 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultUnassociatedVirtualMachinesClient.list method's errors.NotFound error - %s",
