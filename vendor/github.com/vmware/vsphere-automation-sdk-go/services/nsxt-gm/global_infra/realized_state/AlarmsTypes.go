...
func AlarmsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.PolicyAlarmResourceListResultBindingType)
}
...
func alarmsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/realized-state/alarms",
		"",
		resultHeaders,
		200,
		"",
