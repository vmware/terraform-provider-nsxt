...
// Source: /Users/aruntony/Desktop/playground/vcf/vsphere-automation-sdk-go/services/nsxt/infra/sites/napp/deployment/tools/upload/StatusClient.go
...
func (m *MockStatusClient) Get(siteIdParam, bundleIdParam string) (model.UploadBundleStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", siteIdParam, bundleIdParam)
	ret0, _ := ret[0].(model.UploadBundleStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Get indicates an expected call of Get.
func (mr *MockStatusClientMockRecorder) Get(siteIdParam, bundleIdParam interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockStatusClient)(nil).Get), siteIdParam, bundleIdParam)
}
