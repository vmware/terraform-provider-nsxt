...
// TestAccDataSourceNsxtPolicyBareMetalServers_inventory tests BMS server inventory data sources
func TestAccDataSourceNsxtPolicyBareMetalServers_inventory(t *testing.T) {
...
// TestAccDataSourceNsxtPolicyBareMetalServerInterfaces_inventory tests BMS interface inventory data sources
func TestAccDataSourceNsxtPolicyBareMetalServerInterfaces_inventory(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		PreCheck: func() {
			testAccOnlyLocalManager(t)
			testAccPreCheck(t)
...
// TestAccDataSourceNsxtPolicyBareMetalServers_filtering tests BMS inventory with filtering
func TestAccDataSourceNsxtPolicyBareMetalServers_filtering(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		PreCheck: func() {
			testAccOnlyLocalManager(t)
			testAccPreCheck(t)
...
// TestAccDataSourceNsxtPolicyBareMetalServers_validation tests data source validation scenarios
func TestAccDataSourceNsxtPolicyBareMetalServers_validation(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		PreCheck: func() {
			testAccOnlyLocalManager(t)
			testAccPreCheck(t)
...
func testAccBMSInventoryServerConditionalCheck() resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		serverDataSourceName := "data.nsxt_policy_baremetal_server.test"
...
func testAccBMSInventoryInterfaceConditionalCheck() resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		interfaceDataSourceName := "data.nsxt_policy_baremetal_server_interface.test"
