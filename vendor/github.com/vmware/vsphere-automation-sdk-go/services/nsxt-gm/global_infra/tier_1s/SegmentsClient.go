...
type SegmentsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Deletedhcpleases(tier1IdParam string, segmentIdParam string, dhcpDeleteLeasesParam nsx_global_policyModel.DhcpDeleteLeases, enforcementPointPathParam *string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(tier1IdParam string, segmentIdParam string) (nsx_global_policyModel.Segment, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(tier1IdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, segmentTypeParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.SegmentListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(tier1IdParam string, segmentIdParam string, segmentParam nsx_global_policyModel.Segment) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(tier1IdParam string, segmentIdParam string, segmentParam nsx_global_policyModel.Segment) (nsx_global_policyModel.Segment, error)
}
...
func NewSegmentsClient(connector vapiProtocolClient_.Connector) *segmentsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_1s.segments")
...
func (sIface *segmentsClient) Deletedhcpleases(tier1IdParam string, segmentIdParam string, dhcpDeleteLeasesParam nsx_global_policyModel.DhcpDeleteLeases, enforcementPointPathParam *string) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
...
func (sIface *segmentsClient) Get(tier1IdParam string, segmentIdParam string) (nsx_global_policyModel.Segment, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
...
func (sIface *segmentsClient) List(tier1IdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, segmentTypeParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.SegmentListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
...
func (sIface *segmentsClient) Patch(tier1IdParam string, segmentIdParam string, segmentParam nsx_global_policyModel.Segment) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
...
func (sIface *segmentsClient) Update(tier1IdParam string, segmentIdParam string, segmentParam nsx_global_policyModel.Segment) (nsx_global_policyModel.Segment, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
