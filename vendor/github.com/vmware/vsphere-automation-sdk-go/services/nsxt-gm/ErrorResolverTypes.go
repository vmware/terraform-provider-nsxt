...
// Data type definitions file for service: ErrorResolver.
...
func ErrorResolverGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.ErrorResolverInfoBindingType)
}
...
func errorResolverGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/error-resolver/{errorId}",
		"",
		resultHeaders,
		200,
		"",
...
func ErrorResolverListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.ErrorResolverInfoListBindingType)
}
...
func errorResolverListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/error-resolver",
		"",
		resultHeaders,
		200,
		"",
...
func errorResolverResolveerrorInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["error_resolver_metadata_list"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ErrorResolverMetadataListBindingType)
...
func errorResolverResolveerrorRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["error_resolver_metadata_list"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ErrorResolverMetadataListBindingType)
	fieldNameMap["error_resolver_metadata_list"] = "ErrorResolverMetadataList"
	paramsTypeMap["error_resolver_metadata_list"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.ErrorResolverMetadataListBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
