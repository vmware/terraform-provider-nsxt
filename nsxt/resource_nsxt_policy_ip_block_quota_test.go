...
}`, context, attrMap["display_name"], context, attrMap["display_name"], context, attrMap["display_name"], attrMap["description"], ipblock, attrMap["ip_block_visibility"], attrMap["ip_block_address_type"], attrMap["single_ip_cidrs"], attrMap["mask"], attrMap["total_count"])
}
