...
type LabelsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(labelIdParam string) (nsx_policyModel.PolicyLabel, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyLabelListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(labelIdParam string, policyLabelParam nsx_policyModel.PolicyLabel) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(labelIdParam string, policyLabelParam nsx_policyModel.PolicyLabel) (nsx_policyModel.PolicyLabel, error)
}
...
func NewLabelsClient(connector vapiProtocolClient_.Connector) *labelsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.labels")
...
func (lIface *labelsClient) Get(labelIdParam string) (nsx_policyModel.PolicyLabel, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
...
func (lIface *labelsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyLabelListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
...
func (lIface *labelsClient) Patch(labelIdParam string, policyLabelParam nsx_policyModel.PolicyLabel) error {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
...
func (lIface *labelsClient) Update(labelIdParam string, policyLabelParam nsx_policyModel.PolicyLabel) (nsx_policyModel.PolicyLabel, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
