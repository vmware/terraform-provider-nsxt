...
type GroupServiceAssociationsClient interface {
	...
	List(orgIdParam string, projectIdParam string, intentPathParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyResourceReferenceListResult, error)
}
...
func NewGroupServiceAssociationsClient(connector vapiProtocolClient_.Connector) *groupServiceAssociationsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.group_service_associations")
...
func (gIface *groupServiceAssociationsClient) List(orgIdParam string, projectIdParam string, intentPathParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyResourceReferenceListResult, error) {
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.group_service_associations", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyResourceReferenceListResult
