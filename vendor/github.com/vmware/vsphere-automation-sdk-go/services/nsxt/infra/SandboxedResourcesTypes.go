...
// Data type definitions file for service: SandboxedResources.
...
func sandboxedResourcesListInputType() vapiBindings_.StructType {
...
func SandboxedResourcesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.SandboxedResourceListResultBindingType)
}

func sandboxedResourcesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sandboxed-resources",
		"",
		resultHeaders,
		200,
		"",
