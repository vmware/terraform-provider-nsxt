		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, "internal_transit_subnets.#", "0"),
					resource.TestCheckResourceAttr(testResourceName, "transit_subnets.#", "0"),
					resource.TestCheckResourceAttr(testResourceName, "vrf_transit_subnets.#", "0"),
				),
			},
		},
	})
