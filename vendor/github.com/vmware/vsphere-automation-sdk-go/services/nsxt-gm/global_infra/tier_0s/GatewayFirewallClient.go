...
func NewGatewayFirewallClient(connector client.Connector) *gatewayFirewallClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_0s.gateway_firewall")
...
func (gIface *gatewayFirewallClient) List(tier0IdParam string) (model.GatewayPolicyListResult, error) {
