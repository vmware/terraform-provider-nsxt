...
func NewDefaultMulticastClient(connector client.Connector) *DefaultMulticastClient {
	interfaceName := "com.vmware.nsx_policy.infra.tier_0s.locale_services.multicast"
...
func (mIface *DefaultMulticastClient) Get(tier0IdParam string, localeServicesIdParam string) (model.PolicyMulticastConfig, error) {
