...
type ContextProfilesClient interface {
	...
	// @return com.vmware.nsx_global_policy.model.PolicyContextProfile
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(contextProfileIdParam string) (nsx_global_policyModel.PolicyContextProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyContextProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(contextProfileIdParam string, policyContextProfileParam nsx_global_policyModel.PolicyContextProfile, overrideParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(contextProfileIdParam string, policyContextProfileParam nsx_global_policyModel.PolicyContextProfile, overrideParam *bool) (nsx_global_policyModel.PolicyContextProfile, error)
}
...
func NewContextProfilesClient(connector vapiProtocolClient_.Connector) *contextProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.context_profiles")
...
func (cIface *contextProfilesClient) Delete(contextProfileIdParam string, forceParam *bool, overrideParam *bool) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.context_profiles", "delete", inputDataValue, executionContext)
...
func (cIface *contextProfilesClient) Get(contextProfileIdParam string) (nsx_global_policyModel.PolicyContextProfile, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyContextProfile
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.context_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyContextProfile
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyContextProfile), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (cIface *contextProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyContextProfileListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.context_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyContextProfileListResult
	if methodResult.IsSuccess() {
...
func (cIface *contextProfilesClient) Patch(contextProfileIdParam string, policyContextProfileParam nsx_global_policyModel.PolicyContextProfile, overrideParam *bool) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.context_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *contextProfilesClient) Update(contextProfileIdParam string, policyContextProfileParam nsx_global_policyModel.PolicyContextProfile, overrideParam *bool) (nsx_global_policyModel.PolicyContextProfile, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.context_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyContextProfile
	if methodResult.IsSuccess() {
