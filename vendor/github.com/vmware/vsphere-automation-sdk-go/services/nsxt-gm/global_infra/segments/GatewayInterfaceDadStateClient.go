...
type GatewayInterfaceDadStateClient interface {
	...
	Get(segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.InterfaceDADState, error)
}
...
func NewGatewayInterfaceDadStateClient(connector client.Connector) *gatewayInterfaceDadStateClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.segments.gateway_interface_dad_state")
...
func (gIface *gatewayInterfaceDadStateClient) Get(segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.InterfaceDADState, error) {
