...
type RealizedEntityClient interface {
	...
	Refresh(orgIdParam string, projectIdParam string, intentPathParam string, enforcementPointPathParam *string) error
}
...
func NewRealizedEntityClient(connector vapiProtocolClient_.Connector) *realizedEntityClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.realized_state.realized_entity")
...
func (rIface *realizedEntityClient) Refresh(orgIdParam string, projectIdParam string, intentPathParam string, enforcementPointPathParam *string) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.realized_state.realized_entity", "refresh", inputDataValue, executionContext)
