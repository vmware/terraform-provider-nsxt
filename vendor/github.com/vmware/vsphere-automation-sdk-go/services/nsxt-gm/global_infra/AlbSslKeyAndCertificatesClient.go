...
type AlbSslKeyAndCertificatesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albSslkeyandcertificateIdParam string) (nsx_global_policyModel.ALBSSLKeyAndCertificate, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBSSLKeyAndCertificateApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albSslkeyandcertificateIdParam string, aLBSSLKeyAndCertificateParam nsx_global_policyModel.ALBSSLKeyAndCertificate) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albSslkeyandcertificateIdParam string, aLBSSLKeyAndCertificateParam nsx_global_policyModel.ALBSSLKeyAndCertificate) (nsx_global_policyModel.ALBSSLKeyAndCertificate, error)
}
...
func NewAlbSslKeyAndCertificatesClient(connector vapiProtocolClient_.Connector) *albSslKeyAndCertificatesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_ssl_key_and_certificates")
...
func (aIface *albSslKeyAndCertificatesClient) Delete(albSslkeyandcertificateIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_ssl_key_and_certificates", "delete", inputDataValue, executionContext)
...
func (aIface *albSslKeyAndCertificatesClient) Get(albSslkeyandcertificateIdParam string) (nsx_global_policyModel.ALBSSLKeyAndCertificate, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBSSLKeyAndCertificate
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_ssl_key_and_certificates", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBSSLKeyAndCertificate
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBSSLKeyAndCertificate), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albSslKeyAndCertificatesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBSSLKeyAndCertificateApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBSSLKeyAndCertificateApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_ssl_key_and_certificates", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBSSLKeyAndCertificateApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBSSLKeyAndCertificateApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albSslKeyAndCertificatesClient) Patch(albSslkeyandcertificateIdParam string, aLBSSLKeyAndCertificateParam nsx_global_policyModel.ALBSSLKeyAndCertificate) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_ssl_key_and_certificates", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albSslKeyAndCertificatesClient) Update(albSslkeyandcertificateIdParam string, aLBSSLKeyAndCertificateParam nsx_global_policyModel.ALBSSLKeyAndCertificate) (nsx_global_policyModel.ALBSSLKeyAndCertificate, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_ssl_key_and_certificates", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBSSLKeyAndCertificate
	if methodResult.IsSuccess() {
