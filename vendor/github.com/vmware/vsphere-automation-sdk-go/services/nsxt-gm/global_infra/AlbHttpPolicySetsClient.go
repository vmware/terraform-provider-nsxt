...
type AlbHttpPolicySetsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albHttppolicysetIdParam string) (nsx_global_policyModel.ALBHTTPPolicySet, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBHTTPPolicySetApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albHttppolicysetIdParam string, aLBHTTPPolicySetParam nsx_global_policyModel.ALBHTTPPolicySet) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albHttppolicysetIdParam string, aLBHTTPPolicySetParam nsx_global_policyModel.ALBHTTPPolicySet) (nsx_global_policyModel.ALBHTTPPolicySet, error)
}
...
func NewAlbHttpPolicySetsClient(connector vapiProtocolClient_.Connector) *albHttpPolicySetsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_http_policy_sets")
...
func (aIface *albHttpPolicySetsClient) Delete(albHttppolicysetIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_http_policy_sets", "delete", inputDataValue, executionContext)
...
func (aIface *albHttpPolicySetsClient) Get(albHttppolicysetIdParam string) (nsx_global_policyModel.ALBHTTPPolicySet, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBHTTPPolicySet
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_http_policy_sets", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBHTTPPolicySet
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBHTTPPolicySet), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albHttpPolicySetsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBHTTPPolicySetApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBHTTPPolicySetApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_http_policy_sets", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBHTTPPolicySetApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albHttpPolicySetsClient) Patch(albHttppolicysetIdParam string, aLBHTTPPolicySetParam nsx_global_policyModel.ALBHTTPPolicySet) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_http_policy_sets", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albHttpPolicySetsClient) Update(albHttppolicysetIdParam string, aLBHTTPPolicySetParam nsx_global_policyModel.ALBHTTPPolicySet) (nsx_global_policyModel.ALBHTTPPolicySet, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_http_policy_sets", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBHTTPPolicySet
	if methodResult.IsSuccess() {
