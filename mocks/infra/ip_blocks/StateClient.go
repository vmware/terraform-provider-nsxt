...
// Source: /Users/aruntony/Desktop/playground/vcf/vsphere-automation-sdk-go/services/nsxt/infra/ip_blocks/StateClient.go
...
func (m *MockStateClient) Get(intentPathParam string) (model.IpAddressBlockState, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", intentPathParam)
	ret0, _ := ret[0].(model.IpAddressBlockState)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Get indicates an expected call of Get.
func (mr *MockStateClientMockRecorder) Get(intentPathParam interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockStateClient)(nil).Get), intentPathParam)
}
