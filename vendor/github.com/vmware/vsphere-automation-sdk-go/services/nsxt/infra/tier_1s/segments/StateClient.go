...
type StateClient interface {
	...
	Get(tier1IdParam string, segmentsIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SegmentConfigurationState, error)
...
func (sIface *stateClient) Get(tier1IdParam string, segmentsIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SegmentConfigurationState, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_1s.segments.state", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentConfigurationState
...
func (sIface *stateClient) List(tier1IdParam string, configurationStateParam *string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.SegmentConfigurationStateListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_1s.segments.state", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentConfigurationStateListResult
	if methodResult.IsSuccess() {
