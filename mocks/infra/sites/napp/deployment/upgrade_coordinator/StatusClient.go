...
// Source: /Users/aruntony/Desktop/playground/vcf/vsphere-automation-sdk-go/services/nsxt/infra/sites/napp/deployment/upgrade_coordinator/StatusClient.go
...
func (m *MockStatusClient) Get(siteIdParam string) (model.DeploymentProgressStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", siteIdParam)
	ret0, _ := ret[0].(model.DeploymentProgressStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
