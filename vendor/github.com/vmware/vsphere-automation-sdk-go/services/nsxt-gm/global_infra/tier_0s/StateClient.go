...
type StateClient interface {
	...
	Get(tier0IdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, interfacePathParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_global_policyModel.Tier0GatewayState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_0s.state")
...
func (sIface *stateClient) Get(tier0IdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, interfacePathParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_global_policyModel.Tier0GatewayState, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.Tier0GatewayState
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.Tier0GatewayState), nil
	} else {
