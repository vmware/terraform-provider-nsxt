...
func (lIface *l7AccessProfilesClient) Delete(orgIdParam string, projectIdParam string, l7AccessProfileIdParam string, overrideParam *bool) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.l7_access_profiles", "delete", inputDataValue, executionContext)
...
func (lIface *l7AccessProfilesClient) Get(orgIdParam string, projectIdParam string, l7AccessProfileIdParam string) (nsx_policyModel.L7AccessProfile, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.l7_access_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.L7AccessProfile
	if methodResult.IsSuccess() {
...
func (lIface *l7AccessProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeEntryCountParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.L7AccessProfileListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.l7_access_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.L7AccessProfileListResult
	if methodResult.IsSuccess() {
...
func (lIface *l7AccessProfilesClient) Patch(orgIdParam string, projectIdParam string, l7AccessProfileIdParam string, l7AccessProfileParam nsx_policyModel.L7AccessProfile, overrideParam *bool) (nsx_policyModel.L7AccessProfile, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.l7_access_profiles", "patch", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.L7AccessProfile
	if methodResult.IsSuccess() {
...
func (lIface *l7AccessProfilesClient) Update(orgIdParam string, projectIdParam string, l7AccessProfileIdParam string, l7AccessProfileParam nsx_policyModel.L7AccessProfile, overrideParam *bool) (nsx_policyModel.L7AccessProfile, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.l7_access_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.L7AccessProfile
	if methodResult.IsSuccess() {
