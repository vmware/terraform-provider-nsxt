...
func NewHealthClient(connector vapiProtocolClient_.Connector) *healthClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.health")
...
func (hIface *healthClient) Get() (*vapiData_.StructValue, error) {
	...
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.health", "get", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
