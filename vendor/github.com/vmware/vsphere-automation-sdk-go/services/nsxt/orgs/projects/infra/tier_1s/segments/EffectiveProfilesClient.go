...
type EffectiveProfilesClient interface {
	...
	Get(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string, enforcementPointPathParam *string) (nsx_policyModel.EffectiveProfilesResponse, error)
}
...
func NewEffectiveProfilesClient(connector vapiProtocolClient_.Connector) *effectiveProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments.effective_profiles")
...
func (eIface *effectiveProfilesClient) Get(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string, enforcementPointPathParam *string) (nsx_policyModel.EffectiveProfilesResponse, error) {
