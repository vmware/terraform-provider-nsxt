...
type BepStatisticsClient interface {
	...
	Get(tier1IdParam string, segmentIdParam string, bridgeProfilePathParam string, enforcementPointPathParam *string) (model.BridgeEndpointStatistics, error)
}
...
func NewBepStatisticsClient(connector client.Connector) *bepStatisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_1s.segments.bep_statistics")
...
func (bIface *bepStatisticsClient) Get(tier1IdParam string, segmentIdParam string, bridgeProfilePathParam string, enforcementPointPathParam *string) (model.BridgeEndpointStatistics, error) {
