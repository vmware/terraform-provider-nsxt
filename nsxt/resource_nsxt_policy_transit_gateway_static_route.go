...
var transitGatewayStaticRoutesSchema = map[string]*metadata.ExtendedSchema{
...
func resourceNsxtPolicyTransitGatewayStaticRoutes() *schema.Resource {
	return &schema.Resource{
		Create: resourceNsxtPolicyTransitGatewayStaticRoutesCreate,
		Read:   resourceNsxtPolicyTransitGatewayStaticRoutesRead,
		Update: resourceNsxtPolicyTransitGatewayStaticRoutesUpdate,
		Delete: resourceNsxtPolicyTransitGatewayStaticRoutesDelete,
		Importer: &schema.ResourceImporter{
			State: nsxtParentPathResourceImporter,
		},
		Schema: metadata.GetSchemaFromExtendedSchema(transitGatewayStaticRoutesSchema),
	}
}

func resourceNsxtPolicyTransitGatewayStaticRoutesExists(sessionContext utl.SessionContext, parentPath string, id string, connector client.Connector) (bool, error) {
	var err error
...
func resourceNsxtPolicyTransitGatewayStaticRoutesCreate(d *schema.ResourceData, m interface{}) error {
	connector := getPolicyConnector(m)

	id, err := getOrGenerateIDWithParent(d, m, resourceNsxtPolicyTransitGatewayStaticRoutesExists)
	if err != nil {
		return err
	}
	...
	if err := metadata.SchemaToStruct(elem, d, transitGatewayStaticRoutesSchema, "", nil); err != nil {
		return err
	}
	...
	return resourceNsxtPolicyTransitGatewayStaticRoutesRead(d, m)
}

func resourceNsxtPolicyTransitGatewayStaticRoutesRead(d *schema.ResourceData, m interface{}) error {
	connector := getPolicyConnector(m)
	...
	elem := reflect.ValueOf(&obj).Elem()
	return metadata.StructToSchema(elem, d, transitGatewayStaticRoutesSchema, "", nil)
}

func resourceNsxtPolicyTransitGatewayStaticRoutesUpdate(d *schema.ResourceData, m interface{}) error {
...
func resourceNsxtPolicyTransitGatewayStaticRoutesDelete(d *schema.ResourceData, m interface{}) error {
	id := d.Id()
	if id == "" {
		return fmt.Errorf("Error obtaining StaticRoutes ID")
	}
