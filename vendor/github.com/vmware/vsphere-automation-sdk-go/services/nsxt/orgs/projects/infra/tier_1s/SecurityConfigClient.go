...
func NewSecurityConfigClient(connector vapiProtocolClient_.Connector) *securityConfigClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.security_config")
...
func (sIface *securityConfigClient) Get(orgIdParam string, projectIdParam string, tier1IdParam string, cursorParam *string, featureParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SecurityFeatures, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.security_config", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SecurityFeatures
...
func (sIface *securityConfigClient) Patch(orgIdParam string, projectIdParam string, tier1IdParam string, securityFeaturesParam nsx_policyModel.SecurityFeatures) (nsx_policyModel.SecurityFeatures, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.security_config", "patch", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SecurityFeatures
	if methodResult.IsSuccess() {
...
func (sIface *securityConfigClient) Update(orgIdParam string, projectIdParam string, tier1IdParam string, securityFeaturesParam nsx_policyModel.SecurityFeatures) (nsx_policyModel.SecurityFeatures, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.security_config", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SecurityFeatures
	if methodResult.IsSuccess() {
