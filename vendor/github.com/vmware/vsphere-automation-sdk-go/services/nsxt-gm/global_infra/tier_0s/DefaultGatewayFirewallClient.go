...
func NewDefaultGatewayFirewallClient(connector client.Connector) *DefaultGatewayFirewallClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_0s.gateway_firewall"
...
func (gIface *DefaultGatewayFirewallClient) List(tier0IdParam string) (model.GatewayPolicyListResult, error) {
