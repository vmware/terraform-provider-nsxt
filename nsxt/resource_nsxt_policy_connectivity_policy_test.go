		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, "group", accTestPolicyConnectivityPolicyCreateAttributes["group"]),
					...
					resource.TestCheckResourceAttr(testResourceName, "internal_id", accTestPolicyConnectivityPolicyCreateAttributes["internal_id"]),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, "group", accTestPolicyConnectivityPolicyUpdateAttributes["group"]),
					...
					resource.TestCheckResourceAttr(testResourceName, "internal_id", accTestPolicyConnectivityPolicyUpdateAttributes["internal_id"]),
...
func testAccNsxtPolicyConnectivityPolicyExists(displayName string, resourceName string) resource.TestCheckFunc {
	return func(state *terraform.State) error {
		...
		exists, err := resourceNsxtPolicyConnectivityPolicyExists(testAccGetProjectContext(), parentPath, resourceID, connector)
		if err != nil {
			return err
		}
		if !exists {
