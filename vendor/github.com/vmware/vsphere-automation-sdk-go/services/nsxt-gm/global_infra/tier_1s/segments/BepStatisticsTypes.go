...
func bepStatisticsGetInputType() vapiBindings_.StructType {
...
func BepStatisticsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.BridgeEndpointStatisticsBindingType)
}

func bepStatisticsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tier-1s/{tier1Id}/segments/{segmentId}/bep-statistics",
		"",
		resultHeaders,
		200,
		"",
