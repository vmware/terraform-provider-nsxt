...
func NewDefaultFirewallFloodProtectionProfileBindingMapsClient(connector client.Connector) *DefaultFirewallFloodProtectionProfileBindingMapsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.domains.firewall_flood_protection_profile_binding_maps"
...
func (fIface *DefaultFirewallFloodProtectionProfileBindingMapsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyFirewallFloodProtectionProfileBindingMapListResult, error) {
