...
func interfaceGroupsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/global-manager/api/v1/global-infra/tier-1s/{tier1Id}/locale-services/{localeServiceId}/interface-groups/{groupId}",
		"",
		resultHeaders,
		204,
		"",
...
func InterfaceGroupsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.Tier1InterfaceGroupBindingType)
}
...
func InterfaceGroupsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_global_policyModel.Tier1InterfaceGroupListResultBindingType)
}
...
func interfaceGroupsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tier-1s/{tier1Id}/locale-services/{localeServiceId}/interface-groups",
		"",
		resultHeaders,
		200,
		"",
...
func interfaceGroupsPatchInputType() vapiBindings_.StructType {
	...
	fields["locale_service_id"] = vapiBindings_.NewStringType()
	fields["group_id"] = vapiBindings_.NewStringType()
	fields["tier1_interface_group"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.Tier1InterfaceGroupBindingType)
	fieldNameMap["tier1_id"] = "Tier1Id"
	fieldNameMap["locale_service_id"] = "LocaleServiceId"
	fieldNameMap["group_id"] = "GroupId"
...
func interfaceGroupsPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["tier1_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["group_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["tier1_interface_group"] = vapiBindings_.NewReferenceType(nsx_global_policyModel.Tier1InterfaceGroupBindingType)
	paramsTypeMap["tier1Id"] = vapiBindings_.NewStringType()
	paramsTypeMap["localeServiceId"] = vapiBindings_.NewStringType()
	paramsTypeMap["groupId"] = vapiBindings_.NewStringType()
	pathParams["group_id"] = "groupId"
