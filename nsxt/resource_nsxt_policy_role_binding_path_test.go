...
func TestAccResourceNsxtPolicyUserManagementRoleBindingPath_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: func(state *terraform.State) error {
			return testAccRoleBindingPathPreConfigDestroy()
		},
...
// testAccNsxtPolicyUserManagementRoleBindingPathTemplate returns config with project resource (adopting PreConfig-created project),
