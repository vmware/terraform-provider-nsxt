...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_1s.nat.nat_rules.statistics"
...
func (sIface *DefaultStatisticsClient) List(tier1IdParam string, natIdParam string, natRuleIdParam string, enforcementPointPathParam *string) (model.PolicyNatRuleStatisticsListResult, error) {
