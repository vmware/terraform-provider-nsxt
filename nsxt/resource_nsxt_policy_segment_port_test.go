		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, "security_profile.0.spoofguard_profile_path", "/infra/spoofguard-profiles/"+profilesPrefix+"create"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, "security_profile.0.spoofguard_profile_path", "/infra/spoofguard-profiles/"+profilesPrefix+"update"),
...
resource "nsxt_policy_spoofguard_profile" "%s" {
  display_name = "%s"
  nsx_id = "%s"
}

`, resourceTag, name, name, resourceTag, name, name, resourceTag, name, name, resourceTag, name, name)
}
