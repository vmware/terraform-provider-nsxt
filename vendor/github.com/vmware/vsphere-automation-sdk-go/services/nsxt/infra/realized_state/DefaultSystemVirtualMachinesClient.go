...
/*
 * Client stubs for service: SystemVirtualMachines
 * Functions that implement the generated SystemVirtualMachinesClient interface
 */
...
type DefaultSystemVirtualMachinesClient struct {
...
func NewDefaultSystemVirtualMachinesClient(connector client.Connector) *DefaultSystemVirtualMachinesClient {
	interfaceName := "com.vmware.nsx_policy.infra.realized_state.system_virtual_machines"
	...
	sIface := DefaultSystemVirtualMachinesClient{interfaceName: interfaceName, methodIdentifiers: methodIdentifiers, interfaceDefinition: interfaceDefinition, errorBindingMap: errorBindingMap, interfaceIdentifier: interfaceIdentifier, connector: connector}
	sIface.methodNameToDefMap = make(map[string]*core.MethodDefinition)
	sIface.methodNameToDefMap["list"] = sIface.listMethodDefinition()
	return &sIface
}

func (sIface *DefaultSystemVirtualMachinesClient) List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, queryParam *string, sortAscendingParam *bool, sortByParam *string) (model.VirtualMachineListResult, error) {
...
func (sIface *DefaultSystemVirtualMachinesClient) Invoke(ctx *core.ExecutionContext, methodId core.MethodIdentifier, inputDataValue data.DataValue) core.MethodResult {
	methodResult := sIface.connector.GetApiProvider().Invoke(sIface.interfaceName, methodId.Name(), inputDataValue, ctx)
	return methodResult
}


func (sIface *DefaultSystemVirtualMachinesClient) listMethodDefinition() *core.MethodDefinition {
	interfaceIdentifier := core.NewInterfaceIdentifier(sIface.interfaceName)
	typeConverter := sIface.connector.TypeConverter()

	input, inputError := typeConverter.ConvertToDataDefinition(systemVirtualMachinesListInputType())
	output, outputError := typeConverter.ConvertToDataDefinition(systemVirtualMachinesListOutputType())
	if inputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSystemVirtualMachinesClient.list method's input - %s",
			bindings.VAPIerrorsToError(inputError).Error())
		return nil
	}
	if outputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSystemVirtualMachinesClient.list method's output - %s",
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSystemVirtualMachinesClient.list method's errors.InvalidRequest error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSystemVirtualMachinesClient.list method's errors.Unauthorized error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSystemVirtualMachinesClient.list method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSystemVirtualMachinesClient.list method's errors.InternalServerError error - %s",
	...
	if errError5 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSystemVirtualMachinesClient.list method's errors.NotFound error - %s",
