...
func NewFloodProtectionProfilesClient(connector vapiProtocolClient_.Connector) *floodProtectionProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.flood_protection_profiles")
...
func (fIface *floodProtectionProfilesClient) Delete(orgIdParam string, projectIdParam string, floodProtectionProfileIdParam string, overrideParam *bool) error {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.flood_protection_profiles", "delete", inputDataValue, executionContext)
...
func (fIface *floodProtectionProfilesClient) Get(orgIdParam string, projectIdParam string, floodProtectionProfileIdParam string) (*vapiData_.StructValue, error) {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.flood_protection_profiles", "get", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
...
func (fIface *floodProtectionProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.FloodProtectionProfileListResult, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.flood_protection_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.FloodProtectionProfileListResult
	if methodResult.IsSuccess() {
...
func (fIface *floodProtectionProfilesClient) Patch(orgIdParam string, projectIdParam string, floodProtectionProfileIdParam string, floodProtectionProfileParam *vapiData_.StructValue, overrideParam *bool) error {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.flood_protection_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), fIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (fIface *floodProtectionProfilesClient) Update(orgIdParam string, projectIdParam string, floodProtectionProfileIdParam string, floodProtectionProfileParam *vapiData_.StructValue, overrideParam *bool) (*vapiData_.StructValue, error) {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.flood_protection_profiles", "update", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
