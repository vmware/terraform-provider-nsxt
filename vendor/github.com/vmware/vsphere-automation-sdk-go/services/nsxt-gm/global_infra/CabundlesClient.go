...
type CabundlesClient interface {
	...
	// @return com.vmware.nsx_global_policy.model.CaBundle
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(cabundleIdParam string) (nsx_global_policyModel.CaBundle, error)
	...
	// @return com.vmware.nsx_global_policy.model.CaBundleListResult
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, detailsParam *bool, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_global_policyModel.CaBundleListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(cabundleIdParam string, caBundleParam nsx_global_policyModel.CaBundle) (nsx_global_policyModel.CaBundle, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(cabundleIdParam string, caBundleParam nsx_global_policyModel.CaBundle) (nsx_global_policyModel.CaBundle, error)
}
...
func NewCabundlesClient(connector vapiProtocolClient_.Connector) *cabundlesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.cabundles")
...
func (cIface *cabundlesClient) Delete(cabundleIdParam string) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.cabundles", "delete", inputDataValue, executionContext)
...
func (cIface *cabundlesClient) Get(cabundleIdParam string) (nsx_global_policyModel.CaBundle, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.CaBundle
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.cabundles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.CaBundle
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.CaBundle), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (cIface *cabundlesClient) List(cursorParam *string, detailsParam *bool, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_global_policyModel.CaBundleListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.CaBundleListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.cabundles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.CaBundleListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.CaBundleListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (cIface *cabundlesClient) Patch(cabundleIdParam string, caBundleParam nsx_global_policyModel.CaBundle) (nsx_global_policyModel.CaBundle, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.cabundles", "patch", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.CaBundle
	if methodResult.IsSuccess() {
...
func (cIface *cabundlesClient) Update(cabundleIdParam string, caBundleParam nsx_global_policyModel.CaBundle) (nsx_global_policyModel.CaBundle, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.cabundles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.CaBundle
	if methodResult.IsSuccess() {
