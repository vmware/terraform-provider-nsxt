		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(testResourceName, "external_id", os.Getenv("NSXT_TEST_BMS_SERVER")),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(testResourceName, "external_id", os.Getenv("NSXT_TEST_BMS_INTERFACE")),
					resource.TestCheckResourceAttrSet(testResourceName, "id"),
					resource.TestCheckResourceAttrSet(testResourceName, "tag.#"),
				),
			},
...
`, os.Getenv("NSXT_TEST_BMS_SERVER"), testName, os.Getenv("NSXT_TEST_BMS_SERVER"))
}
...
`, os.Getenv("NSXT_TEST_BMS_INTERFACE"), testName, os.Getenv("NSXT_TEST_BMS_INTERFACE"))
}

func testAccNsxtPolicyBareMetalServerTagsNonExistentTemplate() string {
	return `
data "nsxt_policy_baremetal_server_tags" "test" {
  external_id = "non-existent-server-id"
}
`
}
...
func testAccNsxtPolicyBareMetalServerInterfaceTagsNonExistentTemplate() string {
	return `
data "nsxt_policy_baremetal_server_interface_tags" "test" {
  external_id = "non-existent-interface-id"
}
`
}
