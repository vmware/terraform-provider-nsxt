...
func NewFloodProtectionProfileBindingsClient(connector client.Connector) *floodProtectionProfileBindingsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_0s.locale_services.flood_protection_profile_bindings")
...
func (fIface *floodProtectionProfileBindingsClient) Get(tier0IdParam string, localeServicesIdParam string, floodProtectionProfileBindingIdParam string) (model.FloodProtectionProfileBindingMap, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
...
func (fIface *floodProtectionProfileBindingsClient) Patch(tier0IdParam string, localeServicesIdParam string, floodProtectionProfileBindingIdParam string, floodProtectionProfileBindingMapParam model.FloodProtectionProfileBindingMap) error {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
...
func (fIface *floodProtectionProfileBindingsClient) Update(tier0IdParam string, localeServicesIdParam string, floodProtectionProfileBindingIdParam string, floodProtectionProfileBindingMapParam model.FloodProtectionProfileBindingMap) (model.FloodProtectionProfileBindingMap, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
