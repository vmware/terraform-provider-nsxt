...
func TestNSXIgmpTypeNsServiceBasic(t *testing.T) {
...
func testAccNSXIgmpServiceExists(display_name string, resourceName string) resource.TestCheckFunc {
	return func(state *terraform.State) error {
		...
		if responseCode.StatusCode != http.StatusOK {
			return fmt.Errorf("Error while checking if igmp service %s exists. HTTP return code was %d", resourceID, responseCode)
		}
