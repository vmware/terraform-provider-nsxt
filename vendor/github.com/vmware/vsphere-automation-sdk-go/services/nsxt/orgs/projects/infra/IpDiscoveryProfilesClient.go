...
type IpDiscoveryProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, ipDiscoveryProfileIdParam string) (nsx_policyModel.IPDiscoveryProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IPDiscoveryProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, ipDiscoveryProfileIdParam string, ipDiscoveryProfileParam nsx_policyModel.IPDiscoveryProfile, overrideParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, ipDiscoveryProfileIdParam string, ipDiscoveryProfileParam nsx_policyModel.IPDiscoveryProfile, overrideParam *bool) (nsx_policyModel.IPDiscoveryProfile, error)
}
...
func NewIpDiscoveryProfilesClient(connector vapiProtocolClient_.Connector) *ipDiscoveryProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ip_discovery_profiles")
...
func (iIface *ipDiscoveryProfilesClient) Delete(orgIdParam string, projectIdParam string, ipDiscoveryProfileIdParam string, overrideParam *bool) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_discovery_profiles", "delete", inputDataValue, executionContext)
...
func (iIface *ipDiscoveryProfilesClient) Get(orgIdParam string, projectIdParam string, ipDiscoveryProfileIdParam string) (nsx_policyModel.IPDiscoveryProfile, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_discovery_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPDiscoveryProfile
	if methodResult.IsSuccess() {
...
func (iIface *ipDiscoveryProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IPDiscoveryProfileListResult, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_discovery_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPDiscoveryProfileListResult
	if methodResult.IsSuccess() {
...
func (iIface *ipDiscoveryProfilesClient) Patch(orgIdParam string, projectIdParam string, ipDiscoveryProfileIdParam string, ipDiscoveryProfileParam nsx_policyModel.IPDiscoveryProfile, overrideParam *bool) error {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_discovery_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (iIface *ipDiscoveryProfilesClient) Update(orgIdParam string, projectIdParam string, ipDiscoveryProfileIdParam string, ipDiscoveryProfileParam nsx_policyModel.IPDiscoveryProfile, overrideParam *bool) (nsx_policyModel.IPDiscoveryProfile, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_discovery_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPDiscoveryProfile
	if methodResult.IsSuccess() {
