...
func systemVirtualMachinesListInputType() bindings.StructType {
...
func systemVirtualMachinesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.VirtualMachineListResultBindingType)
}

func systemVirtualMachinesListRestMetadata() protocol.OperationRestMetadata {
