...
func NewDefaultGatewayFirewallClient(connector client.Connector) *DefaultGatewayFirewallClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_1s.locale_services.gateway_firewall"
...
func (gIface *DefaultGatewayFirewallClient) List(tier1IdParam string, localeServicesIdParam string) (model.GatewayPolicyListResult, error) {
