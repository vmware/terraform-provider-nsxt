...
func NewArpProxiesClient(connector client.Connector) *arpProxiesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.locale_services.arp_proxies")
...
func (aIface *arpProxiesClient) List(tier0IdParam string, localeServiceIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.PolicyArpProxyTableListResult, error) {
