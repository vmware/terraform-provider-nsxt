...
func NewDefaultGatewayInterfaceArpTableClient(connector client.Connector) *DefaultGatewayInterfaceArpTableClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.segments.gateway_interface_arp_table"
...
func (gIface *DefaultGatewayInterfaceArpTableClient) List(segmentIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.InterfaceArpTable, error) {
