...
func macDiscoveryProfilesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/mac-discovery-profiles/{macDiscoveryProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func macDiscoveryProfilesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/mac-discovery-profiles",
		"",
		resultHeaders,
		200,
		"",
