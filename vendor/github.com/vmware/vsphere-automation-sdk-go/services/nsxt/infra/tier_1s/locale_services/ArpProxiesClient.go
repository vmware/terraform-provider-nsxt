...
type ArpProxiesClient interface {
	...
	List(tier1IdParam string, localeServiceIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_policyModel.PolicyArpProxyTableListResult, error)
}
...
func NewArpProxiesClient(connector vapiProtocolClient_.Connector) *arpProxiesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_1s.locale_services.arp_proxies")
...
func (aIface *arpProxiesClient) List(tier1IdParam string, localeServiceIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_policyModel.PolicyArpProxyTableListResult, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_1s.locale_services.arp_proxies", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyArpProxyTableListResult
