...
func sessionsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/infra/tier-1s/{tier1Id}/ipsec-vpn-services/{serviceId}/sessions/{sessionId}",
		"",
		resultHeaders,
		204,
		"",
...
func sessionsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/tier-1s/{tier1Id}/ipsec-vpn-services/{serviceId}/sessions",
		"",
		resultHeaders,
		200,
		"",
