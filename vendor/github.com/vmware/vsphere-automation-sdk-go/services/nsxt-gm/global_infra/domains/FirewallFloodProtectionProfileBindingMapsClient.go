...
type FirewallFloodProtectionProfileBindingMapsClient interface {
	...
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyFirewallFloodProtectionProfileBindingMapListResult, error)
}
...
func NewFirewallFloodProtectionProfileBindingMapsClient(connector vapiProtocolClient_.Connector) *firewallFloodProtectionProfileBindingMapsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.firewall_flood_protection_profile_binding_maps")
...
func (fIface *firewallFloodProtectionProfileBindingMapsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyFirewallFloodProtectionProfileBindingMapListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyFirewallFloodProtectionProfileBindingMapListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.domains.firewall_flood_protection_profile_binding_maps", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyFirewallFloodProtectionProfileBindingMapListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyFirewallFloodProtectionProfileBindingMapListResult), nil
	} else {
