...
func databaseListInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["tier0_id"] = vapiBindings_.NewStringType()
	fields["locale_service_id"] = vapiBindings_.NewStringType()
	fields["area_id"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
...
func DatabaseListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyOspfDatabaseListResultBindingType)
}

func databaseListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["area_id"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
