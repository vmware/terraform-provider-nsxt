...
type AlbHardwareSecurityModuleGroupsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albHardwaresecuritymodulegroupIdParam string) (nsx_policyModel.ALBHardwareSecurityModuleGroup, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ALBHardwareSecurityModuleGroupApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albHardwaresecuritymodulegroupIdParam string, aLBHardwareSecurityModuleGroupParam nsx_policyModel.ALBHardwareSecurityModuleGroup) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albHardwaresecuritymodulegroupIdParam string, aLBHardwareSecurityModuleGroupParam nsx_policyModel.ALBHardwareSecurityModuleGroup) (nsx_policyModel.ALBHardwareSecurityModuleGroup, error)
}
...
func NewAlbHardwareSecurityModuleGroupsClient(connector vapiProtocolClient_.Connector) *albHardwareSecurityModuleGroupsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.alb_hardware_security_module_groups")
...
func (aIface *albHardwareSecurityModuleGroupsClient) Get(albHardwaresecuritymodulegroupIdParam string) (nsx_policyModel.ALBHardwareSecurityModuleGroup, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.ALBHardwareSecurityModuleGroup
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ALBHardwareSecurityModuleGroup), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albHardwareSecurityModuleGroupsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ALBHardwareSecurityModuleGroupApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.ALBHardwareSecurityModuleGroupApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ALBHardwareSecurityModuleGroupApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albHardwareSecurityModuleGroupsClient) Patch(albHardwaresecuritymodulegroupIdParam string, aLBHardwareSecurityModuleGroupParam nsx_policyModel.ALBHardwareSecurityModuleGroup) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
...
func (aIface *albHardwareSecurityModuleGroupsClient) Update(albHardwaresecuritymodulegroupIdParam string, aLBHardwareSecurityModuleGroupParam nsx_policyModel.ALBHardwareSecurityModuleGroup) (nsx_policyModel.ALBHardwareSecurityModuleGroup, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
