...
type GatewayInterfaceStatisticsClient interface {
	...
	Get(tier1IdParam string, segmentIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, hostTransportNodePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyInterfaceStatistics, error)
}
...
func NewGatewayInterfaceStatisticsClient(connector vapiProtocolClient_.Connector) *gatewayInterfaceStatisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.tier_1s.segments.gateway_interface_statistics")
...
func (gIface *gatewayInterfaceStatisticsClient) Get(tier1IdParam string, segmentIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, hostTransportNodePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyInterfaceStatistics, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.PolicyInterfaceStatistics
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.tier_1s.segments.gateway_interface_statistics", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.PolicyInterfaceStatistics
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.PolicyInterfaceStatistics), nil
	} else {
