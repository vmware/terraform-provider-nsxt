...
func getIntrusionServicePolicyInDomain(id string, domainName string, connector *client.RestConnector) (model.IdsSecurityPolicy, error) {
	client := domains.NewDefaultIntrusionServicePoliciesClient(connector)
