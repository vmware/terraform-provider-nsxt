...
func NewModeClient(connector vapiProtocolClient_.Connector) *modeClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.node.mode")
...
func (mIface *modeClient) Get() (nsxModel.NodeMode, error) {
	...
	sv := vapiBindings_.NewStructValueBuilder(modeGetInputType(), typeConverter)
