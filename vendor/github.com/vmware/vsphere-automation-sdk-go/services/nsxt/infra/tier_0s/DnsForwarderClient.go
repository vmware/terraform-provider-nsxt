...
func NewDnsForwarderClient(connector vapiProtocolClient_.Connector) *dnsForwarderClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.dns_forwarder")
...
func (dIface *dnsForwarderClient) Patch(tier0IdParam string, policyDnsForwarderParam nsx_policyModel.PolicyDnsForwarder) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
...
func (dIface *dnsForwarderClient) Update(tier0IdParam string, policyDnsForwarderParam nsx_policyModel.PolicyDnsForwarder) (nsx_policyModel.PolicyDnsForwarder, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
