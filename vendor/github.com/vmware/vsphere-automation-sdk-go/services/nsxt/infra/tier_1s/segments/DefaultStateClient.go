...
func NewDefaultStateClient(connector client.Connector) *DefaultStateClient {
	interfaceName := "com.vmware.nsx_policy.infra.tier_1s.segments.state"
...
func (sIface *DefaultStateClient) Get(tier1IdParam string, segmentsIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.SegmentConfigurationState, error) {
...
func (sIface *DefaultStateClient) List(tier1IdParam string, configurationStateParam *string, enforcementPointPathParam *string, sourceParam *string) (model.SegmentConfigurationStateListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
