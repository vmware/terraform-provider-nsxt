...
func systemExcludedVirtualMachinesListInputType() bindings.StructType {
...
func systemExcludedVirtualMachinesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.VirtualMachineListResultBindingType)
}

func systemExcludedVirtualMachinesListRestMetadata() protocol.OperationRestMetadata {
