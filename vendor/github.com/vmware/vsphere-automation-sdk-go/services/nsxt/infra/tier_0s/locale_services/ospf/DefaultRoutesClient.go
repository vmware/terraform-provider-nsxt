...
func NewDefaultRoutesClient(connector client.Connector) *DefaultRoutesClient {
	interfaceName := "com.vmware.nsx_policy.infra.tier_0s.locale_services.ospf.routes"
...
func (rIface *DefaultRoutesClient) List(tier0IdParam string, localeServiceIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includedFieldsParam *string, networkPrefixParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.OspfRoutesListResult, error) {
...
func (rIface *DefaultRoutesClient) listMethodDefinition() *core.MethodDefinition {
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRoutesClient.list method's errors.InvalidRequest error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRoutesClient.list method's errors.Unauthorized error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRoutesClient.list method's errors.InternalServerError error - %s",
