...
type AlbPriorityLabelsClient interface {
	...
	//
	// @param albPrioritylabelsIdParam ALBPriorityLabels ID (required)
	// @return com.vmware.nsx_global_policy.model.ALBPriorityLabels
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(albPrioritylabelsIdParam string) (nsx_global_policyModel.ALBPriorityLabels, error)
	...
	// @return com.vmware.nsx_global_policy.model.ALBPriorityLabelsApiResponse
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBPriorityLabelsApiResponse, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(albPrioritylabelsIdParam string, aLBPriorityLabelsParam nsx_global_policyModel.ALBPriorityLabels) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(albPrioritylabelsIdParam string, aLBPriorityLabelsParam nsx_global_policyModel.ALBPriorityLabels) (nsx_global_policyModel.ALBPriorityLabels, error)
}
...
func NewAlbPriorityLabelsClient(connector vapiProtocolClient_.Connector) *albPriorityLabelsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.alb_priority_labels")
...
func (aIface *albPriorityLabelsClient) Delete(albPrioritylabelsIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_priority_labels", "delete", inputDataValue, executionContext)
...
func (aIface *albPriorityLabelsClient) Get(albPrioritylabelsIdParam string) (nsx_global_policyModel.ALBPriorityLabels, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBPriorityLabels
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_priority_labels", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBPriorityLabels
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBPriorityLabels), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (aIface *albPriorityLabelsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ALBPriorityLabelsApiResponse, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ALBPriorityLabelsApiResponse
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_priority_labels", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBPriorityLabelsApiResponse
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ALBPriorityLabelsApiResponse), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (aIface *albPriorityLabelsClient) Patch(albPrioritylabelsIdParam string, aLBPriorityLabelsParam nsx_global_policyModel.ALBPriorityLabels) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_priority_labels", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albPriorityLabelsClient) Update(albPrioritylabelsIdParam string, aLBPriorityLabelsParam nsx_global_policyModel.ALBPriorityLabels) (nsx_global_policyModel.ALBPriorityLabels, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.alb_priority_labels", "update", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.ALBPriorityLabels
	if methodResult.IsSuccess() {
