...
func uiViewsCreateInputType() vapiBindings_.StructType {
	...
	fields["view"] = vapiBindings_.NewReferenceType(nsxModel.ViewBindingType)
...
func UiViewsCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ViewBindingType)
}
...
func uiViewsCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["view"] = vapiBindings_.NewReferenceType(nsxModel.ViewBindingType)
	fieldNameMap["view"] = "View"
	paramsTypeMap["view"] = vapiBindings_.NewReferenceType(nsxModel.ViewBindingType)
...
func UiViewsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ViewListBindingType)
}
