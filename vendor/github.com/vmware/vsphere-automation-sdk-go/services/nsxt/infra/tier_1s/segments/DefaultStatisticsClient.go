...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_policy.infra.tier_1s.segments.statistics"
...
func (sIface *DefaultStatisticsClient) Get(tier1IdParam string, segmentsIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.SegmentStatistics, error) {
	...
	if inputError != nil {
		var emptyOutput model.SegmentStatistics
	...
	if methodResult.IsSuccess() {
		...
		return output.(model.SegmentStatistics), nil
	} else {
...
func (sIface *DefaultStatisticsClient) getMethodDefinition() *core.MethodDefinition {
	...
	input, inputError := typeConverter.ConvertToDataDefinition(statisticsGetInputType())
	output, outputError := typeConverter.ConvertToDataDefinition(statisticsGetOutputType())
	if inputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatisticsClient.get method's input - %s",
			bindings.VAPIerrorsToError(inputError).Error())
		return nil
	}
	if outputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatisticsClient.get method's output - %s",
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatisticsClient.get method's errors.InvalidRequest error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatisticsClient.get method's errors.Unauthorized error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatisticsClient.get method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatisticsClient.get method's errors.InternalServerError error - %s",
	...
	if errError5 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatisticsClient.get method's errors.NotFound error - %s",
