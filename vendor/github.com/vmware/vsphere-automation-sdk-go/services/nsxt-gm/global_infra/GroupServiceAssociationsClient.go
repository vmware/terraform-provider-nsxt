...
type GroupServiceAssociationsClient interface {
	...
	List(intentPathParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyResourceReferenceListResult, error)
}
...
func NewGroupServiceAssociationsClient(connector vapiProtocolClient_.Connector) *groupServiceAssociationsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.group_service_associations")
...
func (gIface *groupServiceAssociationsClient) List(intentPathParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.PolicyResourceReferenceListResult, error) {
