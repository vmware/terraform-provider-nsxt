...
type CsrsClient interface {
	...
	// @return com.vmware.nsx_global_policy.model.TlsCsr
	//
	...
	Create(csrIdParam string, tlsCsrParam nsx_global_policyModel.TlsCsr) (nsx_global_policyModel.TlsCsr, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(csrIdParam string) (nsx_global_policyModel.TlsCsr, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Importcsr(csrIdParam string, tlsTrustDataParam nsx_global_policyModel.TlsTrustData) (nsx_global_policyModel.TlsCertificate, error)
	...
	// @return com.vmware.nsx_global_policy.model.TlsCsrListResult
	//
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.TlsCsrListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Selfsign(csrIdParam string, daysValidParam int64) (nsx_global_policyModel.TlsCertificate, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Selfsign0(tlsCsrWithDaysValidParam nsx_global_policyModel.TlsCsrWithDaysValid) (nsx_global_policyModel.TlsCertificate, error)
}
...
func NewCsrsClient(connector vapiProtocolClient_.Connector) *csrsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.csrs")
...
func (cIface *csrsClient) Create(csrIdParam string, tlsCsrParam nsx_global_policyModel.TlsCsr) (nsx_global_policyModel.TlsCsr, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.TlsCsr
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.csrs", "create", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCsr
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.TlsCsr), nil
	} else {
...
func (cIface *csrsClient) Delete(csrIdParam string) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.csrs", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *csrsClient) Get(csrIdParam string) (nsx_global_policyModel.TlsCsr, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.csrs", "get", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCsr
	if methodResult.IsSuccess() {
...
func (cIface *csrsClient) Importcsr(csrIdParam string, tlsTrustDataParam nsx_global_policyModel.TlsTrustData) (nsx_global_policyModel.TlsCertificate, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.TlsCertificate
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.csrs", "importcsr", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCertificate
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.TlsCertificate), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (cIface *csrsClient) List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.TlsCsrListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.TlsCsrListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.csrs", "list", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCsrListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.TlsCsrListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
			return emptyOutput, vapiBindings_.VAPIerrorsToError(errorInError)
...
func (cIface *csrsClient) Selfsign(csrIdParam string, daysValidParam int64) (nsx_global_policyModel.TlsCertificate, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.csrs", "selfsign", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCertificate
	if methodResult.IsSuccess() {
...
func (cIface *csrsClient) Selfsign0(tlsCsrWithDaysValidParam nsx_global_policyModel.TlsCsrWithDaysValid) (nsx_global_policyModel.TlsCertificate, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.csrs", "selfsign_0", inputDataValue, executionContext)
	var emptyOutput nsx_global_policyModel.TlsCertificate
	if methodResult.IsSuccess() {
