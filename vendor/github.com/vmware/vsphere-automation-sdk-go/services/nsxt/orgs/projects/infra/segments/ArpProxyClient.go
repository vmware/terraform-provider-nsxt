...
func NewArpProxyClient(connector vapiProtocolClient_.Connector) *arpProxyClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segments.arp_proxy")
...
func (aIface *arpProxyClient) List(orgIdParam string, projectIdParam string, segmentIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_policyModel.PolicyArpProxyTableListResult, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.arp_proxy", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyArpProxyTableListResult
