...
type SessionTimerProfileBindingsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(tier0IdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_policyModel.SessionTimerProfileBindingMap) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(tier0IdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_policyModel.SessionTimerProfileBindingMap) (nsx_policyModel.SessionTimerProfileBindingMap, error)
}
...
func (sIface *sessionTimerProfileBindingsClient) Delete(tier0IdParam string, sessionTimerProfileBindingIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.session_timer_profile_bindings", "delete", inputDataValue, executionContext)
...
func (sIface *sessionTimerProfileBindingsClient) Get(tier0IdParam string, sessionTimerProfileBindingIdParam string) (nsx_policyModel.SessionTimerProfileBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.session_timer_profile_bindings", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SessionTimerProfileBindingMap
	if methodResult.IsSuccess() {
...
func (sIface *sessionTimerProfileBindingsClient) Patch(tier0IdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_policyModel.SessionTimerProfileBindingMap) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.session_timer_profile_bindings", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *sessionTimerProfileBindingsClient) Update(tier0IdParam string, sessionTimerProfileBindingIdParam string, sessionTimerProfileBindingMapParam nsx_policyModel.SessionTimerProfileBindingMap) (nsx_policyModel.SessionTimerProfileBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.session_timer_profile_bindings", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SessionTimerProfileBindingMap
	if methodResult.IsSuccess() {
