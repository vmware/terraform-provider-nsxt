...
type VirtualNetworkInterfaceGroupAssociationsClient interface {
	...
	List(orgIdParam string, projectIdParam string, vifExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyResourceReferenceForEPListResult, error)
}
...
func NewVirtualNetworkInterfaceGroupAssociationsClient(connector vapiProtocolClient_.Connector) *virtualNetworkInterfaceGroupAssociationsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.virtual_network_interface_group_associations")
...
func (vIface *virtualNetworkInterfaceGroupAssociationsClient) List(orgIdParam string, projectIdParam string, vifExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyResourceReferenceForEPListResult, error) {
	...
	methodResult := vIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.virtual_network_interface_group_associations", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyResourceReferenceForEPListResult
