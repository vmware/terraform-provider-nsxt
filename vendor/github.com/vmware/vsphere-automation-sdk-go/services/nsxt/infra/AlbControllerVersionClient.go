...
type AlbControllerVersionClient interface {
	...
	Get() (nsx_policyModel.ALBControllerVersion, error)
}
...
func NewAlbControllerVersionClient(connector vapiProtocolClient_.Connector) *albControllerVersionClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.alb_controller_version")
...
func (aIface *albControllerVersionClient) Get() (nsx_policyModel.ALBControllerVersion, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.ALBControllerVersion
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.ALBControllerVersion), nil
	} else {
