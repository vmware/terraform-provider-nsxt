...
func resourceNsxtPolicyVpcAttachment() *schema.Resource {
	return &schema.Resource{
		Create: resourceNsxtPolicyVpcAttachmentCreate,
		Read:   resourceNsxtPolicyVpcAttachmentRead,
		Update: resourceNsxtPolicyVpcAttachmentUpdate,
		Delete: resourceNsxtPolicyVpcAttachmentDelete,
...
func resourceNsxtPolicyVpcAttachmentExists(sessionContext utl.SessionContext, parentPath string, id string, connector client.Connector) (bool, error) {
	var err error
...
func resourceNsxtPolicyVpcAttachmentCreate(d *schema.ResourceData, m interface{}) error {
	connector := getPolicyConnector(m)

	id, err := getOrGenerateIDWithParent(d, m, resourceNsxtPolicyVpcAttachmentExists)
	if err != nil {
		return err
	}
	...
	return resourceNsxtPolicyVpcAttachmentRead(d, m)
}

func resourceNsxtPolicyVpcAttachmentRead(d *schema.ResourceData, m interface{}) error {
	connector := getPolicyConnector(m)
...
func resourceNsxtPolicyVpcAttachmentUpdate(d *schema.ResourceData, m interface{}) error {
...
func resourceNsxtPolicyVpcAttachmentDelete(d *schema.ResourceData, m interface{}) error {
	/*
	id := d.Id()
	if id == "" {
		return fmt.Errorf("Error obtaining VpcAttachment ID")
