...
func StatisticsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyNatRuleStatisticsPerLogicalRouterListResultBindingType)
}
...
func statisticsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/tier-1s/{tier1Id}/nat/statistics",
		"",
		resultHeaders,
		200,
		"",
